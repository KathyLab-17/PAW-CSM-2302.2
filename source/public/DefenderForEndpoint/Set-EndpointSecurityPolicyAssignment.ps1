function Set-EndpointSecurityPolicyAssignment {
    <#
    .SYNOPSIS
    This function is used to add ab Endpoint Security policies assignment using the Graph API REST interface
    .DESCRIPTION
    The function connects to the Graph API Interface and adds an Endpoint Security policies assignment
    .EXAMPLE
    Add-DeviceConfigurationPolicyAssignment -ConfigurationPolicyId $ConfigurationPolicyId -TargetGroupId $TargetGroupId
    Adds an Endpoint Security policiesassignment in Intune
    #>
    [cmdletbinding()]
    param (
        [Parameter(Mandatory)]
    ...
    $apiVersion = 'beta'
    $resource = "deviceManagement/intents/$PolicyId/assign"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC3p442pHs4ME6f
# 6O80fnHqA18O9ArFQCaeozZW0VjNCaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBt1mQq7EWbkqLmySbU18TgC
# ipJqo8xRZ5k0F2zd7V/FMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEARxT+I7zXdNeU9jI6C3XY0Rw6xsCjkcZgWHL7bcUA3qfB5x3Y01TWFC3L
# r8V/RfySQiNzzG1UrovsMi5VHQ3On15eviG6fGzuWsETXTG4aT5L88HCU+XFx3Sf
# nRtS5vGUpbEd5YjJqs1gfMxr5OMxmtk3QKO7P53OZzA3sc0VCDWWgd1HXMcoXHoL
# JLwMRlRjfPx6mvl4zve1a3D6XaUVKK3NlMQRywwN5K75RTTtPd1n0brbdEsR3lSu
# LNrNeP9oy5LtRXrb4Lmt6VOqb+Em9HesPHJI5NB9Ylyjoiptk8HE17VGfkM+6Cp8
# sDLNE33Y2JP32UQijVzd4/rRaZx9EqGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCb18eCQo8LAqeVA1g78quS14bdbzOpVrYS5x71I3f71gIGZBMoguJj
# GBMyMDIzMDQxMjIxMTAxOS41MzJaMASAAgH0oIHQpIHNMIHKMQswCQYDVQQGEwJV
...
# AQkEMSIEICeSd0BdDN7kX/yJPvvWt4ndKF2GwY2Ft974BNYYuY6LMIH6BgsqhkiG
...
# DARQfjANBgkqhkiG9w0BAQsFAASCAgDMypgQ1FsBj1ITR2/8Vr3zTnxAzXYLuo6T
# vNa0i6pc4SKQXGFNugidirp2c3qQCNAg7aodr4SuQAtE2jzuIgnoqBeVLNptjY5t
# DbJTpYTkdenXW7h6/p2RQQEzrBS0cwIDi2VnwrMvhpiod9r3Rq+WC+8Kg+8YQriJ
# zvZ/xmBicFm1Er7Kp9yFqFWdhTHGJydsvrLHihrkVqKAVJSW2oCGmcNJuJ4/UagI
# x/rp5A1lU/sjS5OqqXmO8WxcB41K09JQqxG6U/G/VQesmI2QZpnAjc5JrJKB1W0G
# 8DuU6kPKe9ukcYS9/JbXrPbK9czL7h1MxKcqMKCb8Y7NzY7t5mqo7PbyemAXZBiD
# h1nyj1hWhRzHwmtqkshA5fq25KcyqLgd93ZxZ+HzrKW1mnRZAL7ZCSXxdDHPS+Vw
# bbo2GHqG/NuMuiGqKi8dpQiCsAq0uWuJVp8Q89BIRgH/kri+dGPcBTzjVSaonqjR
# i6ZIdzKDbGSvoEtx3+ZrKW2ApNDEp/Y2qSvLStqM5kIxJiV1+EmBmzTh0ks9XU6P
# EW9d4K5JtDjNxS5WX++1YKzTDc2znd2Du7IpB+GlwAm/tCtZZ41ZPyK82x3OKy07
# JdsUwU/gZilaoJFuBJeJ244yVzPlC5jTXPu12HQ554ghDpjOFX3eM62m5V39UYOI
# baZcvK8IiQ==
