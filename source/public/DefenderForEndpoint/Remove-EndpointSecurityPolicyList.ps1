function Remove-EndpointSecurityPolicyList {
    <#
    .SYNOPSIS
    Removes a list of Endpoint Security policies
    .PARAMETER JSONFileList
    The list of json files that contain the Endpoint Security policies to remove
    .EXAMPLE
    $jsonFileList = Get-ChildItems -Path .\JSON\EndpointSecurity\ | Select Fullname -Expand FullName
    Remove-EndpointSecurityPolicyList -JSONFileList $jsonFileList

    In this example, the list of json files is created with the Get-ChildItem cmdlet and the
    results are passed directly to the Remove-EndpointSecurityPolicyList for processing
    #>
    [cmdletbinding()]
    param (
        [Parameter(Mandatory)]
    ...
    Write-Host "`Endpoint Security Policy:"

    foreach ($JSONFile in $JSONFileList) {

        $endpointSecurityPolicyJSON = Get-JSONContent -JSONFile $JSONFile -ExcludeProperty id,createdDateTime,lastModifiedDateTime

        if ( Test-EndpointSecurityPolicy -DisplayName $endpointSecurityPolicyJSON.displayName ) {

            Write-Host '  Removing:' $endpointSecurityPolicyJSON.DisplayName -f Red

            $endpointSecurityPolicy = Get-EndpointSecurityPolicy -DisplayName $endpointSecurityPolicyJSON.displayName

            $apiVersion = 'beta'
            $resource = "/deviceManagement/intents/$($endpointSecurityPolicy.Id)"
            ...
            Write-Host '  Not Found:' $endpointSecurityPolicyJSON.DisplayName -f Yellow
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBl/N86f+BOWmeD
# cwuonIKjNAt79wkhpFbwC/iIQmkeYKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILht
# mV5lCBwIHTUsITcvUbzerV8gl1d+doHttP+09ilSMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEArCTaxxGdXuFv+QnG+7s29TUkJZP1UspV6RFZ
# Q4OZ+kT+bhhEM7efQ06UnQ33PfItlOLBRPLcs4SnqD96q/QSo5n8EyajgeJ9h7uT
# KVshQT9HD8buChdMHkPN3bEG98cfdirczVNBC6Re6pOfp6ZFznSCezwQ0CU4xKbj
# F5jkpl/IBrq7qvvelS9US67TRYafKM+i/sVM8KXsNMqfgbx0J0NuYdr+DtB+9dlN
# d5MbEq+alixlFLj+QMpnmXgg5CoZeF7lqegc+zYBqZ4WcqNvySxyc0BMybVJpIbU
# obFa/aIySO2IuF1RZ9hqltMBsF7ttQ1bw6bAO6EWJFIdAtXv+aGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCN6G6tM9zrl9N0vwUc7FK8uAofc0wmqt3y
# QEvPiNZLXgIGZBMgedM9GBMyMDIzMDQxMjIxMTAzNy44OTZaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIOUqotENv0b33WAW5+mwSBXMuQ8XHswltCVL
# hh2NvpidMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgAumWUqLDpqgW7t
# rMHOT5OOEgqmwaT3Y1NyMP2S6mzJddcB6YUwlyqcYXDSLsSgdoImRCr/j+Gj9vlL
# 3HOqYgDSdiuJV9mURTxAFoodDyj/KsVjAON38caPQ92V7EW2PaX5LlZyE0TwDEFh
# 3P8W12rBVnHlMqG+gtxz9UbZv2q4/gj9fonEl7Qoz6Y5a/ad4aompWfj9Bf3dCoa
# T2X6BK6LucPkvsLf/vnnDxrN+WTxuQmDI12ngQG8DGr6X+zruHOYFXAdD4VsAq/E
# IZWfJ+yAjQeijJA4HvvXo61lgiV69RKFFWEMBqGjmZkZbdU8p4W50O+gf855HJAx
# LWvf1Q+ECB3NB7OuGUaPslrwnPk2qWnt44somo7GdjPBRD3aRMom/LZinrfqu+Su
# BxLpgrYbeg2AFfk1f9sJ4IlUIqlxRn1+VwABN7wdqXTmPDKZzrfewcW89pmJjNOS
# E0kSGmiWwCWagCxdFGS589+yteqXmHmYstclqgiMyQre05a9+yc/wEbd5Ncf2rwn
# cT+z2aw5Od9LqR2bYKX38q5moAP4i1vU7rVu7VjqCsKSELlig9kTX8CeFfLPair9
# h0qfKvESRtNORK4Vo0iHHs6BA/1eZNvzPiTqJU0SqGXoUBwZVAkELallu21nOPkn
# AL5eB2Gop6m+IicJqQOhVfGDUTmmzg==
