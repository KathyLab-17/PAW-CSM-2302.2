function Import-PAWDeployment {
    <#
    .SYNOPSIS
    Executes a PAW deployment manifest
    .DESCRIPTION
    The function is the primary control point for a PAW configuration deployment. The
    ...
    .EXAMPLE
    Import-PAWDeployment -CSM
    Deploys the default PAW CSM configuration
    .EXAMPLE
    Import-PAWDeployment -CR
    Deploys the default CR PAW configuration
    .EXAMPLE
    Import-PAWDeployment -ManifestPath 'c:\customManifest.json'
    Depolys a custom PAW deployment
    .EXAMPLE
    Import-PAWDeployment -CSM -ProjectRootPath "C:\REPO\PAWCSM_2107" -CommandList AADUserList
    Deploys the PAW CSM configuration (AAD user creation), but from a different config store folder
    #>
    [cmdletbinding()]
    param(
        ...
        'StoreAppsAADGroupAssignmentList',
        'GroupPolicyDefinitionList',
        'DeviceCompliancePolicyList',
        'IntuneRBACRoleList',
        'IntuneRBACAADGroupList',
        'NewStoreAppsList',
        'NewStoreAppsAADGroupAssignmentList')]
        [string[]] $CommandList
    )
    ...
    foreach ($command in $CommandList) {
        ...
        if ($commandObject) {
            ...
            $commandString = $commandObject.command
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDyEX359CgiQ29z
# idt5JyEORArun4SGGs7UV1BQbDvNPqCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEPh
# oNJAh350uaeZ8Z0b3VZWmcHF2+ZbL90enHbEhROZMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAU/2V8y0UQjnrbS/WLtmJiWhU549KFefswF/Y
# MDVBmh1q9CbZ0EBlO73/49dx323dbe8ZPJy53TYHdAx5jk55MDOhdrKPJkdm303U
# ononZrb/R9h1hJJk76mH5nXpju9AkoFTq2V4OIC3nCPdw3XQ30nxTP8YhgBokTI9
# FHqVcwi2LzLnLraraBWPkZkYoKeqel5PJlf9nQyjTKkMyMI225yBDUIkYyx5hJPu
# /BaFS6ej4WqQ7eV1aGfxRcZWI84N2N+NqZoJzBnRfES2FPe0ybfJqPjwIhNlOnhV
# zCOP2Zpld9VU2+OpnF2dsQrisLkpIAUgpEzx02vK84/4jzfIQ6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCUxXxNNJVZs/uMEiNDp8kgNbV40lRG7tjv
# ExVSzgj71AIGZBMgedHrGBMyMDIzMDQxMjIxMTAxOS42NTdaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIBQjiU05CG00J8144l/OkSIJB4gVOxKNlYNy
# 0AEJKtoJMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgATEyYk3ecYwdeC
# t8/29X3Kv8gOELTz4UIeYA8Yk5OyCEDnOvL/zqhAK2rHbkF5io6snoPB/uAui2oI
# EJp62msM3Gv3Axs1/25AK/0Lc5WbUHoSTHLRneRXWnNgNBpX9C6+wIZ/l+fGftpD
# cK30uVzypjUnUK4S5VH3vGt/5Q5G0q6Xu30XjPMjqumqfZx6ExXwn93ZydoalxP5
# T5PNK2h5fj9P8Tj+D+Lqf56CDg9H5sce6bdrUYw9mJFWbykdQ1IB1AJkpEqMTK5w
# Uf0ZRMPUX58oc+kgGWwbun1yBbna8evgxOxhwLL8cB0vTiLLyR918sRP4HaTliY5
# NafAPEabR+HzMUcPpr3VMBnCfaRVbtlIvorkpY0ee3kB1GXTdDPZXxlsQFgyZxem
# D5GtBxzo4YQMaHbq50FL0YUJ0a7EnYVsVV+aLrDyw3NxvtF0xgbp4623ihIVGI4e
# rd90A7vrQle8mUqlI5cxl6iewCAd96jjEMfkmndgSg/7d1OAy6AE6poRKok1+sR/
# EdBHyb38ZBfHfAHZUSj5XE6e8wJIAunmBgewIYkOsTpiWPf18CEiYSMAJt4r+56f
# K4KJo+uhTVjfGWNw1j2EpcN2Xzk0rqNOhbxepasQaIlUiQp1C7niTXP70Te4mjeS
# AcIGu7KzfvAzPPAjvUExYVauh/agIg==
