Function Export-PAWDeployment {
    <#
    .SYNOPSIS
    Exports a PAW deployment
    .DESCRIPTION
    The function is the primary control point for exporting an existing PAW configuration. The
    ...
    Once all of that is identified, the function will connect to the Graph API with the list
    of scopes and execute each command
    .PARAMETER CSM
    ...
    .EXAMPLE
    Export-PAWDeployment -CSM
    Exports the default PAW CSM configuration
    .EXAMPLE
    Export-PAWDeployment -CR
    Exports the default CR PAW configuration
    .EXAMPLE
    Export-PAWDeployment -ManifestPath 'c:\customManifest.json'
    Exports a custom PAW deployment
    .EXAMPLE
    Export-PAWDeployment -CSM -ProjectRootPath "C:\REPO\PAWCSM_2107" -CommandList AADUserList
    Exports the PAW CSM configuration (AAD user creation), but from a different config store folder
    #>
    [cmdletbinding()]
    param(
        ...
        [parameter(Mandatory = $false, ParameterSetName='CR')]
        [parameter(Mandatory = $false, ParameterSetName='MW')] 
        [string] $OutputFolderPath = "C:\REPO\PAWCSM\JSON_Export",
    ...
    foreach ($command in $CommandList) {
        ...
        if ($commandObject) {
            ...
            # Change the verb from Import to Export
            $commandString = "Export-$(($commandObject.command -split '-')[1])"

            foreach ($parameter in $commandObject.parameters) {

                $parameterName  = "OutputFolderPath"
                $parameterValue = $OutputFolderPath
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDGeTDW5jvKZ//d
# ClUaOVk+lyObsJa4L8WOm+Y9oEWDgqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIH8qEhf3PkMXQO/ATA79UZ0W
# g5X0wK/8jQ/xLuk/zjcjMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAkcVjCqDPZXMpTHl1uAlbPcP0A9F1FYbqi+fSlzmVhLej2Em7SKIu0Q3M
# 9pZ4z9pMa+H+pA89yz/agWXItOiypkXyGXs8hU631t7fcNgUoXA9Fcm2kg47pIwf
# AgP9pzkcdPPYidEFI3CuUu9LJshMWZdJlJQIstV58LcvEsc2HK1s6JCeVH7hpQtt
# b7x0vUV0omxfHLEbH22NrXKFhxdOyYCNCAxku4u1hT1HPtr5XLkua6GAz3nVxPbM
# O45hIc1owekV6CE7BjD+Cp5MCjAsQE7tFUcf1MMCqwmdbuG69nf0CdzOv2PAKw/r
# NKa2vebiUN0MlYWCSyce1EdPEHjfbaGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDlzZygLW3SLdVUrRfSXxy5EdrpVaGAmqPzwDuL2cWF/QIGZBMNlN2/
# GBMyMDIzMDQxMjIxMTAxOS40ODRaMASAAgH0oIHQpIHNMIHKMQswCQYDVQQGEw