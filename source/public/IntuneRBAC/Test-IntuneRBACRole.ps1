function Test-IntuneRBACRole {
    <#
    .SYNOPSIS
    A simple function that looks for the Intune role based access configuration and returns $true is found
    $false if not found
    .NOTES
    ...
    if (Get-IntuneRBACRole -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBkquATlfdLsFcu
# jJQoO3BwsFZr3MJ4AsUiXQTFo0oNI6CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBA0
# tg1Lf+ylgbEH6I9CwINmSNv5oCwM1QMvY/hodJArMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAxvqCBjJcXVn6v+PYpmR7XBOYBtRZ0wScaQun
# KbyN/IvRXT0kO9zvf9kyQl8rS1MRGJlB+eCHDTndCN4sFsprNGPGUv7BZJhXfMbm
# MM2jbABGqnA2ADvsRPwZEp7O7g7BrygORS3IyC238WHOwmuXllnp2B65UlwpKXl2
# XN82CAhkH2yBorw5nfNJ+bKFcsVG64Wgu6xNnwniODdANOLiBItd1IrICfFpLhSG
# 4Y0n2ZY/CLQOhnk2zUJ3fqBVBjQLWzp/LXkbvXZVD9coKz5eZS0kCFsljU+807Q8
# VXEpPi/hLQs7JJcX+xuPUzrsQyZR79JJJFYSQZMQ+UHyzXHgh6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBUek0jcI3nTCC6f2tJStbWml5xfCCSZD+O
# YpAThSI/pgIGZBMoguJLGBMyMDIzMDQxMjIxMTAxOC42NjdaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIP6axiwb6O+EDj+Ph3Mz/9pSsNoWdiWfy1eK
# sUheTWkrMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQggXXOf1LdUUsQJ3gp
...
# cpLT3LzHpsgK4hH6lT+hDARQfjANBgkqhkiG9w0BAQsFAASCAgBVXdwYjBwRpGhH
# ljeEx5AIahU+x0KgR8uHCNpXtkIH2S6Z+d07ZOhdcI56nQWATwNgz5ytGsqG8q24
# 5GRUw0zkxDDR+CW+W9onpiBFcEJr5vokCm/4S1PVkQ7Wl8QZ2q2d0DOL02O3gW7t
# OWTOCKNKbVSHhqkhgPhGr3ugMe7wHe0FoKKpCxL4WC/k+8dfl6cTzT/2uB/VBQGu
# 2/oOHh87nvvmCOZT5Q/rJbuOtbN1QWMF6lbgRFeWb7AOnmTnZZUxYGs4ld0Wappg
# Yj+jwTfK4FNRuhG32BRHdDjoAMJ2y4rii7ljHF3gYqkAjZoCvA/unYDnhaNjNpHQ
# 49pDGcbXY8UcipCmKqjwb5KJjrOwuCu6t8KbPxLC9Al/nz7Yv/VQ3debxO8jy8DO
# w2DQU8Wkf0WVevBcxMBXQuru3DnMvGF34ILF8zbJcyWFN/FFQL+ibiM6ZOaIDtmX
# GTYdrUatT9gzO3CTLETFPYqTEPC8K5N5gba0z50HAEEoU2wZXY8z3muPc2aYHQ64
# X66v6EnejJL8bT3iOfz132W8Q/XqxxKnGTHzSeWjIJIO1Hf2T9ygl7JZwDn6iKcU
# DGBvHzadhgGLQhw77pFhWFUmsk+BFOhv37svRR1NP2nErpuLxfHzTgV1PT2VqBOb
# 6aOq4wtBSNABNZLmwnZ08Gj7PRtMBw==
