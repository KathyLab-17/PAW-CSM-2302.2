function Test-IntuneRBACRoleAssignment {
    <#
    .SYNOPSIS
    A simple function that looks for the Intune role based access configuration assignments and returns $true is found
    $false if not found
    .NOTES
    ...
    if (Get-IntuneRBACRoleAssignment -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBhJG5AALs8rA1a
# wJ4efWiuqoRokSWptqKOf3wQxHBwjaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIK3+94IuYMBc1ndTatDP4EJx
# JTLRkK2N1x5opnDCTQkYMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAbGHr6ox16HGqeK3yHTkiVTO1HgpIyMMNQ43UPNz2dUHV480OJJosj9Ul
# 040XpiyGLzc2OSM42ipPUQ95txdqRYrm83ABYrngFtl328hsUDqQg7eLxHym9wkM
# +p8Ra/BqN3zZrhLWj/P4Sb08UyFSXTkfp/5Zj/ZhsheasGibdOSXRS4+6A/2/oTB
# dF5NxjM7Ju7XoJme8t8LRz6sGBz8ev7aSJWdGjg9EWWTK9fgPgtnx1cvZVRgYlTY
# rD5j25Colm3/VBZ7usAIX3eWsJU+0/iguRIyNXNnImbYyysq51vlzEJkhhAm/qaY
# YLIg80EgTOEiTPPZvLzYimf/GDaVUKGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDuMDTmuIm6471ISMVhnCKWrsXVIYJxFkf+yfOzpeREpAIGZBNGUJxe
# GBMyMDIzMDQxMjIxMTAxOS40NzdaMASAAgH0oIHQpIHNMIHKMQswCQYDVQQGEwJV
...
# AQkEMSIEIPBWSBHF9gL+YxOU9oEN0lrUy8VAk9K+erGEEKo+xJIJMIH6BgsqhkiG
...
# BD9ulTANBgkqhkiG9w0BAQsFAASCAgBqvl2sRjz1+h02zF5tNAvnjMp3fFhnu/Cs
# hCPI1dKds/dfT0ZXVnCmyJFspict1XuPzAvt53Xm5mPnRxdWpHu2fxT4K2ju07ls
# esjq2d4OSOF0X/RsrWduZwalOl4l1zqGZpHGncdMMhntpShtqH6sol0Jb3bOk2L/
# im8vzQzsgHjnsWl8uZRFhxBlSMaWSQt63jAB6nFtY436Rj0SKRKYgXlDfJpeBKRp
# b0Zi08INivJlaG2F+PDxMBtH+WJiVdQUJo42/T1ZTdQnZkEv+Y678EA1PDWfD3RF
# IxxhiAwbU4Yg5V/65pKqg+3WC74EUsnoxhWnoe9elykMv7SYNZbMwmNEx3o7xwAW
# CYWP5xm+1U0gGoB8VRN8WS8fn5NM1wndYlGzbeC7s/NU+A6oPtVXeqJOtOBXp5Ic
# WU+1tF4t7IyCB1SLPa53OODnMIQkzjP8mZ5OEV9stFkt4qVW8P6TSmEDtrcyHOAS
# J4JKdVtqWV8BKoCbxgJ46pekgNsryfnbYfsQ8KThIx7cZhe/+PLFRz76CBr1vL5A
# mumpV5kgyhMGtIWQAMaL7EXPrlu8oaQdS8WZyz9SDWFOfbuInRFw1JJfn59PUG/5
# yxfLw3oqgrucVwxRZES6Z0Jkc3gAyWWC3mmCOQ0kZOBD98BohhtJqQ58UlC2bSpU
# FHcAxQAA0w==
