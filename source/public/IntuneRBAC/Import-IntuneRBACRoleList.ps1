function Import-IntuneRBACRoleList {
    <#
    .SYNOPSIS
    Imports a list of Intune Role Based Access Control role configurations
    .PARAMETER JSONFileList
    The list of json files that contain the Role Based Access Control role configurations to import
    .EXAMPLE
    $jsonFileList = Get-ChildItems -Path .\JSON\RBAC\ | Select Fullname -Expand FullName
    Import-IntuneRoleList -JSONFileList $jsonFileList

    In this example, the list of json files is created with the Get-ChildItem cmdlet and the
    results are passed directly to the Import-IntuneRoleList for processing
    #>
    [cmdletbinding()]
    param (
        [Parameter(Mandatory)]
    ...
    Write-Log -Message "`Intune Role Based Access Control role configurations:" -WriteHost White
    foreach ($JSONFile in $JSONFileList) {

        $IntuneRoleJSON = Get-JSONContent -JSONFile $JSONFile

        if ( Test-IntuneRBACRole -DisplayName $IntuneRoleJSON.displayName ) {
            Write-Log -Message "  Existing: $($IntuneRoleJSON.DisplayName)" -WriteHost Yellow
        }
        else {
            Write-Log -Message "  Creating: $($IntuneRoleJSON.DisplayName)" -WriteHost Green
            $IntuneRole = Set-IntuneRBACRole -JSON $IntuneRoleJSON
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA4XUZ3kjybYOWd
# VfngqDFJYy4E/Zdj3tlbyqjOIVxTPKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAma
# LBtU9XaCdHd0ZQW/UGwjR5KKALJe2X+6YWIlsMbVMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAo23CzRKTqqvwhwd8Uuqh8eMF2jVjVxlLdUPS
# oUchCyKCwf6Bkzzn/bhb82moT70HNolPiRYuNCiyvvnm+Njse0+TIxjz9tsAGYA7
# 1FzEZnu4FcKxOOHehUdbWw2DB315IrN1zlai0skJ3r4TDc7DTWA04Q9i4hL+cSVH
# RhFhp+MlQzXCv0jnbAwBnjf1vCp/sOT+jR2/zdpfVa/Rnxl3nKxmmawvfUgcDkkL
# GVb7hcM/A+PAjRO7aTzWNjrE2/HteIAI8+h42IugKqY3iOJld4o0z6Y5QE8WO7nG
# Bu8z7l8i9dPQrzNQBT/AW03GG3LfYZgoMjOHnavCDANZ/zKfAaGCFygwghckBgor
# BgEEAYI3AwMBMYIXFDCCFxAGCSqGSIb3DQEHAqCCFwEwghb9AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBHCxOLpGCLXeeHFBb4X1+LQO/U7c5X/CJ6
# 6D2jWAM9gQIGZBsJpVJ9GBMyMDIzMDQxMjIxMTAxNy42MzJaMASAAgH0oIHYpIHV
...
# MC8GCSqGSIb3DQEJBDEiBCDQAyDqOpMpIA/mg8xg6GsS2MeT/rWWAamKiL5dpX5t
...
# XO6q3rJFmP4gRk17SQ4wDQYJKoZIhvcNAQELBQAEggIAGR6r2AnfxKilk4o8Nn35
# itNBHNzBpq0ej4LuFaYPBJ6yXVOkomqVmYh9nzRZ1FgHzXJLqkdm/uIlW9fuP2DE
# x+WA+/ViKqclo/LbcqvfEg4SHGf5ahdLcBGoTWl6lNK3+3435udW85prUVw6sC0E
# pLXuXDJpN8HIgamZ95vygoxQLCly6VCX5x3006dYWmMuxhYjhP/W7bL6q7VnXhcn
# pgJMrlbtNrxyhEMFrc5godRADbPFNT8ptylcmHQNAvAOJE0WEGmkdRyPjMcBpp8k
# k1HdPNCrN0eG12l6Z1fgkT+OyFDUJ2gq07AzwIrLjEhHxTd1iSLra6B9JQinBocZ
# ZR8O2HGnYMw83o9p1bboaXVqJkcvtn6YbrgB6DtZZTs6JC4DT8eH+40ePpErYLs0
# KFLFrgxsceeO47mvIIgAIDZwLrOeVgYvF+fUepVpMh32E4twqMNeSczLM9yTmUVn
# OgArygqcEHAynz4KgzYEHV/y/f2FAr1UsXaJN8fxjksCIskATc5wj5f3NZqqlCPA
# YgsZMe+zzUbrqZN/8G5IrPsTsjgJxKaN2act0yinZNrQohSMv9RtePhnyQ0UgYNG
# HH27IqxgZiGE4zRAO5TTxwq2aYD9sMheZhzEtajBj9I1a6VQ/Htb49nmiIphcmC1
# PoZdPB2LD7UV7ZQdaTXp7yo=
