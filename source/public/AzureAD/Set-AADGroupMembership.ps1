function Set-AADGroupMembership {
    <#
    .SYNOPSIS
    Updates AAD Group memberships
    .PARAMETER JSONPath
    The path to the group JSON configuration
    .NOTES
    Requires scope:
        Group.ReadWrite.All
    #>
    ...
    param(
        ...
        [Parameter(Mandatory)]
        [psobject] $GroupMember
    )

    try {
        Write-Log -Message " Adding: $($GroupMember.DisplayName) -> $($Group.DisplayName)" -WriteHost Green
        New-MgGroupMember -GroupId $Group.Id -DirectoryObjectId $GroupMember.Id
    }
    catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBrIXspMUbbLp/D
# ZYaNB4fQ2+3fuX3novafl/MXn0QnRqCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# SxyItKQTF3fJ+D+0h7jOoJvc8NtLouN2JqsxvaBNMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAfR24wjI/qf/63SAE/iwmRbvD06EAPtpSyCWp
# uawPDaHnBPur9Ut2rodA0WvBz5SoMuLyjS//1DPcYGsQjZ7uhphoZiW8Fqjk63d0
# fMhg65fwc38nA25z0tpzJrfklCOqt9ITE5ec6sWZZRn04w3Et60h3MdNBuW/dC9u
# kcjIyUWTGfl3Oej8Ww2ZcQvizus0jlK1c/VUtyt5AekZrWdm47jGoQ0Dj7HYaCAw
# Q26LVX9r1B53qUdrplBbNdT3nq3NcAIJD40hDpcTO5int6HaUovwfz53non6Htf9
# lOaNIskHQPy4ok41WbPXiacwHVgaQy6S5X54GnCU5EoapWDj7aGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBtjypYzEAa4Tqz1aHbvHOclmfeEKvZgv/w
# pLNhlm9ZIQIGZBMgedIuGBMyMDIzMDQxMjIxMTAyMS44NTdaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIIQ1ShFN/LFbXyzjc0YQee235IztEbyaKyU8
# KcYkwJoaMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgAolZglgRJzgVCf
# bmYhsUvbCwyXD2OSQlBLf+AztwpLBn4wbw2KwEFnudk0Z9y7Sq1BOvYxE0FbV8qL
# 2RlYI4fMEQS0co7Bngj6Vf/UUykJx1n2yhYWrPmVXeGb3DtxNrDoD2fcFQlB+rLG
# g5yhGVpFmN3SZ6APDM5XgP5QuQ7HDjcm+jY9S9l1Zq1Zx2WxdrTrJhR7GpnWQGRS
# xRTafgd9bUEIjzK9LjHWCLREhd2nmRno/kVvfmTDzHrdRUarltWjOIEwn9Cjad+T
# oZnz//Kdf4wYwXBpwc9t+LypOdKhupMmmo4pHvbOcsh/nxEFssxnG2aopHVjJfHT
# BmkemfCK/0px1gJtQ0CV3BRW2PByUy2sIF0/M6UmmgnVJf59oievCBoOceYf9raI
# rKDob8bXigOhb01HJOYLwwjuGvtRDAPM4ixE/yz0SeLQsIxHiJ7GvP7FYQD+XfgB
# n1t9nLMjrNRMs7WD6TTIvwfpAcqI0eGD3TqY4mo+aNzNFgvTc5x8e4ZYkfHp4msx
# SMqUxj7TSoxZk9twcWf2StXp2Xm/H32LpDE6WfJsKG0fMxyjGWiRvgCH8Mx7GkOL
# 4cyoIKIALd83BYGfNmnF1vbmVaoj3pFYfXN2bTareAZnUkt+kEXOtnBXd0d9ONwr
# ypRGE5RK3RzdMH0NEC/afw9QFEkOGQ==
