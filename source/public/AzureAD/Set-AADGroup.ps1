function Set-AADGroup {
    <#
    .SYNOPSIS
    Creates a new group in AAD
    .PARAMETER UserObject
    The Group object imported from the JSON configuration
    .LINK
    https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.groups/new-mggroup?view=graph-powershell-1.0
    .LINK
    ...
    Requires scope:
        ...
        Group.ReadWrite.All and Directory.ReadWrite.All are not enough when creatin PIM Enabled groups
    #>
    [cmdletbinding()]
    param(
        [Parameter(Mandatory)]
        [psobject] $GroupObject
    )

    Write-Log -Message " Creating: $($GroupObject.DisplayName)" -WriteHost Green

    $groupBodyParameter = @{
        'DisplayName'     = $GroupObject.DisplayName
        'Description'     = $GroupObject.Description
        'MailNickname'    = "$($GroupObject.DisplayName) Group" -replace "\s", '-'
        'MailEnabled'     = $false
        'SecurityEnabled' = $true
        'IsAssignableToRole' = $GroupObject.IsAssignableToRole
    }

    if ($GroupObject.Rule -ne 'Static') {

        $GroupObject.Rule = $GroupObject.Rule -replace '\{controlPlaneIdentifier\}', $script:settings.controlPlaneIdentifier
        $GroupObject.Rule = $GroupObject.Rule -replace '\{managementPlaneIdentifier\}', $script:settings.managementPlaneIdentifier
        $GroupObject.Rule = $GroupObject.Rule -replace '\{dataPlaneIdentifier\}', $script:settings.dataPlaneIdentifier
        $GroupObject.Rule = $GroupObject.Rule -replace '\{accessPlaneIdentifier\}', $script:settings.accessPlaneIdentifier

        $groupBodyParameter.Add('GroupTypes','DynamicMembership')
        $groupBodyParameter.Add('MembershipRule', $GroupObject.Rule)
        $groupBodyParameter.Add('MembershipRuleProcessingState','On')
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCcSPIRU2+nM0m2
# KL5jaGXDYpyVeKlCC3TGNegTBDuPWKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDja
# Srtf1GZW8jslPhE5ZasIByiIp9ZaCnP+qQp7627vMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA4ZDmmYo08AF52qPwogj7aPDp+K2d2zta1PRt
# bPTGjiz+wz/u1DQJ1lQF8cme6M0FNLa1lETkUi8DgQ3yIFyucXkqZpqxJ9ChhHoU
# ZLapkr9bMqUiX6mJM/fjxItyLqxN32MUt+1VczzUZHGfIhZAOx875WJaGBKI93EQ
# cXDfbzioIJjdXkrucl5mSsoytkNKdPks+m4NOJatHqf3n7CyerlVna05NeCt4+Ov
# rOfqehS1MaLlkH+HOgzqIpYLxt2cTF3Xl+P76XZMALcUJZLCqnVLunQ6v312GVY1
# wrK4ocGjPVl7DtkcroH21y1phX7d7zoK91aqqrdEqP6PeZXgAKGCFywwghcoBgor
# BgEEAYI3AwMBMYIXGDCCFxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAmvvUwI7ZiFlOw+l/6A3/8x2FgP0N/MbhS
# DX4vaWq9kAIGZBsTUZy2GBMyMDIzMDQxMjIxMTAxOC4xNzZaMASAAgH0oIHYpIHV
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgKQw7/hbMswfGNEFlQKLCf50PjCePoLut1JaF
# H1l0HjwwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAnyg01LWhnFon2HNzl
...
# IKao0yXV501bCoKS8UVKs3wzMA0GCSqGSIb3DQEBCwUABIICAAwE2FbkAXJ48WqB
# KWVjCqGy4K2UChcSHNVWnq6egFWBsZenSByvKE8H1J9TPS39Yam5I21rSJXn2v0c
# +gB3j6NqeLRXPfnmKjgTQchNVFteR7usFZsV7S6QoOSK5HZOUoCs7lm0ilYBF/PP
# rwnjp+aeUrmdWjzZjiXxxwytQbiadVoC38H7Q7tWQnE7DOvDDgRDY0wMk68BPU8w
# lXNlCEt8XWvID7VoPHpwxBtLK6+ndZ1JcyvF+xk+f7zxku2jooXtGHq9IRz1UOrB
# kcZdIqQZ5/BwcqOuls1JK2mmOu2YU6e2mQ6TfNkAPV5J+ISasFdLnyCRWHGWMMXn
# JKlXnNE6ny3XbpiDYJvrrVzSAbEt6QCIkWjuFG1W2G2SiGwiCEdaJ7Aw6ixSWLaq
# Fw8ZZ3W1I8Xr1RwAcy+V19K1MNeDRgAggSQYpzAAAYbFjDRVYI/WPCkqODhvAq/R
# SxNmANAO93Wf9rijP4Yr5aJYyTXExXROmc6XyFkU99lgiwHw/mZP8Py/fuXoOqVM
# IWRA0dPxDvJqVbizun6veurrXTr4z5clihXUjbCNw/ksC+SFujU5uZc1QkrlcyHp
# nUishMK77/3nenQUykngJxxxHijRy5F7BGru3Z8OzGZGLtqZ0Y4TD8cNbV4Ei2/V
# Nao+wcj2MGfVck4HQnmyTo1z3Zfr
