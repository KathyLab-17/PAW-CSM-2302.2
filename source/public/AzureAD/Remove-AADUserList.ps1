function Remove-AADUserList {
    <#
    .SYNOPSIS
    Removes a list of users from the AAD Tenant
    ...
    foreach ($JSONFile in $JSONFileList) {
        ...
        foreach ($aadUser in $aadUserList) {
            ...
            if (Test-AADUser -DisplayName $aadUser.DisplayName) {
                Write-Host '    Removing:' $aadUser.DisplayName -f Red
                $user = Get-AADUser -DisplayName $aadUser.DisplayName

                Remove-MgUser -UserId $user.Id
            }
            else {
                Write-Host '    Not Found:' $aadUser.DisplayName -f Yellow
            }
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAy5KDj8V0oTJvO
# dprkYma9StI0iTJPDcK6o0jx4xR+fKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAshpeKU6lkJ/wRH1cH7aBfT
# iiQXz3mNiXaGD9nc4lHaMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAYw/oZGO/+FHWInTuWaIlaHBrz8TaqdbsDSOexLvTOKAu1RvH2AvfhI2Y
# gfT+oxr5oXUcZgoofXjPrUWMZbUCuzDi+Mv0YS+dgAdEgg4uTSJshAeIs+4i4LnV
# 5nsP0OW2sr7jGnit4RHRqF7cS/uzoGZQXFNLIkZT+KkCbuA4f98RTDucFhAAhTW+
# o3D2g58avcq54f2VSSNUAEwl5vpB1oWzymYw/J+LMdUTRPoGaYm3vyKOluBO6930
# LfhAFb+lMzLDlYXFuHjTStDgNyt/gQIFRFOuQfrKhsn9BQJJe26JEGWAIbvNEHbL
# XjP04jBZ4g/10+WWT07CFnLP5PHeEqGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCAJ6z1d+iGkl2DgiwX6OfKQ+QODzPepufT9meLYxYVdBAIGZBMoguJb
...
# AQkEMSIEIHuixDZPrh2TGsOGQhk/tEnj7z3dslYF+NMBC8EAplCPMIH6BgsqhkiG
...
# DARQfjANBgkqhkiG9w0BAQsFAASCAgCUWJ0ulxvFCucQuhpfgk8VOgQL0XPo5W2D
# arP3PkZIcgOWv6Y2XqQV9GBIW4kaPSSR4L+h9w+HOZkkvdS+8hNHOw53JkBadGzB
# NeWHRbe21qQTrY/VhfSNSf8+5278XTiyvGCqgBB8u9CPHTmVKOO0e5hnLf51Jnu9
# /YpjZciZz1wouWiy19QPllDf1ux1H88hajS/0rtM6R+ZIJtgs5ewwOeddijFw7m9
# rGCFpZOtpdLIgn/rN32QjcQP8V3Fxx4ihib4CV2QPpu8WcvULakImIG3stUBEt13
# /90Zj/kKS66TMWcsDqOjP+Pqmfjg7brMUKRulP2tk4d5wsDus9XhEaS4wnT7G1RJ
# Xjm4RQCLSQgB7Jv1KM9ZbPueZ6NqYmr0BPlEqz+JuqcH+h82GpAjMSxc/H5qtXI4
# YpzcuQZmD3SdE2X0za8hZd4e9nQ20aYh3Jp16meC4sNtMKAYDjX5R3bWJey6MuR4
# 4hl+wzIaXQjDpF0+jtB4gI0dp6HGHkgKAMqtWciszK4IndJX4Xp6NXQrLKCyjzov
# N990vEWPMdxziEkkjeSrP7M4bcoLrppsqI19WjGw2fIMhjNADcUC+r6oDelRmiUv
# O5a+KBcR2KQ8wPr0dwkY9luv8aVV/LQe2HL1/QfLTEZ9F1kLrulsZUR5ZZnnhOmV
# Mhcac6bm8w==
