function Set-AADUser {
    <#
    .SYNOPSIS
    Creates a new user in AAD
    .PARAMETER UserObject
    The User object imported from the JSON configuration
    .LINK
    https://docs.microsoft.com/en-us/powershell/module/microsoft.graph.users/new-mguser?view=graph-powershell-1.0
    .LINK
    https://docs.microsoft.com/en-us/graph/api/user-post-users?view=graph-rest-1.0&tabs=http
    .NOTES
    Requires scope:
        User.ReadWrite.All
        Directory.Read.All (to get the domain name)
    #>
    [cmdletbinding()]
    param(
        [Parameter()]
    ...
    Write-Log -Message " Creating: $($UserObject.DisplayName)" -WriteHost Green

    $TempPwd = New-Password -Length 32

    $userBodyParameter = @{
        'DisplayName' = $UserObject.DisplayName
        'PasswordProfile' = @{ Password = $TempPwd }
        'AccountEnabled' = $true
        'MailNickname' = $UserObject.MailNickname
        'UserPrincipalName' = $UserObject.MailNickname + '@' + $domainName
    }

    try {
        New-MgUser -BodyParameter $userBodyParameter
    }
    catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD6ulf7MgYPmq5S
# STYNz8Wu8yQVt90pRb/fMoKva+37laCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBro
# UOROZV9tewadRMxrL0ho7ey3QMQRjq5AJ8va7dciMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAJ32EMbNHJylZF1ttIFIaWYQ7lpeo6ZlXna38
# /BEKvaLws7pqjMYZoWzFMeFl/sws6xvvlWa7NxGxCiL3F0+0TtopS4bcwA9oVMUE
# u8RyGBQ4GNQ5B47nTdYH16NE/5+gVzTvmOnfJuj7PSwpGzyyN+ptqOThaHSavbdj
# 4OD9KXscpa+6j9tNMAam4RN0XSe0fVK0VIpFkTbB6FRcjh8C8I3oLJW6zcN94pXU
# XSqhUr271HbiONhs8ZZe6wcB3YXJB5QuEOFxkm2Ytheg6aqUEjXWPiMZQiu0X+k0
# +AIgpSZLJqOHlMJIQo2gdSQibQ+LuERMf71TnSvM03aQ8C70VaGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCT8tt8fdQRSGCSedWDb9nSFeiZpLUfiAxS
# prTgp9dRKgIGZBMoguJ1GBMyMDIzMDQxMjIxMTAxOS44MDlaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEICUlRUbyBF7/j87d4iUhoyaH5kxh97Ccpr8N
# Dzn5lfMtMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQggXXOf1LdUUsQJ3gp
...
# cpLT3LzHpsgK4hH6lT+hDARQfjANBgkqhkiG9w0BAQsFAASCAgBMgD7s0ljatYnJ
# gcNimEDWWdOTy7ekW+7MJ5dOWCbd+izMoNZsf7vQCaF6MiBAwonXjMkbzHsfPqQs
# 5qQHKzbTZc2bQBBtHINMj5ox4OyZPOnh8RR1BhpUCHOsyEdjCmOVbprt+sr+OgOo
# 6TSYFwdP6MyGwdWceSlWlHQiQ8wPJLo4l+HXA2aEhdPRazmw4+BYndawn6IsubrB
# CLd36Duy9n+931wf8owtctrNdymt/Qbi30WuDWIzVqOwpQYYLFUX6LfjY06H/izQ
# vH9Uy1nbO4e8waeK8vRWvdN3eW95jeoX14WyIbYY8+OK2CoCBpaYS4rcA9KTyVSX
# voZrMrgsS3zFeHIjqPlbhRGJgaqSILiQ8gc7NObefZqbajUYgm1XsyOeTdEdJn/Y
# x6tNXvlrYplJS5/yzsiQdF1SRzSNG3Gp10r20QTbRgoVLDWvUm4oKg6A3NyELPg2
# x3NSTJUAqUa/xtpNTif8ZWIAM5DY7RgB3IAOfKUwYhTrubiyFpXnp7BMtsjeD6id
# nssO6NpzW+Je/gVeilPeB2R5P46cMt70sxMKe43ePG9LwtAB87T+WHnFlGGXvxM0
# 4/X2+TDzSrTSFX2QNCbuq8vC5ibfN4PtW60FUd2cwbYkQw3IXNXYVPCV4p8fzT6q
# TleA6cvUY5ZIafnLAlrxR7M6ktcFDA==
