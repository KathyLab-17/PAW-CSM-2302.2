function New-AppRegistration {
    <#
    .SYNOPSIS
    Carried over from origional scripts. Not currently needed, but customers may request it over the device code flow
    #>
    ...
    $CAAppReg = get-AzureADApplication -filter "DisplayName eq 'PAW CSM PowerShell Tool'"

    if ($null -eq $CAAppReg) {
        New-AzureADApplication -DisplayName "PAW CSM PowerShell Tool" -PublicClient $true -ReplyUrls urn:ietf:wg:oauth:2.0:oob -RequiredResourceAccess $reqGraph
        Write-Host "Waiting for App Regitrationcls to be created (45 secs)" -ForegroundColor Yellow
        Start-Sleep -s 45
    }
    else {
        Write-Host "PAW CSM PowerShell Tool already configured" -ForegroundColor Yellow
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD6T1JkT28/chSu
# S0nan8EYB+i3rjzoyq7T7rAlURCZj6CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEUr
# ZZDXjXpAQh5UdNsdeal0xHLEg/+FjmAl9fvrPgfYMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAyIf/glIrh0dvb60GwtEka5jmK25beA/q4cRD
# IQf5SGi+K732Tef2RYXZmfzOw2GJXcZf+6jYoYv5D9OuGGLH7OoAFGGkPFIvYVx8
# INgWMmv7dhujv4Du4Dtlhg7ZO+f81T9WvN7B4PkfmGvxk8gVvqyq8gxCq+wc53HE
# Ii5VN44wv0xEWFtPcytATLIzQtl74zVgyvthWByyivdStKZvfNwTtTVPArKBrmXp
# mpz/PWLhY+EYCknHPCVWl3woDnxNnzyoDDmhG9M8euEDzuKrONeqGjWcm0ELpkrV
# 269adxtCsKZZWcuKVcNkWbAsNv607WFDHmMeUTu0OBx4Cwm8UKGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBJLH7tQvyLCzs1v5q4UA9kKIJdbbh7dCo9
# XpCFLMh/wQIGZBNQb4ihGBMyMDIzMDQxMjIxMTAxOS42MjlaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIJzUTdByB5TryscvRmn95XGPFq2Ewr63kEkM
# P5QdVciwMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg/Q4tRz63EiRj4K+1
...
# cmzprmq4oT5/HJRv+dViI7pOJTANBgkqhkiG9w0BAQsFAASCAgAglVytIoSBb0Nj
# 9jsof1IlHlBP4ho85ZRIFkXnVKDqZrXcLs8yA/7CZqSTOU+iILQ9BZ7RoGHafzhl
# hAyWk+LN+1+xEqXqpNFBfXfO+4ujmbd+OTWzlT011CXxndmenD+GSa9zCAnur42L
# fWuNik6zTV64aCssCHeMA75iVwqCPzoLrK8IOeVEJJbDNIVrsl+Ud7E57zKZ4CR2
# 2h1eEihFoH4rv86DZrS/UmWLxwayeuc1hdLegycWY2tznuF/BsAg8Lp8vgDlOZgu
# VHzgpXxPy91kMOr/xs/xi1VVEpFYVp7CueCjnaD3+bfBLy+l7nv0A/v/CthKl6Dk
# hBogvqSbtqpmdYJNsgIY+qb1NX5SvXuljZ8oi/CNAMicsTZQ81pNsCZF3zTxDW3K
# CM0ypJ62pxwlRDsH7G4qS1srh1xoNIs8Jv/gE0rj0Vx/Nw+9Gv7o5B1c9na4qtCx
# b9jHFrpHau9Kj36pbed8Ml1BdKNKufy8fFtbpS2dJU263cZ2OPMK1BoHqDlb71dx
# NoT61VTF6qigihsmWFfIVCK5GreTqpmudg8yMSZtK1cR6Plyhz6Bnftm/FLUOqyk
# 4TNh3NV+kAH7e3w6dhiW3M1uQ6wP77ggBjhzoqWpDu5IJRjzq8CXvI4L1n4qDt/4
# lbEqI2eHhuVC+wT+1Sbvnc6EpRtzMA==
