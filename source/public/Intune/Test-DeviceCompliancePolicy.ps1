function Test-DeviceCompliancePolicy {
    <#
    .SYNOPSIS
    A simple function that looks for the device compliance policy and returns $true is found
    $false if not found
    .NOTES
    ...
    if (Get-DeviceCompliancePolicy -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAl8SeIyvb57Qn5
# rK/C45iBposqovwEibE2yGug32ViVqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBxH3P2qqgMdgpvQq0YRbe6b
# jDZoyVoIHgQHVSJxZluVMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEATo15R/qflZiB+mxxv+/QrDMe3azSguaJCT4CPN3xGOJyxci7I5I3mhOk
# k/oz1KNulLgW4EG93fk5AXiEHeqPdNtZSKjF2ZZl29sKOfWSi0fQSzrJfHCAR0TO
# Zq+hbnDFf0j9AX8bygZF//iQE4HHE1JxmzaQJ6pxqHjKh3mNBVQTKa6gYk0LTDdp
# YzzVynVJUDpMuyoz4RjjdNeekMYE7BbXxAragmQhmtinFo5UgK3/rMIP+74LWatM
# CmIlffR03Wr7zNu2G8pJDzLYmQLMOqOhuI/Xgh+VVz/9PIUmFtflXfG9mxNDoRSQ
# lzzBFxEhHrr9109UPOh28MOqYnErNqGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCSKLTXq4jMrIZiiGkiwgMLhWVVPnXbrL7Uz5RYygCe/wIGZBMoguJc
...
# AQkEMSIEIJJyaKZQMYTP3ZDlKdp5o7mXps1/8xtD0D/enbfBuufEMIH6BgsqhkiG
...
# DARQfjANBgkqhkiG9w0BAQsFAASCAgCn2vzxaRgTfuvdnUmzSMAKIAu8vED/Vsce
# L4hVT6X8avtP2GzG4Uq+CgelY52J48s5wTgoXpaLLr/8oj7OicyoiRo+UEaLeFjE
# Byxon9hcim6+xK5ueJUjQ2AwbmNdDZI2hbMncrJzEhr2ifnFFsofp4eMpl6nTwfs
# CPepjJkmIPlGk56vplNykuug466ycYVyGXaNMqa7lA7gMU3B2cW/KzwAfjza7q08
# kyh7T+r67Rn06V9FaXTCa6YqiQYVGl8qFTdoh2Mjkn0dQYYazFSKcFjpYh8McUCR
# CpEPZV2Zl1dtFrxau4q7qZE7dUoITkvSRVCJHMq0KzLTg4BXkkHEG8kfYTv7uRVe
# M3XXwdteNjUXAU1YKWPhw/mmpLVNgLJr5nT2ollkwZUbaXtOXJqR8BDSUO8ZUTlw
# rzjGW7z7wJBFrnyjoK9H3Ms1v25X+zX7F+ssHkFTjJCuc/Jut00Pvai/L2gFc8dL
# Laizhb9v9w3s/UXvtB7oXTKme3GvOtMdchxZJ98gRKnHpvwzOii8/mtDGKIx4WAD
# /TiOWsZqp8gRSd8RGKtDatWvEt7Ke8DvxUk++ouX+9T3s+G3Um92h1viMH0k+nZ2
# SOrb+AApbUVN7mbBG2ekHyiS+ZCzUxp7bKrRNDjXGkwJDTuapVEjiq2UymeXDCyG
# iF/snT0IyA==
