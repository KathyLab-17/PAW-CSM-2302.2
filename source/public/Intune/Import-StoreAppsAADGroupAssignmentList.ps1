function Import-StoreAppsAADGroupAssignmentList {
    <#
    .SYNOPSIS
    Imports a list of Store App Assignments
    .PARAMETER JSONFileList
    The list of json files that contain the Store App Assignments to import
    .EXAMPLE
    $jsonFileList = Get-ChildItems -Path .\JSON\StoreAppAssignments\ | Select Fullname -Expand FullName
    Import-StoreAppsAADGroupAssignmentList -JSONFileList $jsonFileList

    In this example, the list of json files is created with the Get-ChildItem cmdlet and the
    results are passed directly to the Import-StoreAppsAADGroupAssignmentList for processing
    #>
    [cmdletbinding()]
    param (
        [Parameter(Mandatory)]
    ...
    Write-Log -Message "`Intune Store App Assignment:" -WriteHost White
    foreach ($JSONFile in $JSONFileList) {
        ...
        foreach ($app in $appList) {
            ...
            if ($app.appType -eq 'Store') {
                $params.Add('LicenseType', $app.licenseType)
            }

            Set-PackageAADGroupMembership @params
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBmE0TtwhpeirT1
# UVDdTx1UKxrjfZe2REHqRyEqT43xcKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIADV
# H6DhDAM0tPRNZ03mWMRJFcpzj52p0cqae/rI7qu+MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEALgQvvZulcZWVsWIq8ozRBklkWQcEpp8nP2De
# MDj2cShGQJY2LX5o0UBq45Ru5i22AG4K+9I2N0xCVZ1pMWyMqzSxoraDZMueYvWI
# rv//l8pYGYht2aUUkX9vPciKXH5cKRgJipjzlLM+O3CcInS8TAaPi4Y3qkMRyzAT
# dvU5qf668xRrOKbsJROFdJxffS/F70JbOsISsaUHEYF0dxE2ZwEHcDtVJ+r4GB+9
# J6Dh3E50KpcHxG0rc3CZ1a5Y6mTxbjlmw8HPC7NOmHwRrlt13ZK1+y9ItdwoU3zG
# /v8A4AgIkH7X9t297uwXHGv/6+kTn6/1juVxL29ttNHIJ5JMkaGCFywwghcoBgor
# BgEEAYI3AwMBMYIXGDCCFxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBAnpRdOvU9A0/AePDWHQyNwdhD6AYnI2JM
# eampnZmKiAIGZBsTUZyhGBMyMDIzMDQxMjIxMTAxNy4zMTFaMASAAgH0oIHYpIHV
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgviQ4Q5PNZUQlFo+rYU+TfWYGKEuze5ftBpyl
# 2p4np4owgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAnyg01LWhnFon2HNzl
...
# IKao0yXV501bCoKS8UVKs3wzMA0GCSqGSIb3DQEBCwUABIICAGoqt59yb92iPkNR
# xYGTFwYPNebj1Xl/U9Tet3ajU7t0ZbCZ1dkh7Q61wt+cggh9TxNtOT0uQF0I5VFN
# zqGl8MifDDSShzYL96TAj42SAKBU9u6eQFidcQq/Qr61WiXHCTQ7H+T5Xdb3WrxC
# +gUgyI8aByq+AecN8Q0X4z5tXcfK97KEWoqWVZlq82COtX1wJnNsvrjVC+MqV/ZS
# +GlzHBdKqBYWRtvjSbzifES15m5X9Y4fUkUxlaSU2qDxUkx6d6v0seeR+3pL5RBz
# 9qeMq1FY1xgrlzDdwPbSmMf2h1mx069OdpdZ9rASRek0mx+bseNhGk2mD9PO+UiJ
# 7rfE+cZu7gvnapa0hHL3e9pfmOafAbpOpO+p5SjCX+9PDxX20r2T8yf+EjyYJX5p
# WO0qvtcfwrEZub3AsqhW2Av4j/7Alg6pqOvCo2HB53Y6YI6QniGiij4laQ3Wclwd
# AVbCSccD/q0AhUUfEeA+RPnndU1P0k0LnxFjRBOwLvhvLuuNix0w8TwgbPaaXN/E
# 8tDjJc8WWMwFH0/HJLj/X9bqlUX7YptayLJJ+FfdC3tuxn3Cck7bObHhrFovk1wc
# RVMwytQIwyqcVIqOI+t/EmwO/FF2++BxymMM5Ui4kpuFBp8QdgXv5R5TFudMekcR
# 92mjZUd6VF/oOjVANEOQgNXxlHAG
