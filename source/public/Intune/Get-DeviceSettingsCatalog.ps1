Function Get-DeviceSettingsCatalog() {
	<#
    .SYNOPSIS
    This function is used to get device Settings Catalog policies from the Graph API REST interface by name. IT IS A PITA!!!
    .DESCRIPTION
    The function connects to the Graph API Interface and gets device Settings Catalog policies by name
    .EXAMPLE
    Get-DeviceSettingsCatalog -Name $Name -Resource $Resource -Identifier $Identifier
    Returns the matching device Settings Catalog policies by name configured in Intune
    .NOTES
    NAME: Get-DeviceSettingsCatalog
    #>
	...
	#Will return the JSON content of the policy, if it is found
	try {
		$uri = "https://graph.microsoft.com/$apiVersion/$Resource"
		$result = ( Invoke-MgGraphRequest -Method Get -Uri $uri ).Value | Where-Object { ($_.$Identifier).contains("$Name") }
		Return $result
	}
	catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8lvJIRMKp6lEk
# Qf10FS4YnbUF8qVBkK8/o1BYCMVyyqCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDWu
# rIkgQ0j0+R+FzpfOWcZgOApK9pBEg1U/UkE3U0IJMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAxt6YxoTMBzbajCp3AFawLN661LRmAKqNbOGa
# kWcy2jIclZ9l0BbQ6gTe9f8yGoeX50BPNg7hjOrk/Xw0p9GHg+Mrnv2/GKcsLYpj
# adzZTLA1HIVzCAtybNLw/Of6hiV6XOsI8dRUNSyPQNKWOf11zY/pHjjd2F7r/bM2
# rPqhLVVksNxrTr7h7Xe3N5yEnySTGvQ/Iw12X4AQqWUvF/xmj6KgUGUNZjnCfIai
# vkZokjfDXp52sX3/mGA4H/tdwjGVuP3wW81Ji1Ko9d9bbiG6ajSSXcLyPbH/B2Dn
# xPQWNIdZcmMrft1MzqFMJrwPYYod/o5vpa4Syb85Z4QtjHgUlqGCFywwghcoBgor
# BgEEAYI3AwMBMYIXGDCCFxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAZooX+d4xISMDoNqivQIa8Tb7ATWL+qvPo
# AZApCKtVYQIGZBslkL1RGBMyMDIzMDQxMjIxMTAzOS4zMjFaMASAAgH0oIHYpIHV
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgIifs+HQNuXai/93jMJTGAq4KiVkyAamFQ4lf
# pySYpIcwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBsJ3jTsh7aL8hNeiYG
...
# VJB+Z+n0fmTzxNUlZPnKggUxMA0GCSqGSIb3DQEBCwUABIICAIdxwkRinUcPgS5r
# JhnzhqjEo9ydLA8eiJE6fNDLOfF6tYRmP8jvrxTTkqKgKX9fxo6NjGNCIr2/EyFD
# b38SXMkENQpscTcmTj90R50AaWjojnBHp5zXKiTA37lnN4y3cd8Qc66/SgiAMA9c
# e7bfitGj1X/OpPabjeP8mi3XPFRYwHC37LqkiyZBhRKJEGYTwTYvI9Xp9xWbBoRm
# u+VgjTtmo4VMRJKXyUleaqwF1i/ROAnJd5+GIBmRsrgIdXIT+46Lj5A+bUiQT+36
# OHH6R71hyqW78m1TL7izrq/ZxTF6++YUQxYHlnXnOSRV8ENoVjILv7F6YqpFcTWx
# KAqXB5kUdMK9wCVmflRrJL/P0I7TmvSYK4unhHfHZwjwN0lL+blIYkq4BJtWM9eJ
# gbAYehJeQi1SKddb4KnDJmn2+OShHsy1Qtg5VzWFG3TaJ5PbyL5F8p1/FwjIqzaS
# DGUVfZiEBliaOoC202yrjbPNH3S+W+C/pfoNAJAOlzGuBvs7eqoFZtKFGDfRi2OM
# u8RnVtosWIkJ1QjS9hWCfGSj5XpLa+SBq3uWEsZgry3MSRqsOKV6lAcRDv86RiJe
# 0CJO8lJhKIF3TCuGTAbeR7XyV3RMtee2PtLLq/bOzYN6ZbShNb55FrlJCuj6cDUQ
# 3TAetypgpz+8UwNdHPLwW1eYgWWz
