function Test-IntuneRoleScopeTag {
    <#
    .SYNOPSIS
    A simple function that looks for the Intune tag and returns $true is found
    $false if not found
    .NOTES
    ...
    if (Get-IntuneRoleScopeTag -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCjA4RC8o/PWZ18
# IUhcnpRROiJjlOyh0GMti2RVX+4CxaCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# D/6pWOMVR+oFUekCDRMNp0rnz25sweqhAn9X3pMIMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAOtKy9mHzcO+QnRmzkcjRuvlYGf296SrAmhAE
# P1aK7c1NgJkfk799sKRrwHd5baYCdC4kEyZdXNunKJ2ja3Kl1aezbwEJX6kPOqTY
# GBwDqGhsJLKvN/IDNBO1nPFt4W2R1+autDbgC8cH1wqP1s0dDAxwKdpU+oOEQ6IH
# egINlZHTAXjBhFxCFLh2uqnQLp+WbgzZpXVxqxHD7aIV1JG5bjsB9nS1cTtZEb0e
# PYNqN4+4oBMtG0bTfe9Y9wwY/ZRnTLiAYjURstLzs6TTVWZ+oJpbVlyqtlQnJkLd
# N4cAH64AcAFVOlwDi2ASskQrgXRuF7pvj8wf/1UsatHnsyPVhqGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAhj8DAj4n4uZPMVMUxdV2AUOPXvvo2wcm4
# euzezUn0UQIGZBNduD+lGBMyMDIzMDQxMjIxMTAyMS4yODJaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIBg3qu0dT7P07vg/P1WOJyef2idtZ6ErkYCY
# fPXqnuYfMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgWvFYolIIXME0zK/W
...
# v3XZImgEh7IGrhHes2IAq9B9lTANBgkqhkiG9w0BAQsFAASCAgCY0jRxq0jK6tgk
# ZoWi6EpQBACBHS74iMXMf2o2RCvkUdnGd25p5y5Q+s8pbkiS0c/D/9bUl/E01HWJ
# Lcnqs97hOwJSIKEIgW7ADCDQXdoEVJDaU2J1i+JJH8ShXpH7MS8wrDQq5dkpwVM2
# dO9Mv21sTKlX05cZSEsQYivGn/g4Z5Q2oVHH0CmSP81p9CxgLoBNHdrq41z28TGk
# WNzXGS0Fdx2vtT0MEysYriZw0HgfMCnZdHGhNjK9QtvUTG/6OL02YSr+qDyUCyDR
# s+t/vDsHhotqimVsHP4FPM1P26AHSwd6J732cCZOtG+wIiGv/IsPBFFDybqSJ3Wi
# kDjIdLjs2yR/AyUCjkMQgtsJVuMV9YwBGK97X9QiU+QYfKWH7mFGRDXuCn8i+C+9
# K0lgQQlmouh4iG7ZuiDwtUZ84b+GtH6IsXO4XBqond9ZveygiYu7mQl6iAoVpLpe
# 4HoKCv/lF1QUNfHcFoLPiZBUs9YshQ+6uhjDzIanOntlZDTdXPAcjwM8ms/fzKqJ
# IAg+z7sg7M2PsILOlXjyN/jpGtSA/dppWBXZTNqCVAf3O06dFy+KY2GUkQuYjuff
# xTcKXWgeTkRDv6CF16kWPr2mCgfY1jfcTHo/lppwqww25TlsZ832kMWi1loL0QFm
# jkARW94bwKFXxOO4iVCPs9gK6iWuSQ==
