function Test-DeviceEnrollmentRestrictionPolicy {
    <#
    .SYNOPSIS
    A simple function that looks for the device enrollment policy and returns $true is found
    $false if not found

    .DESCRIPTION
    Function is currently used to call the actual Get-DeviceEnrollmentRestrictionPolicy function, to validate if a policy already exists or not

    .NOTES
    Long term this will do a deep comparison of the template and what is deployed in the customer tenant
    
    .PARAMETER DisplayName
    The name to filter the search with.
    
    .PARAMETER platformType
    The type of device platform to filter the search with.
    ...
    Required least priv Azure AD built-in role:
        N/A
    
    .EXAMPLE
    Test-DeviceEnrollmentRestrictionPolicy -Displayname <displayname of the policy>
    Returns Device Enrollment Configurations configured in Intune

    Test-DeviceEnrollmentRestrictionPolicy -Displayname <displayname of the policy> -platformType <platform type of the policy, like ios>
    Returns Device Enrollment Configurations configured in Intune
    #>
    ...
    if ($platformType){
        if(Get-DeviceEnrollmentRestrictionPolicy -DisplayName $DisplayName -platformType $platformType) {
            return $true
        }
        else {
            return $false
        ...
        if(Get-DeviceEnrollmentRestrictionPolicy -DisplayName $DisplayName) {
            return $true
        }
        else {
            return $false
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCH4ojBia6FMaTV
# 8URcvezt1Hnczk+nwn5ItSeM5DFNnKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAOI
# GPZ2zsyvhieAQZn/GS3IHYfybl9LxtUG4ZsP/Oy7MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAlJX7XtUhoJpBvutLhkiVuLcBCTd/4vXwvOIn
# Ihg34KwItxA4Q1T71+oJ2gwiPpWbZo16uPi83jb/6yyaNkYHkPs4NN1RU6wpleNE
# Z3BdoHvo+kAiZ6KH2/ashyPDEfM7MUizRo2ozaNSZwSJa6nC1mfzCygbTLqkBc69
# Q7qvkPmJPGtx/FubaH+8Jk/6y3ckyb6WORfb8Hzlyk5U+gP//IU3Jb0zXeIebs71
# qPXr45K2qGHwgGp8CRpL/r1Z1EO/wn8MdLrhGI6U3BZZ1DnFGGFbtGkybzaDAw3E
# 2Ef67ZQbE003mWDxYT7aikVpAApIyAY94ClrbRearbEwjdX+xaGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAWUC0LIfx9CS2yjjnpAS9vkskeKu77Qd97
# y6jgv557/gIGZBMoguJyGBMyMDIzMDQxMjIxMTAxOS43NTRaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIJhQK8OcQAo9Lsr1EcybdNY5QaMUz+WyWZZU
# CxW96FtwMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQggXXOf1LdUUsQJ3gp
...
# cpLT3LzHpsgK4hH6lT+hDARQfjANBgkqhkiG9w0BAQsFAASCAgBnqbYy4IGrvq5G
# 5IUOJwN5sso+gjuhQYluawLduxT+T3G7LDwxBo8dxPelwIq90crSr8zBktpYEu7x
# ok87mVf+Sl/rqNlBVu6Fv+oZ/Q+tI+pARtuLkq9bJrD1Mq3qjqaQqEbM8uAsmVdy
# fcPcdTS+qSzJTyf5x8H+ypYKSWgZC/Xqx0lsJ4sU/FeIwEGGDS6eMhDOI3uKArbq
# NLs7r8JfPxtXhm1zDwkkwJ0vaNjAAz7TDUn604NSRIUaCOHFlxZJq5hWgEsPv1Yr
# 7BfcEDryCLMAO/BWOx+dJIrqiSglcfIMAj3vZd/JEc4HOUFbNG37lPc6sydweQEj
# 1LrRB1LzywN95tg8I2kkXRXLCKOK494XCdq7gBU5yojQiMg+R6h0lS6VYW65G4Uc
# Vx07pdh2JiJ26kN7xr3NC1yD/gSL9trxaNXGfXwH9uYDOgW6WjrXqSIYLziWzD/Z
# jzPRfYncTgaDx3M3vEozsyDngX5MiD5VvbAb0dX5TkD724pBJFe1RFpNCOPGVeOk
# FulZ2+kj2l0r3FiDEHlxrs+novgWx27i+6cd4dna3dvVue+t2eUMO+muhK21NtH3
# 5qR2wnwrce/9zvQK5n9ylEBT2+Rl5fUm2of35dcnw0owwLU9z92VkUWcEKEyak7G
# hlkzV4RnuO14iEl8D6owqEJFU9HS8g==
