function Test-DeviceConfigurationADMXPolicy {
    <#
    .SYNOPSIS
    A simple function that looks for the device configuration ADMX policy and returns $true is found
    $false if not found
    .NOTES
    ...
    if (Get-DeviceConfigurationADMXPolicy -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDA9rCpWDEc3neN
# j1cN3kisug3lv0Uu5qLKnlUR+DI9gKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICwP
# Lp4mQyS8zhcfwhXd2myUtmvuV2i9tVSYfjBJ5TL+MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA3O2AlW7pRUHonrzSyGHLLZ8zZt+qDIELg39q
# o/RGVEcB8Z3+fSFULQNfKHAO50jkrG18aPjlikcs/XsGb3KpZPJPI5ThhnWVL74o
# 3i1/b72IeImBL5zXp7ewQTSLiaMEfTzaAvrdNbcYspBRdOc7Hlmy8F1M4YTxMV6x
# AmkevAepbc6vyPwJXiuBurcHNSQuX+6spanPVn1lSvHiEyPxnQSeZFvdDNWtgeSQ
# c6mIdu3KEp7H7KZd1ROpoyHbcORTp/NZjJ5euP+bk79iPlSUX419SvpbDdB/DzUL
# oqWz8kRBYGFFslvvzJbZCUjbZzqBCd1oNEiXgAvu3FJe9vXDb6GCFykwghclBgor
# BgEEAYI3AwMBMYIXFTCCFxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBbvnX8LViL7dBgCrcSHVeUBswMZnIM8/OL
# SIlIFs1LegIGZBtBQK8SGBMyMDIzMDQxMjIxMTAxNy4zMjVaMASAAgH0oIHYpIHV
...
# BDAvBgkqhkiG9w0BCQQxIgQg3WSOpqTElByAkEssmKai+UYzVY183O/YtUCJASZh
# mQEwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBk60bO8W85uTAfJVEO3vX2
...
# 9KkqgRg7ouEbMi64l/P5MA0GCSqGSIb3DQEBCwUABIICACLX68vBrO7I+U+yljq+
# uctghhbpfES+1gedSwh6e6WNq+vEelhKQB+PbUy3CsfVTokT2H0jixjPzwao1NIC
# 0maJRJvzNGCxZeGmiOASnQcs/x8ykbH7S7oVPYMb/o4W8wr7HT8+jPthkSHdgNYG
# pN63icb8i2t+dsJyXHPx4emiQTCD0tp9mfw4TYJrSpnNtNXJGJYTle9XvrqLMiDn
# ZzipqlPotwgxSINrULDsdoSJ2sYos4f9aV74L+35e4fqZXbCglzGBEZDrYK/v61A
# K3SAcFLjyGYL55POCpqxHhr+FfIYeTvtn0Mr1OOoHEsEzznDIEKOaWZXUI4qgMPP
# tlF1Wt/59dtovayCUaYFj1634O2gqxXbYxL4YpZS+qd46fP5CzffAUQmDNUyVHTE
# sV6kCHTClfrxUXINxcrJ4qylwBsyxuGL5Sibsyc7FOxNKGbFg3nOPgmathFuUJTd
# FMaIxxmAA2NhSn34Ub32MjcFyruImvRhOkzeieaJwdlwIqf3NgBuhB/xZ/eGHPX6
# XEzDtLVO0lNK9+FqqaTdiioTzmbdXcAuegcBgeIQqTA7dyKUwnUz8NL2a6ea7Va4
# 4ZNW6S1QO8voZPbc+a62DjObsJuqHDq7pbJgHaoaNUSe6myWRNuRV4bmwe0DX1nC
# nYskefveZHK+KELKGVqYz89A
