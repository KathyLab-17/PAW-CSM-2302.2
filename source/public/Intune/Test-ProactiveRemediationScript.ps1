function Test-ProactiveRemediationScript {
    <#
    .SYNOPSIS
    A simple function that looks for the Autopilot policy and returns $true is found
    $false if not found
    .NOTES
    ...
    if (Get-ProactiveRemediationScript -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBnIuPx+YOonSkv
# 40e36Mmt1DR+pp4Pd338urDvJ/z896CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAbj
# jA5bkeOmKsj74GXTOqPt5piKbr2ts3vcU9e6QtIUMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA54DC9NrzNbh4JRAR4GQPsbpJSgOBM6ZWr8Hf
# 6+Kk7iKCM1KQvBDKTjxX3DEErJVdkDeC3l2OUa3l4x00hC/VvM+aA/iSRBBE7sKf
# vCqsaejprKLxWh/RwI9D0DDy/ivT/0UhZtkxLJ62KHOlB85FFBEAOivtgSHbzef7
# m+BQGl6b+K/gSFj2x6ehkTt4Bd9XHee6JuFJz1njyKpLayltEQ4HW2bOAKoUIp9s
# 9d/+XAffgCyI4ErpghonloRiG1ZVEelViSK9nLC6Um1PPT2TOqDhEd1h85m69c3d
# XchoLcjTGr2eoFULsE6TeOVMK5k5W58AOnsX9FdtRAK0jFGAjqGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCJE9cZtdUkqjzlEvSwLoH0X41iAgpivbaS
# c5K7JSrByAIGZBNduD9qGBMyMDIzMDQxMjIxMTAxOS40NzVaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIJISsQabHN1dCF9HxruRsmQ2FN24Hmj/1C9j
# y0D5AsHcMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgWvFYolIIXME0zK/W
...
# v3XZImgEh7IGrhHes2IAq9B9lTANBgkqhkiG9w0BAQsFAASCAgAGe5ypMk5zkrmN
# Jg+LkggKZJHY0vQVPsHxCIuui9hyQdI4r0S86fePqM4dzP/9EL8pRa6PVxARyzx/
# hz6M+CPKm3LjZ6fr7h0Cqe5AQkdQV6znHsh4dVYpiFTHNuCHV+yiikqdYHIGLzHS
# CgEDcd4XkGEWCb7Q4ciTCP3lqtfWQogyXgQlzTMi+Ts0qNr7Ssk6si+ZVr/QnXuy
# SHkDBL+jeEzWIy1awnaKakCYsd5zcaneKurmoVubJ0YSN42PsYuRsIL+8J3DtcrV
# l7irrRMVd2gU8gvYWEESZUNgsXwubu4fCebqm78ljHC9WNpvw0RzebFO96qdj38G
# Le907faQoLu+lmNSQL2VyskBhpc7TEQmPQVLN3GTCc5KVZa/pNCSvgacF6Q1tydn
# a4AkYuJKp2bzQJRL4Ds3RgbbBZVjV44DIYiTXO8D7NsGQtJl2RLM/NG3GxXoMtqc
# Sr0FEAJXpyHXNQcoeht/OvgURwJZCHqCSxiMFA6dNQhk4ZQy5tcOfveMjUDxFP5E
# AehbQmr24im77FXWteXFGJjkxcJkR++1fzDS2BxdRBJECH9J2GLWSynlZWcpopH4
# ehBQseK2QAq92HGoWRynSwB9EAF7zGH9Vd2+kKrvB1Wetv8YhRJvfuUTWqtX2Ott
# i2pgIhMq11wszdj8mGtcqDGS1HWbgA==
