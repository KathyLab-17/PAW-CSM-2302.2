function Get-DeviceEnrollmentRestrictionPolicy {
    <#
    .SYNOPSIS
    ...
    .LINK
    https://learn.microsoft.com/en-us/graph/api/intune-onboarding-deviceenrollmentconfiguration-get?view=graph-rest-1.0
    ...
    .EXAMPLE
    Get-DeviceEnrollmentRestrictionPolicy -Displayname <displayname of the policy>
    Returns Device Enrollment Configurations configured in Intune

    Get-DeviceEnrollmentRestrictionPolicy -Displayname <displayname of the policy> -platformType <platform type of the policy, like ios>
    Returns Device Enrollment Configurations configured in Intune
    #>
    ...
    try {
        ...
        if($platformType) {
            (Invoke-MgGraphRequest -Method Get -Uri $uri).Value | Where-Object { ($_.'displayName' -contains $DisplayName) -and ($_.'platformType' -like $platformType)}
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC06p+IVphEfLDl
# EHF+G4393W5NjSC4aSweqbfFYtPCaKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# tqWDWwaX7Mw8X+8iaUkbrHVzv3K6QAOKIhrP68gLMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA5YKT/0xXWgxSqWziqSRFsWGBL3PzPXMj/6pd
# PaKgAuaxlvPm4WmPKJ+Ere+OpUUU7KkFJe5ltu/7rcmdjuXlcUFlSCPn8WG89ed9
# 9RRpkrdZ4U70Nac9AQmC6XRoP5uCpJH6JlcK5XG9vFgVo0CRjZFMX9pErOaShW7S
# RxihI1eYA1+Ha/CuFhKuW7ffCT5phh7VePLaPjmJ59ol6F3fvQJ1P7VU7r0nufrI
# MD3W+lbifBn0rMuf7E6j/LpT01kUo4ua8MBx6DLgC3xZiitqtITD3UdTZQPPQKaj
# jrrhOuR2S/QERPJiGDV6rMeDeHWJsnHAdux5rRWau90gu+khMaGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAHMjR4z47sECqRD/9uk3w9Fg0xWayzBjNr
# XKz25Pi4yQIGZBMoguJ0GBMyMDIzMDQxMjIxMTAxOS43OTNaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIE5FyZbHqM/kAk/MBUCOhv8RWD829rr0LD/e
# MVdceInSMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQggXXOf1LdUUsQJ3gp
...
# cpLT3LzHpsgK4hH6lT+hDARQfjANBgkqhkiG9w0BAQsFAASCAgBIkKgy8hi5IlGb
# pvQTa+oBxMMF74hql0a3TxFtJ6ZHfZmdZ/k86HzsY4bK3xMqnDmR5KVqaMZOFuuu
# u1JYPOs22LZbS3+Slm3h5gD4ZSNC7apftv19RPmHalE30KEjReV4r+/RfBCVFa0r
# jZTJ+7ET0qccfREZQUM0hT2yex6oiwzTHB1oGI9zFTckhrhtnh0V9y9CnXZ26r9I
# ZQb35jLcPuBh0OW3a3G6FK75slcRdFcjRp1nyLkGACP3yAxE0Qrq7i+oefCoLlnG
# /5jk5qZVmwoWGnO/ZFo5zO7LrpopoXF35bcgMxIt+0LZBNwxENGXHpTSPluXW6cd
# yKxtchD3UhxAjb+SIPKaHDxPQAztVDb97rF+37gAYdGMmbX4im+02Jnax850OIQ3
# cy3rpUvL5dv5Z2XozJeVWGAQzG44dbMmwU+IfLK8xGa146+PjQs2ArdW7nZc60fr
# INUO9VYEHL5kp7rEbEEvmQyGJb0nUq6zhejpbjobWYHDBy0PxLqnG1E8xtYm8qYi
# bM5D54vmYfo0Mt1aMhvQP/nL8ipbn3BNVJj8pKGCLyzx8QtkmkNOagNzRWU5Dcmt
# c92aUPs55ux49IgPurHgmzaL65g9ET81rHHJyQeS2tc4GsUCj7f4NolEO3GRxgUl
# 9255FxEC3XFuTc7eAjUTwxu3K52uNA==
