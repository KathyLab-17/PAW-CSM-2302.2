function Test-DeviceSettingsCatalog {
	<#
    .SYNOPSIS
    A simple function that looks for the device settings catalog policy and returns a copy of the policy in JSON if found
	...
	#Fill the $result variable with the returned JSON of the policy, if found
	$result = Get-DeviceSettingsCatalog -Name $Name -Resource $Resource -Identifier $Identifier

	#If $result contains something, return what was found
	if ($result) {
		#Return the JSON content to the calling script function
		return $result
	}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDRlaWW4KYU7y38
# GCfHXxOl2VopHz2GSfhXmvrA6VIv3aCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMdT/gdHGMkOioLhN5SKUQXd
# k+5v+xuWOTKdgmJ/K4iiMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEARZrZbKXISLQb650KrHQTuaPvwcTbqwvJbnB2/7ValFzm7z4sIHFvKken
# clqYdyo0yY/EtetZE7U/1hbYLXCpC64XncU2+ZCSXH3W1be4yHIaAuNfWi4//vi3
# oK3uRv/kdMbR1pVXou9SWC1GJtAfOhtL9KO/VjyOqm5KlVQA3EjOj5zkxSRwPod0
# Kailcfef9gpWnke2tNY823I0U+3o2eArvfQJCHTtOt1097yAO6xRA1EI/11zIRSj
# cvJOnVLg8r/4aLmtwl94WdaEUOHenvlWJIeHLit0dzlJcGy89bi393p3lRAG759k
# hvmN9fe16SG8Y3EaBaLgw97VPm7ki6GCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCBkMsqwPExy3/sxspnf04VRhwFWCJyRdDLUTZ9uNvtGIQIGZBMoguJZ
# GBMyMDIzMDQxMjIxMTAxOS4zNTRaMASAAgH0oIHQpIHNMIHKMQswCQYDVQQGEwJV
...
# AQkEMSIEIBC0a1ESiHSZXx93xJ2RVrWysjDOmHEEHGZ1loZL4SVHMIH6BgsqhkiG
...
# DARQfjANBgkqhkiG9w0BAQsFAASCAgCG1o56AUnDgW/vsfGfZQ53ywxDBbM2MhF6
# ynFL6BH1eeAnrcvaYliwUlSw7H4REQ8T8heNUq9dy8eZEIdIWiHZNL40FwF2+3Mk
# vvFa6rL/KXFaFFGVrj548p1ihUl39n3xa0Opy0SH6j62hKW5pm38JYJwTv+a7OBf
# hndLo941LAm7HLFXmmJzwTLGcFO7zTdES9ch76DBlYxThI6OEeH/mYhDqgN0dzbZ
# VJ/9v+2W99eC/EKAcn3vNXcZVMeaHA0hofwFIY7hR94TykDRVyKGR0iyTCbB8AL5
# jKY178QC9KHdVE/jS4Oa6TiC0/Ypx03nrM3Hhl0kekYc1t/J73EOm1o8Fh4kzmM+
# AVRzDsziVW1MAVN7QSCdZda0PqdDcDR2LlmuaR/u/Gd3LVfteHImDAcFtLZQ+1Tu
# P8dBwDOpFcwQIIxqP/UuMATh9SWlFQow2ihLodh3NpGGoQRSUjkl3WEPc5P4ktf7
# uN+5ziJA6jgrrHnu0edrpMFjel7Wmy//R5GQNJIgimnFDaBUastV6OS4ElHzBrkE
# Fpbevw3+Qsnabx+q81JfXTxKNZLgLUdRyLDJKn1bE8tPD/OwQOapYVKKjQtsCiDg
# WsLqDNCwTAVQfU8BsSXukpTo+l75HpjCScWw5B7hfEL6q9Lv5A+zZMMGRu4ypPqV
# DRvsOWDy4g==
