function WaitForFileProcessing($fileUri, $stage) {
    <#
    .SYNOPSIS
    This function is used to check if the file upload is completed
    .DESCRIPTION
    This function is used to check if the file upload is completed
    .PARAMETER fileUri
    ...
    $file = $null;
    while ($attempts -gt 0) {
        $file = MakeRequest 'GET' $fileUri $null
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCksI6Ncb2F7RL2
# nvXtOu54Xnx4ro4A969v6d/FZwVJwKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGn6
# ID833d/l9EAwU07RntXJFSDDCvVz/ZoUeMh2V/cCMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA4/KvgOfPGucNi4+t0074UXVvlCvA6Dzd7Von
# PYQINzaW+/+IYTtg7CGO9oduT7picW1wMm+c08kRwlrvJaX1TJHRr8L5jZQ5T28G
# 1c2+BHsqe/1WhAleZMvH73qpZvrPb9H7rVMjkHRxuZbh/xQ0k7BQtTCZtZYzdRKv
# R9Cp8+erq8Ta6LctsJUWmhDEa/yBUPZOd1Pw+D0VZTZaz2ih8D+Tye7DJE3b1/Hh
# x1bXtfLQuArX5+l6ywy203AnPjeEYuXW6tF9xlaiOmQ65SoW5hkt+XLn6/rYtZeN
# nwnmNM3qKsuhlI+Kzpy7oExYfaD/yale1HSC88VcxR0gmxOKoKGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCYSmEsndyqfw3AY1fyKo72CCN6P+ZdfKXZ
# f97y7LI8jAIGZBMgedHuGBMyMDIzMDQxMjIxMTAxOS43MzNaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIIjCNMf5VtG293xv8exgkUaCRWkd5jo+6mtv
# a1G4SvuGMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgCpZJfojepKvbRu
# cszUT8mKEgDV0Db3Jmk9wquSveLIFyy1z5LFowgpVDBkuZ5ysxft3ePMGOscSfn/
# voG/X9zBrVkaVWvxAbVqKdn50WOJ+9pmMSDGghLZG7N+lFBTtENmHEvdy0+fH0/E
# 3aMsUyGh3honCJdILP6d3fMKxU5nODZzJits3pkKr9PPumwqyh2UwbzQAjU+W9Zg
# 1AMS4zNWjy+zOy5zJAHXA4FjaZX7V0yXh2qwvV488bEo7fCDLpe52iS9u3rBftCF
# Rdt9TxThkc1aUEVYZPijGo6nbgndUsIG21XEXnzp3HLMyE8tKce5mCPibC6i8Rgu
# COwoNkdd7clL71C5dA+Me9X+DlT2wiigU0Cfvwd46/D/CzeTgoKGlTIQi1Cj3dm0
# /GOg0KwJ0p3AjIao8OhDk1i++k6mnQAaM+gzynqGBMeA0vLaEahuC2Nj16ahgjnW
# Ji284ZUywdlmJ0bcHFL+0H2QGziyGjWBDUyayPbJA4kLHrg1JsCzb7Ilr581L2wQ
# LKvpiv99cNs/o00xAfjvZYxcRNcpgCcJYnQx1lOf4j6egp8AqgC+LJwgPqzORsac
# N8hd+/t/LMrpRIcr1jt7pD/crtB3tatGgOIWUUuEdbxwdEYCHj6Zjk50xGOtxPDt
# e4OmHWQ1h9CnMFb9+jqQceXZxTGi+Q==
