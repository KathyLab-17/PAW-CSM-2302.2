function Set-IntuneTag {
    <#
    .SYNOPSIS
    This function is used to set Intune App Tags
    .DESCRIPTION
    This function is used to set Intune App Tags
    .PARAMETER TagFilePath
    ...
    Process {
        ...
        $global:TagFile = "$($TagFilePath)\$ScriptName.tag"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDK28fMI8jmJkgh
# 2OtWGK9MRn0E7+qjNsM6PFgjwwdYbaCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDpY
# a/Lvmm9EubofDpBPg4bXSbCuX6CzoN0+cgO7wPBNMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAWuN5oKMCqjLVLyiDUyq/efWUaCA+H1O0apba
# rpeddvJemAfBMOrl0TMt1kb2BXulnjimYrHJO8LhdaAw3JqDrIMFoZuJVNufX/g7
# CtUmpwx50qOchIp8/jTTTKUSmWJCDqY3MP8nUWKF4EsETwpFP0NW2E+PFMz3YQS5
# D/KwDqT01/glHETmNLAE5TlqCv4Gt/eO0TNPM1LZ4OIQJrCkGDbX9Zga5jkbIC2I
# W1pw8q5mVfOht967XNghNvCR/wUiPDRhKxzhm/8P9+xx0yDYq9T38bxirXwdGZWE
# rfvxFWzTxrc3ZqtHgJ8Rkq3LhPiIR6VENaDyk7q6vZOLtmfrq6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDNQtgFXZd4HG7a/r+IcH/Sad5CXTtID4YD
# 16HhFZ/SJQIGZBMgedHwGBMyMDIzMDQxMjIxMTAxOS43NjFaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIJauKyaOBQdpxtS79QC3nlx+kVBN+a//qF40
# AEeRfpygMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgBpL8PPgJm7OxJa
# KnhzXYddYz/wrnidBmqgqhp23d96HmfPu/sS3EJoX2NZoPPxlR0x9zAdupMte/ay
# gNkCpbn/biAoCAUHRuHKIsWRQiau8TiTzZk7vRH1kIRZTp5gDbrPq7LbJrZ4k25A
# 6cCWW7tnJsZ5ObMImreQ8f60H4+dXIxj7cjlHMpB0ky10n3BtuEA4F7ybjYrcV9O
# 1x4xm/L95sr2sCb7H0M7UDsqqSRkn5hIsKsVwgQ+/z2Nq+X5Vb3RAHQRPkEcacDc
# BxGENKNT6fcMDWiSvTnXUj84FzTIgGSnuEmPC9nJtfvsYkluXgwNdJY89pt3Q3dg
# IRoAXHvv7jzc0H3CFOPwEUDz35eD+Y+eQQRA5ccHmDUp8/pviRyfBBvEikA53snG
# 5tX4kqiWSNYpu0SNJ/TF3FCUGNwqIkcuRGRLo+WAWJcXIefTG7i3xnLKySPebv9t
# c+0OlkR+Uu1pU6a/Oos1UB+Lm/nPDE7mgYH6nnMIiAuL6EVxhkGGj9d5KnryKafv
# dcJasUlfrhU9cmuyVG5FzxUZxyydlHvbavr1avByAs3KORxoJbsaRGwSkm/V2UUL
# LuvQ2rRgOPJQHE6GzRw6C889D6Ma+qsHqTb5VuFCEXdz2SvRM3eddRuJX0kwkKs6
# +/z7Nlgp6xnALvcQ1iYsYHMVL/9o+w==
