function ConvertTo-AADGroupInternalName {
    <#
    .SYNOPSIS
    This function is used to resolve the customer implemented AAD group objectId into the module internal group name
    ...
    try {
        $uri = "https://graph.microsoft.com/$apiVersion/$resource/$groupObjectId"
        
        # Import default AAD groups
        $groupList = Get-Content -Path $script:settings.GroupJSONPath | ConvertFrom-Json
             
        # Query AAD group Id and convert it into internal group name
        $group = (Invoke-MgGraphRequest -Method Get -Uri $uri)
        $groupId = $null
        $groupId = ($groupList.Where({$_.displayName -eq $group.displayName })).Id
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCho6ZjF4FTQSmI
# 6L19gzeSYM022+BOzgqJU/KkffFEY6CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEYT
# 2xaNJ1Jb4UGNOPEGRjnLPmhF2SwIkt9YPB99I1BGMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAPRfARGpiCoklvNwbF6rbdJWlRrdPZcfh/GdX
# wR4SCNNqZ66wSBOiSMlj/j6iSwBgkzHm9mplOsH93SQDdRM21TpJjzSb8LguqHg4
# n3llabcwR9R/F2W+uHYhVkHh+onbT1xji/i7LzJAgw9iXmpPXKtWJdsAeV4SNJkJ
# Jtf2AbkcPMnsoNE3M9Bp3zf/zHmtVpQWphzRmbkAcoxkibYKtskXa/MQ5BHG0qbe
# RJ95ggGCGKkAVf3kLag/40TkaBV0NJRdoe4XrpaCoEY0QsS7R2i7oiaV8sj1Vq2n
# XZW5kn/afQHffQdf4qNjazccn4mBuYDqUocaAhnX4qxWeNHNiqGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAPHynkjvwSBijxegiBfShLBCS2H31UGLCL
# 9iuz8M3OPAIGZBMgedHyGBMyMDIzMDQxMjIxMTAxOS43NzhaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIJH8O4yZQhHZGKJo0G8Ew6RJCcKf3qtCWqQx
# KnN5+Gq+MIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgAMYpuhJ0o8Xig7
# GyFg6Jn5ltCPwKULOTn+24dC6Q3ziAXpU65AuGrxF5iam/b6J7ip1bf/kzAddvxg
# Ze7lasL2ZjibYhQdVEIfRxy5HHJcwk3nSMahwZkeTy7rAekBMuXRFITO40rgF3ww
# QKZcjsYkuv2DNenuE4Fjds1D8A+E43KXLL51vr2S6V0BwiCp/SfDavfznbwWTW4w
# LUtD5z45Inm0Bm1pENVVijui9Zj3Si6t7hLlDR9nAMf+xlMXWIARKIDGTWPVzM64
# Ww8YO3dR5vueue2GPIQ8XYU+FEcPBzq3zCT6vVnsrbv6z5ZjQkfpziVFLUN57da+
# JcEQX5wIIrEWQcniP1EXDvFAUu9f8fdEJuXZX0G25PWUSrE0l2zppOCOUqzTX8v0
# CmV1e2JEjOcBnnJc+USvxoqkduTsBSWIGYZ4aLY6V2OOqGFnk/VgaZ/JakQrAUkW
# 2BZWbBMsnGV79Eo+o97LB9PHyemREQIhSsb5P8YZwuMw7GahG8hLY9RQbruYQ3iN
# NWPwytUsnogGz7e8Z/hRFTpxuPqSI+mehwxjol22i3pUt053TXzYt/SG1yd/Rld5
# IsgUCXKdnyInskpb2YWUSMXic4qfLzRygYyLXhos3FXOHXlvBMBPhBv1m3ccFfJe
# VNiLUEuEmO8jjK/YRSFIQbaUawUBXQ==
