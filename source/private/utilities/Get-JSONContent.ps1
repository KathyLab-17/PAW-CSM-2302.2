function Get-JSONContent {
    <#
    .SYNOPSIS
    Pre-Processes JSON strings before importing objects
    .PARAMETER JSONFile
    The path to the json file to import
    .PARAMETER ExcludeProperty
    The list of properties the exclude from the import. This is a convienence
    parameter that removes read-only properties from exports json data.
    .PARAMETER NestedExcludeProperty
    In complex JSON, nested properties are not filterd with the Select -Exclude
    The NestedExcludeProperty conducts a simple string filter before importing the
    JSON string.
    #>
    [cmdletbinding()]
    param (
    ...
    if (-Not (Test-Path -Path $JSONFile.FullName )) {
        Write-Error "JSON file $($JSONFile.FullName) not found"
        continue
    }

    # Update version number if needed.
    $jsonString = (Get-Content -Path $JSONFile.FullName) -Replace '{PAWCSMVersion}', $script:settings.PAWCSMVersion

    $json = $jsonString | ConvertFrom-Json

    foreach ($property in $ExcludeProperty) {
        $json.PSObject.Properties.Remove($property)
    }

    # Update Tag Names
    if ( -not [string]::IsNullOrWhiteSpace($json.roleScopeTagIds) ) {
        $roleScopeTagIds = @()
        foreach ($id in $json.roleScopeTagIds) {
        ...
        $json.roleScopeTagIds = $roleScopeTagIds
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDu2SkpGkzaBTh8
# AZU1Z5S7PdABgtUKQOixD92F/cxaIKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# gb9tA7zfDBARZPAu/mOtA6UnmAyzNKnAieI6H9UEMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAJaZmW+JBcmnR3WsH9p61LRQn1TylRb8K2xwC
# 2vBd915og/fjBjpNGqs5cq8AqpXNx6wtbJB1UhN+GoCk5pBwvG+bhaIBOYTs6rM2
# f3IiaSnwuEXGXEd+DeR9QBfuXT69DtaoBNL+Bjc3vigDSBrSvMf/h9mS0zmdJnwA
# /bvWyBqxsYg//sJdmnEmgVqbPYtNLBtFsRIJCn4/pfY70GPhl/VPg5k2UiOjKqAP
# 2CA8b4i1puc5ix7zMredYJzydxQvr+VKcuDK1lwyIGvGcU/JO2i4Z6GsqRgqtHRn
# ca0mbKT+NdlikBT1U60Svs3Gf7bCq06pKmxhfNfSVCp8qKE/P6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBsEq8w9BRfwep1tYRoOoy69s3qdMuqKvMR
# 3lAtEgG/EAIGZBNQb4iaGBMyMDIzMDQxMjIxMTAxOS40OTZaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEILw1qTjJ9RT3AiGVb5fGpeHchwtE1o49QeQX
# AE/CWt/lMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg/Q4tRz63EiRj4K+1
...
# cmzprmq4oT5/HJRv+dViI7pOJTANBgkqhkiG9w0BAQsFAASCAgCnP5JAyVjyiNn7
# 8qIy1ubmUwF3KQaIjNeVoNC38mwsTKS6MMhrA755ZwgUge8XRCeTAt2grUe6tPrP
# 1n+qF/43wx2Q3hE4J3EE7WFwRQvH1MGTc7lzVPglQIBzGT3j5QEQS3bRmCIBt9dp
# cdJOD4QFnFD84EN+7Xmabb2PRgXH0Y1OLwGyW5W/xvxNnhJJQTp50LfsUD+mf63I
# fOGhPM/Ms/R80Sa2kUtfY4+qqE9VKgxe5gM6EFZtEbHsqdDYTQPGGYRKGaF57wVe
# uUX/VnuJ/7o/UDGaPIeRIc/gfZUVuE2d8BvIZk2SaShePwL7BVJ9H4rUIv1i12g4
# K3m90n6A/iu0YX8vuWT5j1Kzsc1dyL2q5Hi25cza3AMgJ7x508SfcKR8t41hWMWK
# 1Vh6RyFXLAKx+Q64SvjD3dhIStthUM8OU3qqyKCi5GHXemG1xdy9Yqku0echA6yO
# TQHRmOklcm8R+KDYqSd4PpFxNbkFxZv3t8SVtDfliKckgi3RWBc0IfPiGtom7oN0
# PfT4btngzqZud9PwWvorkiJI6N5LyFcgiOzEBTG5h1m84kuQqnMTqnFFfhj0c8a0
# oUI+OT38pz3a2t5crwanWBV4JDYCQIVcN9u9L9sjHsMqZUba5M5lNhBCSPgViti8
# hSnU1iAQ0t9D5SXBqTIC8UqxuODllw==
