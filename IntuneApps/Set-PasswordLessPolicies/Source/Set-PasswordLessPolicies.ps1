...
if ($Install) {
    Write-Log -Message "Performing Install steps..."
        ...
        Write-Log -Message "Set Password Credential Provide to Disabled in registry "
...
Try {
    ...
    Write-Log -Message "Successfully Disabled Password Credential Provider..."
}
...
Finally {
    ...
    ErrorAction  = 'Stop'
            ...
            Try {
    $Null = New-ItemProperty -Path $registryPath @regProperties -Force
    Write-Log -Message "Successfully set Smartcard required for interactive logon..."
    }
                Catch [System.Management.Automation.ItemNotFoundException] {
    Write-Log -Message "Error: $registryPath path not found, attempting to create..."
    $Null = New-Item -Path $registryPath -Force
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBMOzJFvum2kT20
# bvd5nv391gSEc1s6RAWb9CS5po5IVaCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# KkG60IFWmDTujFpdvTfsb9ehgCM7grcUbIkS4RHkMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA12gsKM/lKes4HCbbaRZMfKhBQMyt9PETid7X
# KGarlOuSt/PTWev8iaMvprTGYRAe8ufoZj7OwOAxv2Y5N6fY/363Kwbk1aOPTsau
# cQeFQ0f+GwSzLOMkZ2iFqV1q7Ezu1CTVbRC7jOxQ+hn6KVXHjDHftuj2rVgU/B1o
# sO3zyvUKEL0ZwX1hvPrXJZhIauCbhaaNf2TuY5VBgHViYDGg/UWGOH1xZJn62z31
# PTf8TjhDpp51OPUb6W9OiG8cpC5zGHQ1Qtnb+UHDPgJZLnqHXvx4itYTPsmg1awb
# gWcoLcNK1ZclG2Rd+AwJrJQBhWeurCNvvV1ILU/JuylN9Uh66aGCFygwghckBgor
# BgEEAYI3AwMBMYIXFDCCFxAGCSqGSIb3DQEHAqCCFwEwghb9AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDqjj2WCSZDTh+z47M3jz0retyiOakF0YwG
# Hypn5Gp5dgIGZBsJpVJ+GBMyMDIzMDQxMjIxMTAxNy42NDlaMASAAgH0oIHYpIHV
...
# MC8GCSqGSIb3DQEJBDEiBCCQmdPX4fzu83zSpvuElk6eIxLDwlOEmTwz7l2XXfpM
# 2jCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EINPI93vmozBwBlFxvfr/rElr
...
# XO6q3rJFmP4gRk17SQ4wDQYJKoZIhvcNAQELBQAEggIAPwrVKd16ivVgSYtSa/wm
# 4+NO/QZibc63YAcL5IDmkJf/cTf1gWVYzlLZO/hxZ5wmWDZnQyIbOoWihESvzEV6
# Zs5YjQe7CMvAZhqns993Amjo8P+1B++yaSNBR0VxxB0pqif62JfOcsbcl8PsCxog
# x97sCNg+5ZS5objFb6M+qE2/xDPcL+yMPM3/15yaht2KHkQxJrf8NQGADwC6MMSB
# I7XhGvvYmoHMlJXBwD2Uq012c7uH8prsGIfzpITex4cNwfisKgp1JrNCIUdKAhGd
# AcvwWJ2yhdwUpyFgYikD1/Czoz+Qk6jAY3yuksSHNlPCJHAxYUxWJbiVX7iAvbqL
# h6eH8GEJtYdDfwiPpffsvrotXA4q9Bab1c3uV9a4upxLqnhSOVrrQlzzNtipAL5u
# PPYmgXEM/xGOQ23U37q92Jjj+BEabNo608Xuad3jT++ynF3/pZsegqu7In+RfriE
# 0j4v6rsQ1Y5wfIr0Z7pWXrh8Ysc+Q9PYwZL+L5kcd5vQchUYQEgrte+V7f92GDz4
# 1JW3UOamBzBy4kTLHuvJdnFkwwBYxZFFUWwhiLAf2xfLQssmHKXvMph71tgCYXLu
# /CPDiwCrqSBD0Rj/vTpkt/ASzYxaeS3QqZLuANAEu5XgJZiWXG9IoFTX+V/qyCOA
# MxZd+hgwOnF5j20MNcQQwbc=
