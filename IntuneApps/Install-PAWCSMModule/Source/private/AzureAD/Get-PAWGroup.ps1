function Get-PAWGroup {
    <#
    .SYNOPSIS
    A function that returns the group object from the JSON configuration
    .PARAMETER Id
    ...
    $userList = Get-Content -Path $script:settings.UserJSONPath | ConvertFrom-Json
    $groupList = Get-Content -Path $script:settings.GroupJSONPath | ConvertFrom-Json

    if ($Id -match '^group*') {
        $return = $groupList.Where({$_.Id -eq $Id })
    }
    else {
        $return = $userList.Where({$_.Id -eq $Id })
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCu2GGfFplOzEJi
# Q7mojtQBjT5ekS2h+TklvkRJLXqL6aCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEILkM
# m329EfCv+kecQflEiaaOTfHhvriadxTbpOheerlkMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEArDmdHr60dtm3aMG3dDIoLW8pHEIeo6lYHeqH
# VMablW2WQ2cdPUHR5SbzefMC9c9s0UwVMi+4YJpdFil2/UVVDDj9OFZvymGg86xB
# aaeqzKSIKfT2ZIOIDqgeyNTEnqhwI3seQ/J4eVr/j9wVpQFuIgwmmSxm8V3YSSHt
# 2ENQ8VY/YFZ2Z5r9hrCLEhgHLJPGcb+mbWwGDr48V/ieoMUKMndeqgigKloAOhQY
# PePuPTBnWedJ8Lps0S/HvbRT+D6FwlNtd65ys9gBw22x5RNCyqHiirKTZ/0GWcwe
# nOJKhFhjlaxx18Fjm9rb0HAb/ckagr/f9052C0+h3d19ght646GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCbDOqcWO7oNuLxbonQwo1GP2fom9CCt80v
# +YF0O75KqQIGZBMgedIQGBMyMDIzMDQxMjIxMTAyMC42NzhaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEICPMeXRiyQSez1pcILdIgEcmsxAfsh28Lfkt
# dqiBd1lqMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgBmNu+p0iKRBXk5
# lS2wPuS1F8PMiFOIiHEOL3fsFMlAUHeuSek/i9nUj6XfI3NbAi+a8MrZUwA/0bX6
# d94tb27ym5wXAYNWjozZuMRR1iwvIm3DFkqkgX7PxTAxVM7sL7RbKe4v/Cq5zYhx
# gZ/RnX9I3odASjynZg2oVr4/oQoWwqU2o8qp/m7bLy87qle1mvSHHeY8OCdnsmub
# 4p1/usVu0A9EwrWq4I+6Jfum0/JYgXCqzgIhRz49nV1RLIp84KjIkVtmJVG2LOq+
# LgXfaZbo6NC/VOyTfPujBhJxfnwlQkVOAULoGQKPMwgS1+2i3ZUTJDrbeoX0NQm5
# mje0QYcfL9TjToAeGjJ/vpSLnf8OHGBBDtJi1YxMqMyWMHTLSQ1QfDG8/l2V1jgs
# hHwI7pe4kkucGDb4/g47bwZtlzoL1sMJzwB6Gnu+whCpFucANOilRJrYvOwrDsWf
# CSI7mhKPqJJNIVoJppk2J7e6Kp0CQvUtnp6afGCNl164g/YzXAi8E/pq8IgqmXDn
# Vu7/GCrh9hi38Xjf1vQLGGyGaoox4R6jYpBhTKBVwJ6X9hmtm1Qkt+saF6qdHzR9
# A2ghe8zEt10OwrcpnNQXySynYTr6loTmyR2nim2PevlSGpfEAvJgR7wHttH3ERX4
# uazUIBx69S5VNITgPZD5Z1JRBulClg==
