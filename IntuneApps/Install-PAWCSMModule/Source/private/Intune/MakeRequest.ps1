function MakeRequest($verb, $collectionPath, $body) {
    <#
    .SYNOPSIS
    This function is used to parse requests  to the Graph API, dependent on the given parameters. Typical operations are:
        * POST
        * GET
        * PATCH
    .DESCRIPTION
    ...
    $uri = "https://graph.microsoft.com/beta/deviceAppManagement/$collectionPath"
    $request = "$verb $uri"
    ...
    try {
        Invoke-MgGraphRequest -Method $verb -Uri $uri -Body $body
    }
    catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCPI0jkYYS9b1AX
# KlYMGEnSs5UzVC5DmyzK9cZsHal3JqCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJO6
# qOUnBCkxMW5shZjplthK5HtLAjsIsPWQKeuZGgsYMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAIBeINlu6No+Ft/rx0MwQAqKhM4W8bfDekPXs
# lSzb6OuFg0TpTR/I61kXzaaULSEHqhMF3u+2sDZlaSpJWFnq9sXlhb2+kF36SPHq
# NULfyiKpoRY0Uf5CfrkRZ+3lkPSbVGsmLkB91fAgWdjEVQgWQyANSccXkmTJN+Qw
# 8p9bQd//E5FQIRUjGiWzEBLWvZq6y3ZXRzaPm57af7A5E2vi43Nzxz40QhmBELSZ
# Xz8zmYwbEJCCUMjjzlCoK4jAXzfXsPkXJfFnhrOuHdH+XvtmJ06l+QJuBG8wU/bh
# jOhKcU+gXGWBajLOsZu9t9/d7YAls4Xq0JBJdDaX2F7AEH48KaGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAPR8LIy7YwCc4owU02rBB/5iSrwpBZZgiB
# KoAB8tafJwIGZBMoguJJGBMyMDIzMDQxMjIxMTAxOC42MDFaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIMMYkxNik6Cd1jrc3N4tP9laZjInqj24Jw6R
# PZd2l1kcMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQggXXOf1LdUUsQJ3gp
...
# cpLT3LzHpsgK4hH6lT+hDARQfjANBgkqhkiG9w0BAQsFAASCAgC0QZYHLZ4f2Tow
# H1xG+YfSEoNA8Elm206I8XhY3rhZ3BWijlxkFe9UXOR7zKWHnX4VlvyhyLniggc9
# yHHfvjstWqOEPKCAe0tsfYmaBGfxLAUJ2/QYiXYHcc2SRCQBU9RpdxNhc5t1r5VB
# akQ2bF7iqObtPyVo1dFl0RNq+6PXLT5rKjf3aCqDxkeUB4j+fdXAjZawfHiWdUF4
# MXAQ0huHSful5CTfPYOjHWrTvf7exxY8HAGBNjS7jXkury2gqqJptNK2+CtffRAS
# 1xElo+4PVw5MQCeDJ/9vhuSYQPB3Lkhiesp6WoKGubqC0mk44Tj8sG0b/t8zWMGj
# qmEu9qAAlzr8WdaUvDNAFU94oElcuIjOm68EEQYv28QEwCRsHfwlopx5EIgQNuXI
# mFqLZo5a8dVY8ucVPQt39xe0I9L0moJKYS83EU1wEHNEVauu2d2pG2IOa7qlCTeD
# ihTt6yDaA0tGO5qMnAcf75cgHQK2n6BxGZc11LMUfadK3/PRuIMI5Yes4P3sQxHD
# CPBpwv8HcOG4KwUMGfEm+Up0Qo2vT41Raeb9kYuH63Qn849EvdFqjLkKael0HCqw
# C/KO6JLSI079DPXXav6LIpxETg7N97M0tjvOYwulUNqn9Y6qo+Y81FCVnqUmwYnE
# VaxSjMoxkZceqJ426Zghsg2gionx3g==
