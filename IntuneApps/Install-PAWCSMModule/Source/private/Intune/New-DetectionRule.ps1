function New-DetectionRule {
    <#
    .SYNOPSIS
    This function is used to configure the rules detecting the presence of the app (Intune Detection Rules)
    .DESCRIPTION
    This function is used to configure the rules detecting the presence of the app (Intune Detection Rules)
    ...
    [cmdletbinding()]
    param (
        [parameter(Mandatory, ParameterSetName = "PowerShell", Position = 1)]
        [Switch]$PowerShell,
        ...
        [parameter(Mandatory, ParameterSetName = "Registry", Position = 1)]
        [Switch]$Registry,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA4ueS4KfvnKiSI
# 4rT3kGpc0sIALQ60rBCPcvuE2f7bMKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# ek2mSoBBU4zloJxmeHDD8tUh47YD+EiDnxF65tYYMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAqB8ATP2Q+HfbKX6RthXaGLsogXYpQ6zrpr75
# msQ7mE/y1MLwaP8MSAHtKMR1GhRavyM5pWWAHzV/G6V762B2aqNl8eqQArRJuHDc
# 1CM/yFHI6oukp0Ar5B0NrQX6zUwFOKy5TCiv2BuU1bVmuzijeeOrUOYiML8yG8xC
# lgYZiJ4DjNcNmEYf84n5o4tDnxlQANlxdrJsymBPOrTBkfeTKYJW4dHYODJiOGzZ
# dND6x+atRlr1MJ1XTfMx/zjGS1k9+5c2/HfuMLGRC5OS/eSBXtjOpdhpBe0U63Bc
# UEqVo7D3xE61k61Sr1z9FYkgTyTMuIN1YhdVZptUYaPx7sfOJKGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCD7m7ABLp3dJivb3dc70K8B1xLd8DqrAufu
# EOno3lPDggIGZBNduD9zGBMyMDIzMDQxMjIxMTAxOS42NjJaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIMGYodEV1f0YO3nZ9Y7llVLlrGfVONc2AVCr
# AvP1ebyWMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgWvFYolIIXME0zK/W
...
# v3XZImgEh7IGrhHes2IAq9B9lTANBgkqhkiG9w0BAQsFAASCAgAflDtUxDDlLqB9
# ckABFbHKWgiqvUYKigDTVVhJJtmRB71R3sszE0EZuBdczJzRtqRDXxfZYtPnREja
# r+rWqQ8XYPdbjqBwT2KR8nY/lw6l4CBmw0DUGe42h7E7mqTOv4QqUjeO6C2GpGA+
# 3kaJ+maUTZ1jTsOUSAFavL1OrL4w7hGj2WLE9l9CkfKOGGjF9IFfgdbRsMN/3JNf
# NktzsXBJytw5BnO0Rzr4aiEFqzi/tw5ppJzqcECWLvIgYlZl6pbpqKtR02Ckqiu6
# tLiVKAGc8ospmMd/OFwhNRPLHhb3/CxdhyWCSLeQzWfy06EfZmQaTKzaAn+YSMTO
# 981WcZmfFG9QQAOWoWuZNEv2UWF0i9llXfo5FV1xapjSatGvGUm2/HDintJJ6Mke
# 4vnd8RKI3XhIIngKrfxYpGLcXbqEuzW3kWuBOcEChHNK6vROJ9AH4bs7i/Rc4z+O
# gJNA/saIPJ76F2ku1Q3coAjdqitm/w9803QW8P553oh42IE2pIPpv8G7Nn38uW2i
# Q23sJX2qS3ks/rZmQoxjNVwyPvqFh+PpUDhdIwPLdRSMZfVBXiP4osOy9CF6y1+P
# og5UauN4lIer2YWEfX/GyyIXTb/rXsliKt5vxh9CkwVJ8UKMOtf8i2Md20HVTUH2
# B9yX7EjTymXEv7WMoeqPhHPNG0N4NA==
