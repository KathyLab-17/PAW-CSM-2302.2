function Set-RBACScopeTag {
    ...
    ######################################################
    #Get Role scope tag ID


    $graphApiVersion = "beta"
    $Resource = "deviceManagement/roleScopeTags"

    $uri = "https://graph.microsoft.com/$graphApiVersion/$Resource`?`$filter=displayName eq '$scopetag'"
    try {
    $scopetags = (Invoke-MgGraphRequest -Uri $uri -Method Get -Headers $authToken).Value.id
    if ($scopetags -eq $null){
        Write-Host "    Failed to find Scope Tag" -ForegroundColor Red
    }
    }
    Catch {
            Write-Host "    Failed to find Scope Tag" -ForegroundColor Red
    ...
    $uri = "https://graph.microsoft.com/$graphApiVersion/$($Resource)?`$filter=displayName eq '$Application'"
    try {
    $id = (Invoke-MgGraphRequest -Uri $uri -Headers $authToken -Method Get).value
    $type = $id.'@odata.type'
    $id = $id.id
    if ($id -eq $null){
    ...
    try {
    Invoke-MgGraphRequest -Uri $uri -Headers $authToken -Method Patch -Body $JSON -ContentType $contenttype
    }
    catch {
        Write-Host "    Failed to Assign Scope Tag"
    }
        Write-Host "    Assigned Scope tag" -ForegroundColor Yellow
}

# SIG # Begin signature block
# MIInogYJKoZIhvcNAQcCoIInkzCCJ48CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDrEBT3BjixC3jm
# PFfBKa8enMpRtyDmWQCdh5r89gZF66CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPK7
# G+6JPJGaVCMCFTNdluFgtDhtTeUI0N8A7ouaTkPwMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEArwt8RHfugYrzrD8q/weijp78x8TFRdiXmBjD
# DhFMZ/kDVL+QHGyTB4z85RS41Kzvm/KqF13NxxHTO3SO6gVuzuD0T9ZgZSztOzuZ
# tvqtqHlL/65JW8U5SIF8U9Vbmcah3woaGrhTcAO2jzglJcusuArx6fVVrOWkNVug
# oXyiWl8q27hfExxMJ5Axww0bVuV/HXarhYUL6F0+PLnJfBWN7JdzY6uUsf4eCBSH
# MDjrXZeuIut3MJPsikMKS18EuD1oW5Y1ZVBnIJJb6OJjsKskgLP2XDnsJxnmqIfh
# A1UbP/5dwa7kHDDketGI5VIHHQvci8qjXXnMqpuWczDS3hBIlKGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDGhx04nDIUdfsHm5pR5/nD09vqXXjzZLjh
# MlCbl0QPlwIGZBMgedH8GBMyMDIzMDQxMjIxMTAxOS45MTlaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIFQf+KXZIvgs0K4k6cO/z0s9lCfnJDMuj0Eo
# p/MqLEj5MIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgBJPF7HItjSSyU6
# tdTtR0SV8Fm+eEcU5qCK0pzEUvenrYq4uSIUTUUAqgvimXHmuynacfjkG9OCWwhE
# wvguM1K1bbM9wxzCWL0DmNcNv0i2nd0tm9ks4Qc/1WyHZMpdBfxpHft/amyXlTb9
# fP5GED5IR3d9NV82VbgrBfhpDioh5ynLz/cwaaI1APtCc8aXGAQYtilVfTL0DhZa
# MuY+icpLiNKYC/mUQQ8oBbkK8mAdDvbcrSE0Cs509JFkGzcOJrmQUNXTpCmjZCiz
# VT/2ifsN3NqTsLFphsZOipnNFl0rN1ewlHL8vvHd7UZozWS53B+p+1KCyFvS21Ye
# PTP7h1gECXQCsiNGDPrBghvhdPk2+DDfmFRaNX6gKIikmZ0yl6LQcHcTYn7vcr8w
# XtNSwtsPdjqTwVUIinN6qAtvs+ZOpOw7Oyig7yzVsVZ9vQf2D46KEkYUmETcAGMV
# 8ChQjW+annq8s+V57KHV+SOpftbPONaSVGK1RJOif6sM6z7uYdyw1b0eudx3Z+aw
# fjd/9bhEHMM9uSml8fVBijN1QMXd74V1uAqI2+Za9xqcr9XjQS1GiY7ldZyM8CBl
# b3bsKZ/MwHq0PgYCgOS9AUcr22350qrFflzcgK7KxepO4n6zLDpEU2gs2miGelfC
# sk58R3HhcK+/imuacYAQ765Qr+i5Kw==
