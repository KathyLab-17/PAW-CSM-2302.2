function UploadFileToAzureStorage {
    <#
    .SYNOPSIS
    This function is used to initiate the file upload to Azure Storage. Splits the whole file into smaller chunks and initiates the chunk upload function
    .DESCRIPTION
    This function is used to initiate the file upload to Azure Storage. Splits the whole file into smaller chunks and initiates the chunk upload function
    .PARAMETER sasUri
    ...
    .PARAMETER azureStorageUploadChunkSizeInMb
    ...
    param(
        ...
        [Parameter()]
        [string] $azureStorageUploadChunkSizeInMb = '6l'
    )
    try {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCtAn8OZJgj4f36
# S5EGr0AVvlazVYY0r9TWUBxJp0U1UqCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMC2
# LM5q2QMVZdSGS1/NLj1bYHc55VDel+1KsR68atH0MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA28QFrC/vgapKhHuHgkd9vr4/hlXZe8WP64nY
# 493QhLbxuguHG7zWhUlugVtBTRB+hoJ3cc7Ao4DAjhnWm4EsJeN8qsjJHJwtt5Bk
# XTCsIF0AlPTms4f/DmHSZDzqdkpuF2SGBLQQcsa17LxY6am9+ufacd6KnBsZMEIN
# 6Vc7YBYEfPIi5sTbcqc/a2rO+Q8COn2VBBof9gaDJQStHRj6CWc7Dr9UPYB5TiRu
# TrhGku4RRtftkzycTtNtKlf/3KKxNbTNcaaxM4OmO0tUZ/osdoIVf67MpKp3wGmg
# lbWjw70pyJ2UPKeQqlq6yygn+Falo07kl3Oasl07dlM3MAgVraGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDaIFf08N1PHRoQnHSrdMHm3We6o8eKppDj
# GK0aoJM4SwIGZBNQb4ieGBMyMDIzMDQxMjIxMTAxOS42MjNaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIDRPyoN0I2Zj5X425xlwgBoMcp0Mz4CtSR5o
# LyEVMN/7MIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg/Q4tRz63EiRj4K+1
...
# cmzprmq4oT5/HJRv+dViI7pOJTANBgkqhkiG9w0BAQsFAASCAgBXPPvOm2JAub9k
# aklirRA7BEMgnPJmF9zKbumQuMXtmUdotmcMr2gEXymyFXjor9N1OzkYU7JtHECi
# jlfHZJSweTItOHUvSepjT8lcuuUxxR1Dw0igDw+3RjKKGrAqGtqi7Zy+yd7rwUhc
# 5pVNAU25v46v8Azq0lgH3z7BtzhZxABz65DBum4eK9eptu89FWIoaBS96ckYrCzL
# BmDcuzVUMmttST2/+mVYkpyq0Pao7Cpzr7RdNc3JohDnKEnIpprJV1F2TabGFXLL
# dKigBEbUQ4/nI5ZXTEkiuOWNpN1R3BBN40IRg2xZbQy0/9GD6+QYdSoFJxaziPlp
# Zx86fdpRvbgMW8w2BS97teKVIlfj/gk8zBUGr/5GlgeuMypY5WZKCagQCjQlcuoV
# TPWKVmpNmA2KeMMqIxEpMJF3UkIrFJeU+T74Ot5qrHPhS1CxW2hL64AwE/pFxRI7
# VRNk5NcJ7osY5ujSiZGtaBkEWkkkcjs8c/4p0tdRGlvI8h1S2vtDP1X3008gDqnr
# 3oiaqt0uux/M7es5nYa+MqV2yI39Hz1CUvHJoiBHa6e2L34zJ86Yj0+gpvizD9+Z
# hhK08taUnfiZPPlrRdFft0iByxPl74r+bl1h/OiQbF5A5IBkIlxdEtbng6A4946b
# J1VTh1Mv9Z9zCVFFTwr7k4mupWYVMg==
