function RenewAzureStorageUpload($fileUri) {
    <#
    .SYNOPSIS
    This function is used to reconnect to the Azure Storage Uri, after the time out
    .DESCRIPTION
    This function is used to reconnect to the Azure Storage Uri, after the time out
    .PARAMETER fileUri    
    ...
    $actionBody = "";
    $rewnewUriResult = MakeRequest "POST" $renewalUri $actionBody;
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBcnnCeUX8bpXgY
# Ez5m0T6tXmnonslarRvtlhmUkAXzMqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDfC9DzeN7Q6TMj70mI7k9Hi
# Ahrt8kpeDkWQu5h1tOmAMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAA9PozoWyo3KhoNCRx2IffrDbcGCCeXpkxFhVTe2XdlE8O+dI7J+VSGv8
# yjWcvC8IWn/vEMCwj/jSHqqRWUoTP6bmGYx8852r/i93IXtKGGIPIHKnTvw88pSB
# oSPshZe85CCER35bP7UxGFV0JPpo7gXW+tCqzdYfdAJhDPoEtCwhJIj12bRAwgb+
# hGwYEgeDVbx+312BG0jxfrg7bpebzyYUWaeSLc8kuwAgorsFVLL8/bsBaLGBFq9I
# RAQlgWH502QpaG/QQo+5UtEnDqQb/tQ82sjVhvmRYWe2A4TtGhGC6lTIIzNNYgfk
# 8hR2l0iQcioPkJBpuRI5AEOKsffUNaGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCBzybM6rZ2SjoMdvW5l74sZeaxKSEc1Je9fY2xk1cTPWgIGZBMWIsTk
...
# AQkEMSIEIIzOfnQjSCrHxaonT/wgmfN3L2P+UYyz254VtjOQzC77MIH6BgsqhkiG
...
# 81lrjjANBgkqhkiG9w0BAQsFAASCAgAQUaFeKzD2tdvrOZpdwgWQjXERhJ5CDvMU
# m/QLsj3iEcgNdnspVNDmhTE/p5X4VjXTJ++llvsXOytniHfstuCjIbKz74hG5aMi
# LWaPKkU3gIh0zLEyjbumXni0Ci9CvXmu+MW5KxbBPkg9yETbPy1Tf9K6/Pm1Y7dX
# ocyA60pO/RCKrzrUWsL17YS4ctjZW3mrlZK5N0Ahsofogkl0uCsyF1QDlzqv1UeM
# lYeQ+HMDMMyfExEUllLVIukKwNduuczZJoFgtiTLbmlmGnQ5ygBt2LHa2NFdS7R3
# PSxDiSoGC7dM+5ciWyAazNWsRGVNVBKQWY2JTxi6d6xyXyZbECB7rOJP8k3CFe5M
# h/OdeMB39OpTg+5V0FUXe5BwunwFHCsaDnttbGOg8IHptolxdBt3FJC1i4IJZX4e
# pO8dUvvI8f5MTEExBw3G1V+oV40HiLL3Mpx2h1h7wJ5L3WejwHU5oFJ5UwV8JzKJ
# bQusGLkZyqYOxf2AmxmZXB5LS+exV6rrVg9jzRLZ6AKWNOk5SaId9AeVTbN8c6FP
# YVpf6CDf5/nI3qDpi/bDZV9Im/mB+2Boju5cmEcxt2REtcICFSA+/9QbDR2UhbLw
# nxAqHtxLTaf657D2xCZqJWKycyHrYUdFyDJen5Eq2OLLu/upb6/Gi4GhKNshKCSS
# WcG4ljmOFA==
