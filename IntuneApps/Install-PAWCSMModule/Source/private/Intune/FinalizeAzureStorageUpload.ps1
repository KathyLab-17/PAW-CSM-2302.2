function FinalizeAzureStorageUpload($sasUri, $ids) {
    <#
    .SYNOPSIS
    This function is used to confirm the latest version of the uploaded Win32Lob App to Azure Blob Storage
    .DESCRIPTION
    This function is used to confirm the latest version of the uploaded Win32Lob App to Azure Blob Storage
    .PARAMETER sasUri
    ...
    try {
        Invoke-WebRequest -Method Put -Uri $uri -Body $xml -UseBasicParsing;
    }
    catch {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBLwmEPR85Li930
# YLJuwNMy51oStRIKVNqlNh6OPtqi2qCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIMsk
# elLGhaNWzElGzQqQSZwE2X3XJ8eO9/iH/J0BuefLMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAnkLepXyx6DFLlL+glBMLrgum89kbObPZ+lGU
# 1cxoDPJL8bmANpPsweabFpDFdY2f91Hmd6uYkl9f1P7QZNQ3bJXkyUUSnjUoLJe5
# fQ329oJ9qOxoo6vFE3Ph6L0tkDcgw3lkr78pxCI3oNbd+cuE8ZF7NMyribzjG7V6
# hM2ZGVT928Q/5bvQ6bW8mw4uvoudXMcVWIQEPcRQkdsRQ98jbZFXP4U8uzVccpmQ
# KQHe/fINICs0QTLQCWdzrM1C1Zkoie53SWUFJOgzA1q0ySuiXZOesClSGDcJY3RM
# VBGiFFqVkkpdg5Lqx8hk9yO/5rGD17c2wFM2SPHsPqjUYMO7eKGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBBQvzWISmKGmem3Pk8nh0B1tV8g3RyZkwa
# jYrF6VSyrgIGZBMgedHgGBMyMDIzMDQxMjIxMTAxOS4yOTJaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEID1cYKmFbum/J8tR3zH9AL6MX0N9ehKFlUp8
# SqtVc7QdMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgB6GfD3aJWGEV1s
# I/+OmzpBHNf0ujsJD75OyfQMQJzocNFKhKXV3O2zAkvmXz6/bi6pqwPEOHe3nNpo
# v+rZrYsFmbksT6dgLsTv02nEHE8BmF4KdH+LE1JZToO0yt/ytSrxP/hxAYNn/hZE
# T7gNVigFYFs8XGRpENEQU5vennkTnbCoDy7odo5c0gkpCr9esddvGbyRRWEaUulc
# EZyw2qkE+vXnY/wbZj30ZoRB+pMueV06omulM5qquJnqzVzViBGW1dmiL+FF8sFv
# OX+LIb4dsKLi3WXVVfkrcFTmuEapO9QmV5x/ym3wc8WUSuwqvpBwb3jDzqT4pDUq
# NPiZq7X8hWYtw/iSVuv+Zqko4KhT+YI8XcpsSshAKkG6qeGbMijjmdR42Yw6f8yj
# Suow5iYiGbHIdEnxwzoQJfRPVb56dGRSTJhjifOH+FqNfofKleQ9M8OK8truUDu5
# aPnepg2bteCK0lyc+VYZ0X+4qLt0dMdwGJr7b0JOhQ3TaFvOB4m1cRYy9bfE8GWs
# AwAh2vSpWYC/+NWTQiu+h+nUSSY46CxLaPP5dmoCWByIBDrzox/oyY+FqEaudh9z
# NdcskX4OnDKwfVrSyIn+/AjE+E815w0GZ5L7CcPeMwxewgpueJ3P9ZOKuib9zU0D
# Xldii2SauC13ueUevTPFS3O4wvK2hw==
