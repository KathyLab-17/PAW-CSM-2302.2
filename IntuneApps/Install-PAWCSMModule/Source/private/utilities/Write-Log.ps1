function Write-Log {
    ...
    Outputs message to Event Log
    .PARAMETER WriteHost
    Outputs message to Host
    #>
    param (
        [Parameter(Mandatory)]
        [string] $Message,
    ...
    $LineFormat = ($Message -replace '^(\s*|`n)+','' ), $TimeGenerated, (Get-Date -Format MM-dd-yyyy), "$($MyInvocation.ScriptName | Split-Path -Leaf):$($MyInvocation.ScriptLineNumber)", $LogLevel
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAMLg4Otp6OdGhB
# Fi1gI2+eJ03Ne0Vjks/AKcROTDeEf6CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIA3m
# xikNeC92cZw+D+52Q4aUh7UmCRW5QDXK+4D5qs1JMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAr0DqTq43UcdMjL/VSgY/ETJ0SFBXm+CiD4yk
# 0oCgCrMc0aP/d7+aHgLvgfH4dln2KMg5PntnaJMDqhIA/2ikUFXDDQSxb85uFWkx
# sRFiZRoPfcjhlrDiHrE7JQHEk+NFKYma1ueP+528l2rrPupjijQCP53JPILG60qH
# uvfzSbRWbXj/PbJK+81k1AxnCv4gTV/42sWLklJqLRSGBILFuZQOz9fw3L+P9dFB
# 1RUHLL5YXYFfekBS50ni7RQoT9hfNv6ABYImJEi/MV1W2fOJr+118T+QbbjrGp7c
# 1uxvfuUivtBpYnzvo4Z6CPz27CKnOG62YOntYR+Ku60DXjRMoKGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCARo3RjWjp9hi1A2UrPsKtnYWG6sw/SpqC2
# eXHW0O0HCgIGZBNduD9xGBMyMDIzMDQxMjIxMTAxOS42NDlaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIGiEmI452/T6Lsx22Dx9Pq1Tlr1cgL2b2ins
# OeylcyGLMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgWvFYolIIXME0zK/W
...
# v3XZImgEh7IGrhHes2IAq9B9lTANBgkqhkiG9w0BAQsFAASCAgBL5JL5o+MHbdM8
# g5TmJMoNJPrJKsExM0KRA+k0Kqny/U38MCmUZK+F3y94Y9aXxTb3NsfuvYlQFrG5
# k/CfqzB2cNgKmNoBPkPa44qrwE/MqxFRpTyOFpJdC6g37S4fzQ4dxszoKZCjFyuQ
# s5wJdy+KXUbzLNLy2ee/Z1XAGaoU7jvFJUkQZ71eheObufnaeG0jvm9WRvEK6bjJ
# /kv3nx/kD6dwnPe2nQd29A2+tps3i1TMPLLoHE+tmOyvlnednBbKHwJ/0NWQ2feY
# Rh3AhLkD4byM/Hi3AQnQLbJEIgHBuBERC70hhNAKdHUpXmMpiPHcmy1ZdnP7Upeb
# cPSeLaUBfZ/4EUHCacDdaqeCwzdtTpsKRRGi22ZiSbn4A5DJAu02y6lRbbEfTlS/
# nFMzuRMx0/6b6aE6a0//vma7FkkExEdXfw4U7FycYNVxFOUwEFeiDRbA3dTGEoNS
# mUwoU9vV5rvnnV7gipnopcSivmJNedXxHcvLusw08NwrOpsdx1A/1aVolwD0VtT2
# 5WNEuU/uZeMXHLIArnhjK0LCFkcG4glYsafL0NqXrCKuo91R+dgEHuWXSTbN6k0O
# WM8/BE5+vNFVrd8QBkHHE7jDMSutWRYNiNn5k8OHcGT0aGQ5NZM9J+bOO19HMBVY
# Q6pLrncg3f+cZmhHDVn7tUW98QsLIg==
