function Test-EnrollmentStatusPagePolicy {
    <#
    .SYNOPSIS
    A simple function that looks for the enrollment status page and returns $true is found
    $false if not found
    .NOTES
    ...
    if (Get-EnrollmentStatusPagePolicy -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDs1D090qlnZaKO
# sEohrmA8ap2VOP9GM+4a1ba9+NesjqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF0ofdbWvtFlZJNXgJvBo+KP
# yb6V/SXxFfxcOUBq7jQBMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAhs6KW6SLzYCYvTgCIMsv+vVkGzg9Q3NK1QdwkLPr4muzFeMmXTJsoI8z
# OBVgmbgfujYlG/EnJZiQX64psZT8YXJZ1ATk/j4Z4TflgEziF1twXxTbzXn21TCc
# mdLqiTxt+fVXltBLJG2LWsygWXdqU3SBKMdGSeN2UEPvMGK22OCu8R5TzRvtXJt7
# Gh5+uzjvHKQ5yCNNP5bk9I7k+K+zSQAYZSaGK8bGiJx6vW9rkqpyY6INWDiF1nEV
# 1AKiCHDw+iPas3EGvsw2XXteVN5JgVqs2oALgrctFvSKJNXx59AHN+8JKfEDm61Y
# iN4YfHUahRl/lXQu+oDQmc8563QgO6GCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCymHwD4HiS2j006Cjt/iFzcJyi2ay4fAol2taaV1XpSAIGZBMWIsTd
# GBMyMDIzMDQxMjIxMTAxOS4zNjZaMASAAgH0oIHQpIHNMIHKMQswCQYDVQQGEwJV
...
# AQkEMSIEIF4KvGQzV3BtTW+5iWdFgKRQmRx7L1DvtD8paIQktNavMIH6BgsqhkiG
...
# 81lrjjANBgkqhkiG9w0BAQsFAASCAgAgwYf2/Pjune8GNNOajRn4F2FN+FOg/aRd
# dlVJGMW7dpJS6GmWzv7BiLVK6oeODzwxa3gB8MdnYt2IB9oW2Ma79F0kc0MgjQKR
# nbKROvs6gW4ghxrKsXc0OZJiP8lAWf/EmDNcW6bFYtz/g5aIOnUpUv23aWw6Qxbr
# nSlBlkJz0qmNUfshfBsnmxH5mHcrm/GJx/5eAH0kx4GyuoLdyUyMmy1vmiFV+yzl
# QWMYtAM/mcsPqK8tdTXe05euy4Uhy9KTxEXfaS/JuZaBF9kWl0LSJ15/gQzrGaRK
# A2kDFYmzxG1AK389ogGgOVMi+FutWvWOVsv/Iajoi4UeFu5y4NA4bHoVXbLJzoCg
# 0DEWpe10VYFC4xfjVKlY3uEyEroZ8lJxpjpTzgxHxRiywMGCNUm7rgqrR/q1aT18
# L1HqXjk8A+DTlbzappuQ1PWr+AarKkp/TP8mE6ZM+cWoPOV/RKQ5aqQnnwkvtFfZ
# mLG0q5WtsJV21H9A3lCcm38PQtKotDrlD8ks8gpEufnR+wjeJCeP4To5PoM4GV6V
# 5gCBeJIgu9kPtDnhkwvQA9FbOcxhLePA3b/5C5mqysRnknbVrUoFCvB+cLUD99sm
# VvuM+dXpLtJf4gW8+2JayMBXs0dmnco5+Jb6zzYD0LSi/Xv3AzeDDn23nUcXRZKc
# JfrgJVrxTQ==
