Function Set-DeviceSettingsCatalog() {
	<#
    .SYNOPSIS
    This function is used to add a device Settings Catalog policy using the Graph API REST interface
    .DESCRIPTION
    The function connects to the Graph API Interface and adds a device Settings Catalog policy
    .EXAMPLE
    Set -JSON $JSON -Resource $Resource
    Adds a device Settings Catalog policy in Intune
    .NOTES
    NAME: Set-DeviceSettingsCatalog
    #>
	...
	#Create the Intune policy from the passed in JSON content
	try {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAqU0fLQBRpoXQ7
# QLMSP5D4Y7RLPUcad1kXpGpveITeeqCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEII5c
# JGcF2Bx1J3A2uQwyVw7EfQ6Lxd9Hd8fTTRajsI5wMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAfIZHkbdvYMvAwcI84dut45/G3Pn8f4gzLCIT
# eTOZPDCapZx/RsTSqM86VFeaZGkdBt1/LRB+HleuuQnK1sbDKpFzX0rTN1vxBr0w
# uG+6C043h3E/bPuqZaLdaRBIoik7YEX9LBZxRtP0oXwmS/GGw2ODA6PwJobFg7B3
# 2vYs55OhX8H6xuyvd0uSEceAMK2KETI/1+iRKmb+Dkm7pg5w2x6DkLkxDRgMGuJD
# tabzbXMtLsA7fRsHARXgs8n5jwxidzanJqnpaPPxZA91iN+3ECw0jcjogzcUfqji
# YiRu/tvejByKnnoDEg6wF8KBshJIYjpRVYbruXLuncVZklc2JaGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAtdf+XXLgXP4KXkAf1aD4kC2xA8kRQBQo6
# uL85rHG+NQIGZBNQb4iDGBMyMDIzMDQxMjIxMTAxOC42MzVaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEII1/r0FVZDrMFO7EUdZMPbjllqQdHpcE7RAV
# 9mnF4QxSMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg/Q4tRz63EiRj4K+1
...
# cmzprmq4oT5/HJRv+dViI7pOJTANBgkqhkiG9w0BAQsFAASCAgAMiWPEjd4dbD8l
# d4Rwr8/f2v5+D2AW+jum5OzxkYe3o+S2Eyi2cS02Z1D2+lroUt02Q57/dV+j7Fhm
# ZJzMgkC6urm5UftTzFLh2TO5d7KSqv8vriS/TchGPSbdvxjKY7g/F8SojO+m1g4b
# 1/BtAw3L7VBNbqUaGrZA5ikUqKPwJhe6bHisCGe9LduZSyGLwO2Izyq6/zU42T4V
# Sb68bP0NwHZxyfZb3mW+FkZO9m6UTjQaK+7Togh2lXbZniCLxpibblGUbbd9NTc+
# CKiMcDgwfHen5fcmRdkwJwFQ+mZDEGOogDNdcOl22Bw2PRVjRYkMjnoxuGbFeDZy
# b4JOsg285yU0apMaCsxIgPxyR1qGzRll4sdeJX3rmF3lRtN75VymyqqRgNowU0yU
# daL/vXYb6JPn3z6MJ7SSDZ5+CNMisqIme2EvPpOGJmpmSQr+caHZ5oQJMOHUvc8U
# ESQVJRvKSsoRZQXs2i/NCYWhusTUgSuFhtyi4JNOlI7mhd3Xn2vyHSILMKpFK5Oy
# uGgzuwqfiu8o3FllTnMRyX+mhcBWdYFXTAfAa09WmYjQPSLNE5QbFEV4GtNSWwqB
# J4n3UVCduIq8q8/xVywylziImjVT5JDM/E0MbabykcZ2cr5d2cUhm6KoXo+JnHQU
# yAjOyMfMYoCDT2wUpd9fGBeEPoIgsQ==
