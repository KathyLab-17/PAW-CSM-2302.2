function Import-IntuneApp {
        <#
    .SYNOPSIS
    Imports a specific applciation into the Intune Tenant
    .PARAMETER AppName
    The name of the application matching the parent folder name
    .EXAMPLE
    Import-IntuneApp -AppName Install-VSCode
    This example will attempt to package the application named Install-VSCode within the IntuneApps Folder "C:\REPO\PAWCSM\IntuneApps\Install-VScode"
    #>
    param(
        [Parameter(Mandatory)]
        [string] $Appname
...
$groups = "C:\repo\PAWCSM\IntuneApps\"+$Appname+"\groups.json"
Import-aadgrouplist -JSONFileList $groups

$app = "C:\repo\PAWCSM\IntuneApps\"+$Appname+"\config.json"
Write-Log -Message "`n Intune Win32 Applications:" -WriteHost White

foreach ($a in $app) {

    $app = Get-JSONContent -JSONFile $a
    ...
    if (Test-IntuneApplication -DisplayName $app.displayName) {
        ...
        $path = "C:\repo\PAWCSM\IntuneApps\"
        Set-IntuneApplication -AppManifest $app -IntuneAppProjectPath $path
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBvhcSWg/ggnhYI
# vlXa2KhL3hrORpaPrOYxB4VHbsB3IKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICU9
# iyMSIFNAG3MvUDEu3TyQR4TNlm4BW03qCv485ImdMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAQ6xqfI0QwrUZVeSzl4JBLS68WNHurELYYEM5
# 2i2r9g7YXaiFJv9cy6SbPKZl0V/9B1Lj/QHza5gDTEiLTbsZtMI/PVbzEZ4txfdV
# MzMmfaGMuA4lsMBeyl7kely8vG+O2pAKYejLgOhdcSmecEW07qV0R6SaocZHdwjT
# qh8B10vn6pd9cPm5P2rn0nfDh1QDQLebaqB5uxucyyL3x5WKim/b0i4XPCm23vkJ
# lnj2STPM/PY9/OERO4rHDEsl/R6D0UOAprO52KDGeHdh+c5Pt5EbMohB3OqUYb+/
# CPrOXnM4jCdsomyxti7G+33Fh+HJBAaBZMl+z5jepmDFL7kLyKGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDZtl9xukAUuVmQLoIk+8bHVBXNj+vVgzc5
# tc0QCcTGcwIGZBMgedHtGBMyMDIzMDQxMjIxMTAxOS42NjRaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEINgBsl1mWKlHNG4XWQw3eXSocq1BSs4iLPBW
# AEQozcdZMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgBAjz4CTOCnU8Jr
# uXoMyeBBhTf9wbDZOOn0YX/DpyM+VdJSCykYn8XyIYKXHdQgeogDidZSdJ2FrKze
# 9he3BI0PxRmVlOHYpQ1qGn/zXSgaYCA1Mye+Lec2RwlAYJxBB391184dw+hNEjkf
# GyqgkTCyS8JcAnmbnWri1e24INp3nxhcFGf4SeV55PxwYaDV6SVo33LVXAdKQdBJ
# 7iLoes8DP63GcfFavoGFoQQn03Ao6ak6va19Z/acA+7AjWK95M1Ni7jDV9bBnvPm
# BthXnUGNWMW7rXAzGQeSSh3Ly6eGgaUnXF2LhXuWnPDo//dKxQ9aJbUmEpreF/Mb
# h0ehDJyBFUffeX+CBCC2Yykkcf89GoFyoeCfyLQkXYpyL0Pq9vQ44lvDMQ8NHr/x
# ZptEqVf2JsTYFnRP518vx5ERXG4iSqcI9ApTcGFxFxFcSov/DGo4NJ71/sjBPkln
# DhoxeDlrRNoJ0MYGL/9GwZ6gVD8JkFfucfDk9Ccjfzusjzz7E8YljTg0ry3LG0Z6
# 8euc0ivGK6gYrWU0Vq7kPYcpCLXDS6ptMgkQ1Pr6as7JkxofEQadexMBZLmvKwE4
# YR/p+IOxBtOWJ46J6AkvQ2NwtdWiFirI+rCEBJBwVHFvhGsDTbTzWWu6QZ0bpsFo
# tmUa/wepxI5QvP+luEr9DX3MAJZukA==
