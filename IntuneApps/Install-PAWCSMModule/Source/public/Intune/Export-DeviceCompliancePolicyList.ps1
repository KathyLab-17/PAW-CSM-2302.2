function Export-DeviceCompliancePolicyList {
    <#
    .SYNOPSIS
    This function is used to list and export all device compliance policies from the Graph API REST interface
    ...
    .EXAMPLE
    Export-DeviceCompliancePolicyList -OutputFolderPath "C:\Users\john\Desktop\Intune-JSON"
    ...
    try {
        ...
        foreach($policy in $policyList){
            ...
            # Expand policy settings 
            Write-Log -Message "  Expanding policy: $($policy.displayName)" -WriteHost White

            $policyUrl = "https://graph.microsoft.com/$apiVersion/$resource/$id`?`$expand=assignments,scheduledActionsForRule(`$expand=scheduledActionConfigurations)"
            $policy = (Invoke-MgGraphRequest -Method Get -Uri $policyUrl)
            ...
            foreach($assignment in $Policy.assignments.target){
                ...
                $groupObjectId = $Policy.assignments.target.groupId
            
                if ($groupId = ConvertTo-AADGroupInternalName -groupObjectId $groupObjectId){
                    $assignment.groupId = $groupId
                }
            } 
            
            # Export modified/sanatized config file
            $policy | ConvertTo-Json -Depth 100 | Out-File "$($exportPath)\$($exportFileName)"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBhWeitUG6ATg5J
# 1Z+ZqLDhvU07k1FWIm4XtOCHnnHYQKCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJBm3GJ1yRtPwKbWTlB7n/UK
# NMwaQYGtFyKykA0nxOX1MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAJjTUIXtKDtQBd2gU7TI0ANIhtBoUNwrdCJ7m612woSyGtlI7uDLk31d7
# EoBmqq6V0U39nlNp5/PTLNG+a3PJrYV4RuOe0QRbfWGam3EWS0j0XQQXYM10mFWs
# RH7eosU11MW95R8yj2DpJBwlQ26k8+qWFxmK8aeAEfAVbzaYwIo/se6ppwofQJy/
# 8xMg57H119aTcVrOrxqvBE/K0o+n7Gw8R63ENwQ3EVmNjnc+4tZm7scYnTPes9x1
# r6Vhav06/HbGbDv3CfRcZFFH1SGmilxMvXFh8OyCWhUAlc2HaepbaVxrhM5y17PC
# liTMm1RRpF6CZt4CPIjd2UpEq2AA9KGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCC7YDRC1+sC2B/mpZayL/ZQx2S9LHU9Afc+5ajg2zLyjQIGZBMNlN2+
# GBMyMDIzMDQxMjIxMTAxOS40NzRaMASAAgH0oIHQpIHNMIHKMQswCQYDVQQGEwJV
...
# AQkEMSIEIHU2PPQgoMVztJotvyN1MObiHK0vgXgwvcGc9+6BgvCzMIH6BgsqhkiG
...
# RvtnXjANBgkqhkiG9w0BAQsFAASCAgAC7VBw/s7B4BklzqtMu6vOj90RtCBRca0+
# /zgBkPlOkTb60CpLzTHol9pdiaw0Sl4IZxFmKsATbfJsEachLgGgbDbrWxTqqRzZ
# zAAhqsTmtJyH/C7Mt3Q3++YVB48zBAzuIh7zUiVGyQzV3+/hAK2SLAMkKSDvpJwS
# GTIIjammgFdohQbyaagf1IyhY+9AAOUfjZy9h34dHoHMbC1LydO35Q8LideFhtGL
# bqP0o49nlGBOCN5wXsnBE5JwPUwlvWCy8P/uAc1s4cUtRRcqqnHEru2GzGMo2XfD
# X/wVH2Vfs3ioZ5J8P2Hqn9lahILpvsnw9vcBP2eODUkgYJfy50o2U+Kl8OMnFSDr
# 2TZsdQNIikiR134H4ukmp86eeuEuxSAQQUEQaZ+KWg9/IOf5MJ1igpFQtzx+130F
# woTGEXk9dfOELam2YHRddidrwXBe/z6rEwqs/ZxtOYD6cQMRcxIHaZqV+KgJLLi3
# 1LWQx5gtD4aCoDupa04T/6g0gIBjEHE2WkCnKJDJgVHW4MW57XuuS3q/F7FtA0Ln
# srgWN+fsqHt62LTGwca5kWmlvCFKkO6TrtRROaoBGo+l0gasPz1zKFAOtF+htTaF
# bhsX6OL8DpboTpJTpGJA3kgFrUKEvPXe6JqP/aXhdY7Ar5U8nMbLgP57vVwxE3eJ
# V65Uah70cg==
