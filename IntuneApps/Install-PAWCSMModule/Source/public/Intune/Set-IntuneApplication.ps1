function Set-IntuneApplication {
  ...
  #  foreach($group in @($AppManifest.requiredgroup, $AppManifest.availablegroup, $AppManifest.uninstallGroup)) {  
   #     if(-Not (Get-MgGroup -Filter "DisplayName eq '$group'")){
    #       # $groupObject = Get-PAWGroup -Id $group
 ...
 #  if ($CoreApp -eq $true){
  #  foreach($group in @($AppManifest.requiredgroup, $AppManifest.availablegroup, $AppManifest.uninstallGroup)) {
  #      $exists = Test-AADGroup -PAWNameId $group
  #      if($exists -eq $false){
  #          $groupObject = Get-PAWGroup -Id $group
 ...
 #   }}
    ...
    $groups = "C:\repo\PAWCSM\IntuneApps\"+$($AppManifest.packageName)+"\groups.json"
        Import-aadgrouplist -JSONFileList $groups

    $app = "C:\repo\PAWCSM\IntuneApps\"+$($AppManifest.packageName)+"\config.json"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCpvDFxHMUm0/JL
# RnmbMBDwVJyXnR0o/1Lp4l0gxpaMjaCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOqV
# 5s9auQoSvJQpUIMlfXHC7FKnIC147zfLkzEUdT5uMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAsc5A+AdVF77dh3a3kcu7L2y/O+dnSF3cOF+4
# mgQjC1XUesSZk/toi6Y0zfrZe2iZlDbpkNF1czbWcoNTJgz/MR9WYfsteEdw2Oul
# 0KDMBOIhqn1CCUKZW0APRlquLEi9+NKEI38kD8ic9yMy7TQLC/ogDjZQRIy7KDKf
# DG2zfmMKPDUdw282n2/NF1yJcs5WZFYrZP3BN/e8YxTkiLoph0MLNqJBmHJ533Lw
# HH/HA9H90iup6IRax2izoQwigfXwhwGGmN+gdSP3Rs6zeDx9s+DhVPW8n0Qsvjhg
# FtVj9zS8b47fxB0i4ZNT8lsrX0I84iJCY3lWMO58QdZ+H0S6xqGCFykwghclBgor
# BgEEAYI3AwMBMYIXFTCCFxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCC5wYMUgVSZHhBWjD9rn41+w+91uOmJsLNu
# cmKX79jIogIGZBtBQK8jGBMyMDIzMDQxMjIxMTAxNy43MjFaMASAAgH0oIHYpIHV
...
# BDAvBgkqhkiG9w0BCQQxIgQg0rAtDqVE3dvKuwUcJ0orTkXdWwLmFUYRoRevm1it
# cGUwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBk60bO8W85uTAfJVEO3vX2
...
# 9KkqgRg7ouEbMi64l/P5MA0GCSqGSIb3DQEBCwUABIICAC/Y6QQQFYnwdZXiPdBc
# DM9dIGkelCA5AmAVpXPHbxEgoB0+hV0KpgJj3bapEtnxMozlvw1BjYBLNj99E5xw
# pf3RNQFNypxdUWS4BaRv1rKPvlAnwtN6w2fhv6dxXBa5eto2Ps5GnCAcKPYZ0ahu
# 8zhPhVoFFvcmeqRaHMlE3JGcqmt3vyiMNQTWSw2xIGK+OygrZkxhcrkPWk+hq28V
# 34aAx2wooWqjHycX5l6X0EPXfSgeqADZz1qrPJkEk3+f7sANnkmeNGZ3nQ30sf2n
# 8mkJ5KFeqR+b2LePNf+0HHpjSNc03PpHwdx7OHyu9ZES1IPRjlHSDrkgCKWqr5b7
# TYDdN+sy5xrEQxTp89Qtt7bODhdOcLYxWJD80gJIQoP95HeDT3HvOl4dKLbbbL+4
# VvSRO8nfcSQncenyUnSJY+DfCzL8SZ4Wxx9EOEy73g9Mi4Dw1DQ80Shl+O3vG50l
# swPSjGdfls/gODHegmU1jjVKK5d1Bt1LDaHRecSGXFgH9I9+s55l7Vob5UZka/dK
# cNOHEXKBE2jnVrnUNEi8OMdphXL/0Bp+9GrLBUdYMdOkqvB8Iy5llx3u4Oz9aEpH
# DCuqLzUqyUtK3LW5cm0cAPKe1d1JHUPc4mJvGjaQVsVgmD1mB/UchYo/RCh8Ix+t
# gMXrvEfrLbfG0Aj5+E8Sx0w3
