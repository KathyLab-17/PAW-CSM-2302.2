function Get-AutoPilotPolicyAssignment {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    Get-AutoPilotPolicyAssignment
    Returns any device configuration policies configured in Intune
    #>
    [cmdletbinding()]
    param (
        [parameter()]
        [guid] $AutopilotDeviceIdentityId
    )

    $apiVersion = 'beta'
    $resource = "deviceManagement/windowsAutopilotDeviceIdentities/43dbd01b-ffbb-4a21-8a90-4d59facbd1a9/deploymentProfile/assignments"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAX52OY4ou1jmtE
# /P8S051GHV8kto7xC0bItsBeaHDQE6CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIEri
# xsPAYZ5sW/TbG48iQ8yS1sVdYZjoXJWTGFZa4XeVMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAEHqqZWQTcy0lWasRGLdaRTXDPxcHrP7CjQ3z
# DX03FqbYOC5WY7sSb94h+Y2yXeHPoSINpigPGfacQyrmkrgLbbwiX+ZoPqy/FQD7
# URPnFu0dyqnqHpAyjfmtPi3JSJIVmTyjL9+PsXTjCuJ8p/9Ej+uarYTDdGQHqdf2
# TvuN5iwsIvtnwHR1wq2/KOKogh6XdeoiXUv3JnF2thvSdvRzagYy/Xjt6Nw0DnCh
# SVDr2iN2EvFja6cSH4gk7DEsCT/bdOvUHWBxtkqFzXWTXjS9u4PZC2Etwp2TPp1e
# mjysUmvLiIwS7ez9RN7uc275yAS8fCFWHRWNBNcaS3A19RKD2aGCFywwghcoBgor
# BgEEAYI3AwMBMYIXGDCCFxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCobP1DqIwzBJgT+tBjTYNkg2SdNYOuItt8
# q5EmtOPR2wIGZBslkL1QGBMyMDIzMDQxMjIxMTAzOS4zMTlaMASAAgH0oIHYpIHV
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgCwQ26o23wrxlsJR6AFTMaiGu6scGkAqn8WB0
# EouYDg0wgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBsJ3jTsh7aL8hNeiYG
...
# VJB+Z+n0fmTzxNUlZPnKggUxMA0GCSqGSIb3DQEBCwUABIICAGC62WxHGwlYaxXb
# a/ddW1KNRdPWPeIMzdg6Hv3Zzjl7gqpHyw2n9zMmrvdbQteWKfHGgfXWym7M3Wh1
# BthofkwAXMaPNdfyulSUPqsAGhCpVmx6oKtrOT2M3RgcYFrfaKSsJ1T/XU7118Bz
# Qe6ZjI2j+IKR8VaCx5iRWmcjtL4dROpZgG7BgLJa9eR3My3N3tMmim+EhpPp5Das
# usFz6NMsuVBFZJdAs/+l2xhz10LFy7H0ckHpaIN+Mc4pi1GSUTbn2RWwxzi0txhf
# DtRkNGTQg+X57qjVYh9pMcUZ3Yuf8DJlhT0R7uJma0aHZBfkqj62RI/sZ8s+4b6H
# TaevAv4/MFZ6OaVPBef3/vISif4OeUDzx2u4P8Hltg5DjKoHB+gbCCOw8MYyA+kM
# 2yjH98NRDPwzm4Ra3gPbAlgIdBrCjCYsZ26rlC9apwBOM0ujF8u5DFJjdG2YUE3J
# aznStH2TuFbgZPlQe2PEJ7qaP7vYdLtL2q62SjOVp37b1WUPmtvyk7jmMvBM9Ie4
# xrA+ZX+JYfeOy+NKStEydhHVksO25YHtn5TPJTMUE/5vspkyZxI37Qn80AmpMdVO
# s3Iyq29ThrJj/xEk/rjUp/4XReHi/2K529DT3ET5XSh7Fe4LPVG0HQY7y6LVdwzF
# 4Getuu70tOgXzEqw5jBXbmCpuqQh
