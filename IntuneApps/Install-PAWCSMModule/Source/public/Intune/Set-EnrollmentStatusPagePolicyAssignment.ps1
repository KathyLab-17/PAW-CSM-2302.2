function Set-EnrollmentStatusPagePolicyAssignment {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    Set-EnrollmentStatusPagePolicyAssignment -$PolicyId $$ESPPolicyId -TargetGroupId $TargetGroupId
    Adds a Enrollement Status Page group assignment in Intune
    #>
    [cmdletbinding()]
    param (
        [Parameter(Mandatory)]
    ...
    $apiVersion = 'beta'
    $resource = "deviceManagement/deviceEnrollmentConfigurations/$PolicyId/assign"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBYAq83FVHnrnKa
# +FHCFImZC81iwZpD8Adbe9Dwu61DdKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIK/X
# kZU4eYSB7zMNOODYoG9MHTirhEvolabG99aXkuQzMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAYFz3NfcRYuPlDEaxRP27xc3uhcNq8UjC8MGn
# dGRdxCXATT9dfm4wD4ZHhh1MxFi1egCm565r8+bN6db9XOnIarJyCWuIGLlWgIDa
# v3ArYtvaOUZ+2JXjNxeaC+d+MKcUOVwL3ijTF9kkv6hI50goEjXSFcD+GNim1/Nd
# Qg12AKdZWmabkLT3asdYrYAVOrvM8YDGRRlQuVCy7u2yqC0rh1cJPlHMZ/Y0bSGt
# cpR3Bap2Uv+6GqmAmIHDvkXMpoM4A4X82EqcShWW8kzI4eLdbAU9H7yv6b56Fu6z
# dwRraJdEhartD7NaS9zGZOYOGWbK4E4F6R3iQrDtaA0UCJ2rc6GCFywwghcoBgor
# BgEEAYI3AwMBMYIXGDCCFxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBtmQTUL0NcmRV489Qgotufy+7ZhYC7WYfs
# j/IcKMskRwIGZBsTUZ1zGBMyMDIzMDQxMjIxMTAzOS4yMjNaMASAAgH0oIHYpIHV
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQgsCeYCHOimP8K3oHHpa1PxthaRMWPePpvvxDZ
# w6HWVzQwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAnyg01LWhnFon2HNzl
...
# IKao0yXV501bCoKS8UVKs3wzMA0GCSqGSIb3DQEBCwUABIICACD5qQ9HQaK8LwVr
# i5X9vz3gvhkDESq0pae22b0M10GmTHOAnknIUI2OHEfJtYQR5+0mgEj3ABjY0/MG
# 3KZRO+PEvC7i2zv6ndg+H0ETO/147Nq+P40NYRVUoQ3wZFOqMM7XwbqAQqkOTPGs
# 5h/y2iuamANWHxwHx1FzONUs+6AscxfjDfUM1aKwr1RWZTOgiOtJDsjQ0MUQ8VO8
# CZkaHRmsfrrXG0+AyIRdTN/zbHItMkArpOwJ2h3sqyqL3CSB/hg22nSqqBANghsz
# pLl4YXO7/tr4VPRjWqRVufOVOHBg7Dgdw/lLxNFZZh/h6OO0j4+br/JEvLCPdxMT
# kffPi+2LM1aPqNoeRBuc6ZJmO/F96aMqOb7qaGk/COPX7UAAUqzcqcuJrCmB4YSQ
# GbnxeQKTfYMhQ70BplpK7zWX0NrT6Hbd6K1wkGAMNQi/2lOJtPXIOQwOp0iVKBp/
# p7y03jj6h9Ks9AtnJ+c4Yn4Dr6OzheVqFvU64k5P2M5OLdUGTP1MxkOx1KBKu+Hm
# /ezsrY1nR64fPHXzLU8xuZADjmU7TeJG9UfjsPhKIb3sa/kgkQlzfu1Ibuyt2bIm
# WP6xXtXncP9hnt9y/2xcI3AEg7MYpZdv06Qy9/lwZLfOMgNgcRmXq8qxOOqsE02E
# YHHKap9ta6yESdBar6oZAJ4EDVkd
