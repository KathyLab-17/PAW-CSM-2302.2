function Set-AutoPilotPolicy {
    <#
    .SYNOPSIS
    This function is used to add an Auto Pilot policy using the Graph API REST interface
    .DESCRIPTION
    The function connects to the Graph API Interface and adds a Auto Pilot policy
    .EXAMPLE
    Set-AutoPilotPolicy -JSON $JSON
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBA2Fz6okPWp1ny
# IxSZr/NIHNNDPnToEAXD1dLTVcwNg6CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJn4
# oInrY77s1qCwExB9aQu5p5zL2oiEFjo8b4pgq+nZMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAt7dNPTrOlA+K+6U+jXSjSTJgwstuVgj0at1+
# ZF9LsvAN7VqdXZLvaVFNRdzfqBI/a/xuljktocmc2yikWv0lTn9BaH9X8uwEc5oa
# 0d9Xh+j2TecL52T/+f8+U1cIxQn19FQIrpmcUL61o11eG1UTldzEHrPbwHSD4Fex
# mlvobB1Dd0ILQrEazIjFWinXPM7OEUxWVeqj/s6j7BDLBr46E/KeMotVZfeyA7a+
# ykE0IdlgEaEYlnyzGe1ELN8gYf4tKGrCvMPYTZl0QZ05H2KBLaN5B4dfewQnadbj
# aZao8DsZtyW5Dk8O1X4MnQZ6DnImSlwQ3wyPFQRzxcPg/bra1qGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAF225W+reGwYmY2AdttJ0nIeqecl5QPZVy
# SOYXrv2MPAIGZBNduD90GBMyMDIzMDQxMjIxMTAxOS42ODhaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIKf4HZ+irCyPKDymIfJ0wNzy1RcSgvLDMCWX
# R7N+LIoIMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgWvFYolIIXME0zK/W
...
# v3XZImgEh7IGrhHes2IAq9B9lTANBgkqhkiG9w0BAQsFAASCAgAwWvYvUJ5dFsK4
# v3OMzf9f4eP9Ve7I17V4HfrkiTUzGFdnWmzVov0bZQPxcpNwSX0LAjQGRISdwKLA
# ZPlGz0e+9iIUXm+lSSjEGfP49b8rg60h5kYyP/m/VYi5OCZY7LfFKSiFMq2YyK6a
# ucJCUG8SpbwR4P4ZwxbOLZc1DVrWf87jjQxA7uQwYPECi2109Ig9DBRtH5KAFbAO
# I4DYMULU3GNl6rHJMoDSInHixCLbRs1EVyaHfGJmxVsbmU7jcyErMDAq4HheaFac
# oxGYJeGo/+AJ59QduNFl0ITaekUM+7eTfVsOTTpSJWf4FAMDLeBAmQOrJMleAv/G
# 2d9CGpKKVL4c5EnDioMul99XVFJ9x3veOjdhcTCYg43NT5MV6vnHRKlOK1X807OV
# Cg+ec8vxtQ5zbnhphsPHu75lp9uldS7zvcHV8LDgZRQ2YEACWkhPfL+I3pDOAbzG
# 9TogBwFSQalVeUnckCpcV1/hByuBBt/G+W7q0zmRTCwOhYS1ZgGaVQsPvWW4sou7
# s3+azmrHWme+9ljDrlh8xjDhlYSZkr6YbvG2tFRZP1Jc7I4cHk3BabwQt6ejKNtV
# dK9E6hfLNajWGrYpNORqDhNbqvEz8v4c7FgZSG4XiriqNNajwjeQb7NJE18zdEax
# GKexZ58iKV0S2P+R6oRVXoFRomo0xg==
