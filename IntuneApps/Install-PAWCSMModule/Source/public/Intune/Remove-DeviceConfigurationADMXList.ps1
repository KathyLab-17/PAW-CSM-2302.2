function Remove-DeviceConfigurationADMXList {
    <#
    .SYNOPSIS
    Removes a list of Device Configuration ADMX policies
    .PARAMETER JSONFileList
    The list of json files that contain the Device Configuration ADMX policies to remove
    .EXAMPLE
    $jsonFileList = Get-ChildItems -Path .\JSON\DeviceConfigurationADMX\ | Select Fullname -Expand FullName
    Remove-DeviceConfigurationADMXList -JSONFileList $jsonFileList

    In this example, the list of json files is created with the Get-ChildItem cmdlet and the
    results are passed directly to the Remove-DeviceConfigurationADMXList for processing
    #>
    [cmdletbinding()]
    param (
        [Parameter(Mandatory)]
    ...
    Write-Host "`nDevice Configuration Group Policy:"
	...
	foreach ($JSONFile in $JSONFileList) {
		...
		if (Test-DeviceConfigurationADMXPolicy -DisplayName $groupPolicyConfigurationJSON.DisplayName) {
			Write-Host '  Removing:' $groupPolicyConfigurationJSON.DisplayName -f Red

			$GroupPolicyConfiguration = Get-DeviceConfigurationADMXPolicy -DisplayName $groupPolicyConfigurationJSON.DisplayName

			$apiVersion = 'beta'
            $resource = "deviceManagement/groupPolicyConfigurations/$($GroupPolicyConfiguration.id)"
			...
			Write-Host '  Not Found:' $groupPolicyConfigurationJSON.DisplayName -f Yellow
		}
	}
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDAm+ddRxfDE2Ml
# 7/avK9SHDJ38uNOoxVOnEQW5bnxPhaCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIFzR
# RI8Na276LogwAijygdeio4aF+ydQpgzq6ydmee8xMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAmk0/FVnikSI1hb/bTlaeY+WRY/twmr6sieGL
# MiLcgdG8wVJqE9wBBNN2LzjETEpTRGtmI+5JSgDxaDeP1+kLWtGAoVW4ur0UCuwK
# LpqXg2XKbmeDnfaSraHsK5LVTJh1zoxfuIYLhwwgn7kibRhhJEPqJ+LDlZX7ow21
# Se0RsXvP49YdZlARUUDvZuMd340tR9D1482ivXBLo9q3qOAr5wuQ245x7cUCYa6e
# SOUwDYKMylkqr1vn/QyPwsIyhKuu8t7MW4ZSx1VKj16elz6Rxp/0gnxfJYWyoBsT
# wkwU1w84ueTe3F/T2guB9xxjD1/lcF7Inu8PfrnFuwOTDBQwK6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCTEakziF92R3BCqk8bBdnQqmmkpEEMiHIT
# 0Qz10v6O7AIGZBNQb4iHGBMyMDIzMDQxMjIxMTAxOC44NDZaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIFSj9INXhYXg+AUkqITmdGXczqCAujH0oE9h
# dMIPYf/UMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg/Q4tRz63EiRj4K+1
...
# cmzprmq4oT5/HJRv+dViI7pOJTANBgkqhkiG9w0BAQsFAASCAgAliHc1eSHWgV9S
# 0pj3LYOgRkcoTZ+I50QgY7jmlCvrbUrugic8rqKt/bILkIJCxNPHOTRzjbXoSLPm
# Fgb4nFV0l3Cv/YNiZhNGwJHYG3UOCJjISjtDyO9DBt6K4Fo9jJfuUG78Pg5yzeIk
# hpmcCRoSbA03iNXstpVAumu7suq7XhzXnt0cIRI3tjzt6gxh3a55KPUeu1sMgyyk
# 5ikp/CXLbBNtNwupiTmNLqCmACPf558UwyovK2uZYQynV5v7bRGH+2CNrQMmyUxZ
# YMjjsgqmCqweFCXpQgoGADTJpKN1Q0eiX4iHXCjudH0fS22GZqQTo9+IQGAk76GE
# 4BPRgy07L6HyEHQ3gN8Mutatm4sxEpVDhHzoCwG21likKCaA9L6GsDqIe33bfTlc
# 5ggYM78HKCuzC22Fo2wMKUGr0NvS31KZ3RLRFkAFzhnNZvAkWbE/cJH+y2tWZ9Z0
# LwdL6cuEOFQ9NiHLUKAmF5O00atT7LvHFRQGSVluf76jJ5O+Bvz27+1rUvtyBRnR
# v9AcjUKzMVHUI+2buHGV3/f6lGoLdym12c4dPg/5oUuoDpP4P3aM6x3MOXZ8HCu4
# D2AL+OkMfHa08iRXjlPIGq3wn7enokh12WYx+1sTCHveaU9Jt7tS2ke8nLHapUGL
# ZoUU+UieSkCNaXczxZr8ZVRXk6VwbQ==
