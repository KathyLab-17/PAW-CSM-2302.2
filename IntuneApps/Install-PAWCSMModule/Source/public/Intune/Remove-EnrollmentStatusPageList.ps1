function Remove-EnrollmentStatusPageList {
    <#
    .SYNOPSIS
    REmoves a list of Enrollment Status Page policies
    .PARAMETER JSONFileList
    The list of json files that contain the Enrollment Status Page policies to remove
    .EXAMPLE
    $jsonFileList = Get-ChildItems -Path .\JSON\EnrollmentStatusPage\ | Select Fullname -Expand FullName
    Remove-EnrollmentStatusPageList -JSONFileList $jsonFileList

    In this example, the list of json files is created with the Get-ChildItem cmdlet and the
    results are passed directly to the Remove-EnrollmentStatusPageList for processing
    #>
    [cmdletbinding()]
    param (
        [Parameter(Mandatory)]
    ...
    foreach ($JSONFile in $JSONFileList) {
        ...
        if (Test-EnrollmentStatusPagePolicy -DisplayName $enrollmentStatusPageJSON.displayName) {
            Write-Host '  Removing:' $enrollmentStatusPageJSON.DisplayName -f Red

            $enrollmentStatusPage = Get-EnrollmentStatusPagePolicy -DisplayName $enrollmentStatusPageJSON.displayName

            $apiVersion = 'beta'
            $resource = "deviceManagement/deviceEnrollmentConfigurations/$($enrollmentStatusPage.Id)"
            ...
            Write-Host '  Not Found:' $enrollmentStatusPageJSON.DisplayName -ForegroundColor Yellow
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAlpOKydAZ8wxuk
# 5leVXjQd5xj09DtfojEPgawf3T9WwaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIO5VkRxTXy5ZX2aBlC04+ZRy
# +lNhx0xVxJbPR7HQWVF4MEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAtS+G86sFA1ey6dZgh014yIBNRBcfB900OZNsLpCHUhuva46gQSMEXcH2
# BEZg8QbDg9kktXOc+kq+/A3W5Rt9S19q6/eRIu49VqQjoQDKVVldvMpPjtSDOHu+
# wndvHa21nHJjB64uYHhRSXgDoM8+jnYzVhHURE7OWG5YTsQ4Ha5J81tZYKcL5mDx
# qt51K7iY9eQP09Byjb1d+XA+mMX3uJDdLXsmMkkQm/whl1d4itptbARcqg2P6ED4
# VBngp1rvrEMFAvduLJvyIAup7VLqyXSoNxVLeUJAE7PK/Jv/56j2RAsxUh21p732
# 0wiGWcCR0QtAscGkpK54WOuWZTyXWaGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCC6eNzMHZGJJmthjnlucl3LLyHcSwYs+hWFPixqYFafqQIGZBNnTNqC
...
# AQkEMSIEIOC5T7zoWYWemDKNiWQvDF31P1RNPR7poGeIk894c6toMIH6BgsqhkiG
...
# 9dD9djANBgkqhkiG9w0BAQsFAASCAgDilyE5Ws24gVlvmdcbIRxFkKRxtxbwSZ+b
# b4RP2WPSnWLtGRMaivdikP8XH4tTr6pv+2Dd00T1WzJkY3V/HSVHFd8BNj1YRl8S
# xnbqReQ40f/9Gra4eZe9DFbUF6gXeiZjVPPdls3qXRy1h9lfxbw0m7M6teRl428+
# S8beiGzXNcYeY1y73PwB59blu7j8MrvXEBmGhwb8W3s+eMwkW6hOhs6BGz5fiff6
# WCmVgeqbzOac6on+w4fQ/ukz12OLmNGv9S/o3HuZhclUM6wo3u0qvjLXB5LmsVCO
# YqKc+zPHYtPpzSYIgLaUGhZjA+9aVV50/idBkUrvxwL1izufQM0Vo+Acj4D7+dQp
# +vWFuKW1G8TzRrgVRDyW+saEG7MppcbDlF7d+9H5XXGpANBCzB6+gBe4M+C9jK8m
# qvnCyG2o84CHJF/PpmfRl1ZLQuzIXVJc9SeMFm0ssy6fstZudeb+vDhEVdRcIf8d
# 08Y/qFbSCBQtHOpuC9uQRFd8ZGWzVt/p+vJBMJ5eMf59jTlQQKdbhTZPJR4v4RvW
# jgkBApkRrOVnG7UnB8Y4/LcZDaxvmb3apyJmD++tv3yrHPQE7IhXAfC6Xs1XMRll
# cZ1QES05zyxIB7j2osHgriLzUEm1fIc5qmAdmbf3Ue5fyUwO6XqmDq7bFODfXLd0
# f5uVBedcYQ==
