function Set-AutoPilotPolicyAssignment {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
    Set-AutoPilotPolicy -ConfigurationPolicyId $ConfigurationPolicyId -TargetGroupId $TargetGroupId
    Adds a device configuration policy assignment in Intune
    .NOTES
    Requires scope:
        DeviceManagementServiceConfig.ReadWrite.All

    https://docs.microsoft.com/en-us/graph/api/intune-enrollment-windowsautopilotdeploymentprofileassignment-create?view=graph-rest-beta
    #>
    [cmdletbinding()]
    param (
        [Parameter(Mandatory)]
        [string] $AutoPilotProfileId,
    ...
    $apiVersion = 'beta'
    $resource = "deviceManagement/windowsAutopilotDeploymentProfiles/$AutoPilotProfileId/assignments"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBVrhbDfsvYvWPW
# ofxVJTguATFKmqSnr3rJiFllbQuX+qCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHWO
# tlJWYYUrCV4dXha+98FwoMQh/VvsoiWLbDp0z2fUMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAbcqXqvq7D7x88DQ1YC8r2bRkApgy0SfqAr4W
# f6I0mng54xRhfzhXad+3By0Xe3fu3MOK2K3UfjTVP5xwSXJ+u67w57/uBnm2su+P
# /dOA58/+lt2/Wu0wA4mCMWkq8t/BQsbprwzBD8DAwJg+iCjLjRbPB8/6PufatHEB
# aXPF5z+EF8ypLid9OnrEZN70ovhoHBLXYVC2FCx2lbWRspvViGEdL+zPpR8YcNXx
# 4PtelucU7X8DLLY7XR1TpftCDrYV4a91g8SuZk7+OuhcsqoN8hRcb+a1f7UPSf7o
# S11R/3/ec9BknYMUG5HMn4Jvnh8M3v47RmJ3FCpg6cSHCpzPd6GCFywwghcoBgor
# BgEEAYI3AwMBMYIXGDCCFxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDXO0Ie0gW6aI2IF+HXRMmczo9RwqZVI8yz
# gr44dYkCMQIGZBsTUZy6GBMyMDIzMDQxMjIxMTAxOC4zNDJaMASAAgH0oIHYpIHV
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQg80Je7wU3G1IfF63Z/r9fefr67Zu1TjV6Oxvw
# MVAaQ5EwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAnyg01LWhnFon2HNzl
...
# IKao0yXV501bCoKS8UVKs3wzMA0GCSqGSIb3DQEBCwUABIICAIQjPtPijceQ78FV
# uh6CKbnvuFBH1WmvaxjuULiEp74OLL7/hoCPimpwNhOfAljsCTaq+eQUc9oCAelW
# jU3iFEQbiueiYJxLJBQgyafYZhwjI+6ElmdYN+mElXuMNAW22y0FjBgGZnZCt27w
# u1mjMshbQA+P3TvBK1L7QIOg+NOWamcmCBE2fdte3FGE79FjrdUK4sFth342vJ6U
# LZOBkgzqOXN/0eiGGxSCBjPsIOJ8LEtBFOq7KaI5983xK3BDSWaGA8FUEAt3ZRwn
# h76i1rHzCMXz/kCvmDJ1cNlYOuaeR0UFLHRwcxUJNGl3aeyU4mLb/BKRUE+0HnU2
# rr/OKyjj9zDuG+2zK8DpC39k7pzOXpR3bodZnUwARQM/aBHJ1khUBFnOOzQLE5E7
# TsnSBvqVEvCCTrEI9BWuxwqt6UJ+lGbGNQRHAUUaCeh3NSq0O1Ttfw2QJvCd+fIb
# DchkCHh7JCCSLUmhmtSsqpxLF3JHV0ZyInmYyhTDwEs4Y0t7f7ohwnLk4krUKU+K
# 0r4QcBfpoL9wEqfK3/nzhcnE1axBAK4ancRRr5pLl0LII7kYJ1sVMNtE6QPC/naq
# GojqcZdjQbZ4ZzOhX/2fZ638OyVK2t96PMhuVFhsQYw0KOgu81+TP1OSeXcgMweM
# 0JaZVDEJB1Ugq7r6n1M09rdUSYp/
