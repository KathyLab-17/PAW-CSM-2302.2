function Get-DeviceConfigurationPolicy {
    ...
    try {
        switch($PSCmdlet.ParameterSetName) {
            ...
            'Prefix' {
                $uri = "https://graph.microsoft.com/$apiVersion/$resource"
                (Invoke-MgGraphRequest -Method Get -Uri $uri).Value | Where-Object { ($_.'displayName').contains($Prefix) }
            }
            'Filter' {
                $uri = "https://graph.microsoft.com/$apiVersion/$resource?`$filter=$Filter"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCn0BInlhsjMCrw
# 1xcv9lrAup8f35w9zKuV+X7LyzeNNaCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIML8ntM5p0XYc1KD2vwqLKm6
# iGDut0z89zxTmouitYquMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAWWXb3qSpbJc/TmDyXboC7rCWRK7wdCWz9IAukkV1H2Jl4FsMbqRYAL/V
# VarkK/R/j1Oo/sJW3YWJK31IzIWLIeICtl1aZOzg2xbFx203uPnUYHw6GH3OQHkG
# N48glil6BJ3fK0Ry9XBEOKv6cx+1+vU/p0Avqvhm8XXj8Eps/jxkZgcZdZIgI9kV
# nffH8X3lqhw9p5iI3eVeUTjMZbuKyY2/4Rx9iGSQfPlNJWIGw/Ho6F9GGEFkWon6
# 2jbRU4DsQ4Yen5nk4M6gHvb3dLIu6Frz+iHucI9K3kAEI1wO5MF8AgK1ejR7abKx
# XX7PRLnDtfG+uRzqV8crmbtMXWCYkKGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCL1Hh1FGVQrCOdlEvJNvVc82XDxm5cQTNMFiXoGKdWngIGZBMDWRVq
# GBMyMDIzMDQxMjIxMTAyMS42ODNaMASAAgH0oIHQpIHNMIHKMQswCQYDVQQGEwJV
...
# AQkEMSIEIJ56LOoYgFCpKnls8UZY5027MPCjhj77ycYYc3AtgDPRMIH6BgsqhkiG
...
# u8JuSjANBgkqhkiG9w0BAQsFAASCAgCQ8HECMZ4EnS78bYu61MU4yr2bUjH8S3s3
# Ho3w/kmeqWKLrD+j1/SKLjh5NvuEQNflf0S79y396J0aWjjn98C34PyWiS7QFavH
# yhCSQPoRDdc1wLE0eycsyM8rJV6ENpSKdGySuaNlaRVaW8G9UVo77yKmOvJBeSqo
# z8PvN/gaVwx/FmWBIbiDjCqINSyzi0DzWL7oMIxM/sJqV+d6PVJdozLTckwwnbnM
# L0iavIDvNXh/XxpHYst1cOCt25QcAIFkcHjwJOK51o7N/L3oBWhb9H3fD4DAIh1G
# 69IH0fBJG1P4YDs4PWPhPAspdYph3lLsSM6iOnZdbeksO/s51zfwdIE9INFEDzw3
# 3YoSsbW5wN6s0HuSKfj4JhhltNBIC2GAllpN/w91w7JtiSUDVaxGc6IvLqkRMwyR
# rVOpBik1/h9HOFF9p+ZUaGb9sBYctVEZqx6VSI7BFUkwXVlHxeweLG0gupyQV6k1
# EyGP70eq3MBWyFfNOnoMNq9F3FkA5KM7mQoGr3iaqNp1ZYIGwFi6QaoA6aNzvIuV
# 5kReiJ9RC4u8M18HKxQAn9kd61jbfZHyJvWMiB9xsYY+w2iIxVVRadQlK7LMrv34
# Py0ZaHcFFjsRE22TzlKQt7OH9kMZbwlU/9l+kcvUw5nzz2CFcMaivjQh1NyREJRc
# RBw1RK+g1w==
