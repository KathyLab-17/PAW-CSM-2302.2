function Import-ConditionalAccessPolicyList {
    <#
    .SYNOPSIS
    Imports a list of Conditonal Access Policies into the AAD Tenant
    ...
    Write-Log -Message "`nAAD Conditional Access Policy:" -WriteHost White
    foreach ($JSONFile in $JSONFileList) {

        $ConditionalAccessPolicy = Get-JSONContent -JSONFile $JSONFile

        if (Test-ConditionalAccessPolicy -DisplayName $ConditionalAccessPolicy.displayName) {
            Write-Log -Message " Existing: $($ConditionalAccessPolicy.DisplayName)" -WriteHost Yellow
        }
        else {
            $null = Set-ConditionalAccessPolicy -JSON $ConditionalAccessPolicy
        }
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCGvDLSlidTOZD6
# r0UfU4FXfA29M1lQQ0TF/wVvxf2TZqCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOglGbcbrtbVTjLPtLIJHr3h
# hjRyDVX5U++uqZ27YWzmMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAn8Ck8/siTHdFuoc0SQgQDULEE9vj/4adgewIKpq6WmAWr6lHy+jD1CTn
# cIwztxJ9J6iyme96Sy0hZrIk2K0sj5XCL01+tmmmetSqHEh4titwdoS0wwcfSB/8
# j7Kum8CBgYy6RTityNR7AkxzCcm8Qkx8S812CpwtCyD7y4HQj/25ennH8ABhunRI
# EiwUpKx2CJfFOLEmn1fsb+r/vnC479Oa9e1rBKQxuj2/vgpJur+qNyOFEkT3fIOw
# 8ZgNlPvcjpwOO84WpAM2W4j5l57o+j5sBO2sGPCpNgtSPSbXWwikD/N8NlHccAA8
# c8ep5NXOq6dEnBWv7ivJTqgSx3eRZaGCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCCG+X9BFJjWlGtsAtgDTQrYnVNacx9k3NQLPZN9U/M2WgIGZBNduD9k
# GBMyMDIzMDQxMjIxMTAxOS4zNTlaMASAAgH0oIHQpIHNMIHKMQswCQYDVQQGEwJV
...
# AQkEMSIEIOE2Jfkf9gpHfdRf30U3KF9e2InqGD3kTTYh8poqEO7wMIH6BgsqhkiG
...
# q9B9lTANBgkqhkiG9w0BAQsFAASCAgByNvqAGKC5x7hLuPi0BEMiU7bUpDpUqDEJ
# FwXG/5iuGmHFueqY0/wD1bCbvyy8O/vYtPFkkTuCpc88OnG8pu0RFdBEkZyEc8nG
# 4JXoS/SmXX4sXbsQzxdnuDasnzlBLgW0lZEJrQZ8wiV3z35QyZwCTrNVerJpjS9z
# pgFtWykzdJMiVcf5JPUYlrmROdoEPCgMQ7h46UR9UgmQpNPnJbzl9NVNdNXKn9ni
# LhaX+1hQTx+h5PH5eaAwB9te9dlyVb4HTZr6f2kT/k/IaEk1urc6Pk7Rl1MM4oxW
# 1zocQyDoKtREianh4V2/d4LVWq0+/9O1Piq5oEV2HOQUgLAzVftgEcBR0pskqhv3
# QUpcn2AjU2EJTg/mEH9nt0w4lVD3/y+O8GwJuahBvaR7Ijc5d0GhUMRqWoYuKAOH
# ya1oDSzis/GplIFff8XpGjYP8fqvJliIt0LUTxkSjhPgVIzRA4tp1rzsW9ZtZjXg
# HzmxY1+C7T/D9xWxASOeQrv9MOhECVbhn0wgU3Gdpw3LOOx2JEFBoJjKXrqVIILC
# t8V1IqYuHX6mjnaRO+5QC2XAihKJ6IlWD8ZgdnBbY0PbdIBeVtGQgEMCxDCptEkQ
# owp8kgrTNdstOcoAGIrcxJ1GAiY6A9WkT17+KEmR7eAS72Sjogcyv3Op2Ump3Zo+
# VlCmWyIbBg==
