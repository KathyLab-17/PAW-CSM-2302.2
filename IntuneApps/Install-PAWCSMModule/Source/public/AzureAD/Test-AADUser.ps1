function Test-AADUser {
    <#
    .SYNOPSIS
    A simple function that looks for the user in AAD and returns $true is found
    $false if not found
    .NOTES
    ...
    if (Get-AADUser -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAZgEmazuqcOsKK
# RfOuxOgpyt1AovEVN/esx9YpMAkbp6CCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEICBuexeVxxxMMpALXy47vxzZ
# /z/QNg2QU6dhcR4cNgQjMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAeAQinHOcrKJ47pPUjFxKqbGd8QeMCISAajDoa4xOMWKGeSFRMyIZc4ko
# HrlAyNZTxbbGPYj65huG8FMKzOoqKuyMJBkMUGmXWsPSxrQ7hgWyhMtUkUhlsG+I
# MJXdwvcRV0/1CxnpdpdxFpjMmGQHNzl12fr0Df3MKKUbOZEjtG00XOXLa1YrUtaK
# J97x6OvsL/GLRIy57Id8o4jXqNte/y3Y2W92/+mW8i3oaDLO6XrFOhXtIk0Dam0n
# VPbNod6PeML0dg5ce+dlgY+xBDfioqlII0ynO5EJON/u78GHiCSL+w5c2gqlrgZP
# UmgFKYz0ymgsFzqokx72mO/d1MNpL6GCFv0wghb5BgorBgEEAYI3AwMBMYIW6TCC
# FuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFRBgsq
# hkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDzOY/kzdNxl+eETMAALZnzMqtngm4HZ3RhX4xRt8YHbgIGZBNnTNqB
...
# AQkEMSIEIAXSv7zW6Lsxe5k3e/nIBTU1skVR+wmGx+LTT5lYanBnMIH6BgsqhkiG
...
# 9dD9djANBgkqhkiG9w0BAQsFAASCAgChm6kwjrREzNWWq59dI8/aLG95ehIVC18n
# re4DNXJWOpNIB4pvoIo/smGIaVw1hGnYkRPtjshiMHhgTXRrhEbdTAHJ8uwnw9+I
# YKcajYmd7YgNaTmqqUb8HP/LF6Czih/2Yrt7elI6DO3rf6SrDK89neWGfEluksSh
# QdCf2A/sDrqvubP75Wd1L5ZpupC0ayPWb9G1Oxs+RgPJDp5Kz0G55C9NYUxaVFg5
# eqe6mzMPrk36eppJnFOkNE4BLZ+4u2ATvNrWsTINhwd4y2o3D+bLmkm+3vcn3O46
# M+f2oYdnzbebu7P2OPipmhM3WEcw2dCnfvRISR/ubJH4Bpf8bTwO+t6+tMCQY6y9
# vz6kkHmqb8Gl7bjULQtXQAfz+3Fk+qbwL9sCDHO/seVcmdxgWeO6ypwvx1kA8R5l
# oGy0X7qYi110Kpp++0U36wvdFoeHDeTqfs6OFvu/F9zRZlsrsCHXzAjSPdbNDEiS
# eNtUb22atoPFYGBh3LyTyGW/YVG9Vxe9Fz7Fn5KILOu3KYnyIRWW+kAJigLqyG1Y
# NFoD99G3WmKU00VeteqgY8Ic7zm4Z9chlVDDZB62ezrohNbZ7HZS6s8ecuk3lshF
# XCmqsKRxQwy3G9Xfth4VGS7WbaGi/FKF1qxfxsMu0hjPS5xXr9ZKrVGNhbyx0H47
# aMxVB676TA==
