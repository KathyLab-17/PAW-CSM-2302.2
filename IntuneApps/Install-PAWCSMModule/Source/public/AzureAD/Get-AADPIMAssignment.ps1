function Get-AADPIMAssignment {
    <#
    .SYNOPSIS

    .LINK
    https://docs.microsoft.com/en-us/graph/api/privilegedrole-list?view=graph-rest-beta&tabs=http
    #>
    [CmdletBinding()]
    param (
        [Parameter()]
    ...
    $definitionFilter  = "?$filter=RoleDefinitionId eq '$ga'"
    $displayNameFilter = "$filter=displayName eq '$DisplayName'"

    $apiVersion = 'beta'
    $resource = "privilegedAccess/aadroles/resources/$tenantId"


    if ($DisplayName) {
        $resource = $resource + "/roleAssignments$definitionFilter"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB79zuQP4LUtfH/
# eMbANsmhYHTFN0NGKoIAxXaxee+X5KCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBXr
# ZlHGpQZuBGmWf7Hy6DpGBoNZ/MLpJFM6eIU86xL8MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAx01V3xuIXCGDVhZIpHbZKTbOdTEVyj8pRURa
# kU5slLUBwKrZrMpD+pvz6mUd5CL/+sENrOuib3O7ywhG7Bf2ZPFCXZcQj8UwaaqC
# UiyuXOX019hUTqzhNEhPST9O8/nQl+A247KIHzfwA5PjfaCQw2KMJxGDyQHcaQ81
# W8RNoDtESA3CmagHbdpwfSPMv2BK+ftG6dPYHk3217OdVFlJ2NkqQaqSAMaN8mu0
# Uo0phQ6qmGt6nEjFdUscBbXdMVI8UE/bud1cSyaHGwrbro7duJOPh60Lq+NYgfrN
# Z1ItrTMQxmMIVR5B7iAYevuNk78aCnw51X+cvXQk5LC0hYbko6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBNK7Es7RTeRIhK0C9FOlMcDwOSoDx4loRx
# gDMFfl13ZwIGZBMgedHfGBMyMDIzMDQxMjIxMTAxOS4wNzVaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIF6JThv18Hq5//tY6yVhjWdojyBIYx2IzH3E
# MoZ5SMQMMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgBLXPONCJqxGnVq
# ejhz+IlkLi8iERCghzeB9Xf2RnJJ2jMbHkX9rnDABsXn5kEtQIF0Tegixx1Keuzw
# GfFuVFSo7gPVOUwAPpJmejVsLm6yzMeRRucoOAnBShDpGKnLlchHoR1tLmTvy+xV
# Gp/ZMHlGmOmAf8y48HGFkpgntgiAh75OsNs/fVutldn3AIQ7T4lp2W5YTxXOgqC/
# jvtAk/qmUg0CTygzjr9sXpUI7QkgaWJEmkE+0GiLfhd/QVZvoIyQwokEFoNL6kYv
# P/rL6BfjI18MlimPc9gkP3EDg4RLiUcXJ8L2mPiviVEL6UtiMO20A0Yr4nSWfA7x
# 4Hk4T4/uybrA6H7XUxAK1tzScSuQ9OnrKJuDFNYnWJXHa/ByNOtBW1YagjGms+4J
# MKHDxRlGjZo6LI/2HlD8agAprynm6b/jpYErEX7M+Vq0N9IyAO+whJy5wcA5I25H
# V9+JcJD9g+9KZ3fV3Xm8cvtPYEQ9xlOiQ2fXdsIqCHOe+OzhnusjPYHZeuMPLeWb
# ulE972Am54fn94o08Hjj0YQi0twpsoTy5430Mysqim8KA/yaISY40pAKKs9b0D3R
# /kNxzsyAXMadIc6LcSzTdZ0iPByEamMm3bRzgn1fSguSkffgfe7u6hN53cIoeAYC
# vlA/8mMsrZdJ9f6ZEvkCEvroB2QjhQ==
