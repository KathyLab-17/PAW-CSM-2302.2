function Test-AADGroup {
    <#
    .SYNOPSIS
    A simple function that looks for the group in AAD and returns $true is found
    $false if not found
    .NOTES
    ...
    if($DisplayName) {
        $aadGroup = Get-AADGroup -DisplayName $DisplayName
    }
    else {
        $aadGroup = Get-AADGroup -PAWNameId $PAWNameId
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC85UQAJjOPJE5/
# kKGXI5CLwGI/RNyNBva4g0ZLwuu3A6CCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDSG
# k/8dZRcTVkvFi/kPv8fOI5RFpMzsxAezAd3Qx8KcMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAyi4g1himxOcD4zUmdKB8858Rmo2nvhOPT/y1
# ZnMXnEILrYT9aIthITCKFTB4XUo/+fXjmnzNAzBdJX2ZNqTQN/RiIb+Qqu3tAlsp
# AUb+Qj31+QcU49c6WRKoxoANCX3xjf/I2z9g0nSjaVCEFp4N2VmMsx9ELhHPZKnx
# hhccZQzmFow2B1YWqxLWI0axshf5F6WODwO1O2B/+xm+Bw7uhlwV/GHDcQWNfdwL
# yHDF/9vtKK1lqOdXREdY10WkSnRXgfRsKT3OGS9fO52p4+sVTuIy/Lt2rPvspRIF
# maiBfXfqRydHtcrQSHJz7X8buDOoDQgyxzmFDN5XUrdUqUUgEqGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCA6h72m+RXYeuDUQa7TxaqWveCJcZ9eBQoM
# IXynhQIx3AIGZBNduD/AGBMyMDIzMDQxMjIxMTAyMS44NTFaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEINc9uGOtX/2SksUjdiunlelKQp0TUESl6+XJ
# LWj6IOTFMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgWvFYolIIXME0zK/W
...
# v3XZImgEh7IGrhHes2IAq9B9lTANBgkqhkiG9w0BAQsFAASCAgAXVkhqhidWwhwQ
# eYy2ax5ZACRou2HngfdSzZMqTVT1ANI0SL9wtm0jfZm2+KNT2HbKWv/QFInXj3lT
# Sc+l0XwyOL2BGQnM37ICa/hofQlO5eyMJD/2II+62qTw8UR1JCCSML4mu5PvVzmd
# +8Psv+GV7+iEC+eiYCXM+jAEtT2sRoTHkAWPWQrrge3CH+Bg0CrVdTy3Tp0Ud/56
# gqhnLNqYaKnKGhImLETwHu4Ds1BD+xzKpI4IywKvH/T0Ue5in7B8J8HxKH3hPSNP
# +abfJpn+i0o0Ms0wkXCXmVAz+GnyhPi6R8PDFAbJ7h0DFhGRuyYi6SkHizXszbF0
# /0XAe8nOQ63vQBoHyzOtP1vzgDlMMYNBNthujXTG+tBy0CGKgFngkyQeNmexwSEI
# yWqg0pXycBrkQ+BEGRn0XiPWkAau3fMkGcGgRMREfT7D0ALC5+UYrnI8sa/6uCR2
# R2pYJIfLOT7FJiGWJUV+EZrDd+kRgaXX5shy1h6YeedNpPwA1mcWtbCiwwgLIDmx
# DUHhiW+NR+Ax2m7MPSGTgSt/uVA8nCcZmxB1UCeau7e3RBygQDxFYeUNxIl2R1UN
# 5P65YoTyCizAP8yQHNZ0rRGDPH9il5gNvfKV4KDqUqBxGmy9QBJ/jrO7/ceAL0l2
# fAInwYjYwBZnmUYXj5GNqCs8qugbyw==
