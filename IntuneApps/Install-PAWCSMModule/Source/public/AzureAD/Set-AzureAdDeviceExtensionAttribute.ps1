function Set-AzureAdDeviceExtensionAttribute {
    <#
    .SYNOPSIS
    This function is used to set an AAD device extensionAttribute value so it can be used in Device Filter CA evaluation
    .DESCRIPTION
    This function is used to set an AAD device extensionAttribute value
    .EXAMPLE
    Set-AzureAdDeviceExtensionAttribute -ObjectId $device.ObjectId -ExtensionAttribute $ExtensionAttributeNumber -Value $AttributeValue
    This function is used to set an AAD device extensionAttribute value
    #>
    [CmdletBinding()]
    param(
        ...
        [Parameter(Mandatory)]
        [ValidateSet("extensionAttribute1","extensionAttribute2","extensionAttribute3","extensionAttribute4","extensionAttribute5","extensionAttribute6","extensionAttribute7",
  ...
  [guid] $ObjectId = (Get-MgDevice -Filter "Displayname eq '$($SerialNumber)'").Id

    $apiVersion = 'v1.0'
    $resource = 'devices'

    $uri = "https://graph.microsoft.com/$apiVersion/$resource/{0}" -f $ObjectId
    $body = @{
        "extensionAttributes" = @{
    ...
    try {
        Invoke-MgGraphRequest -Uri $uri -ContentType "application/json" -Method Patch -Body $body
    }
    catch {
    ...
    $uri = "https://graph.microsoft.com/$apiVersion/$resource/$ObjectId"

    try {
        Write-host "Extension Attributes for $($SerialNumber)" -ForegroundColor Green
        (Invoke-MgGraphRequest -Uri $uri -Method Get).extensionAttributes
    }
    catch {
        New-Exception -Exception $_.Exception
    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCfEd2pu3SzK8Pt
# YoS3BcWlUQhQ0eOYlhzT8zJ31D9J6aCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# Dtx6mkRbq2uCyhQE22jtpRoZYzMY2xSxsfAKuYnOMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAbtP2TeIXtPO+c87UtfJZrfaCIkPOIWtc8mXz
# Lif26CFukioX7ottEHnAtQQdz/9j2cfCfFCSTAhCjxA23r4XDZnlwy1B2CpmYm2z
# DhhqnCVP0fj91rqatUJB8idXPdVbqN0llxGRl3WY4IKT/4zN6TIisUD6TUzZOXrX
# Sj1U2dbEqMYgn0RjT/MVvEXKCRc0L5YRoxqd+aZFytNiK2eh00WDGG4MynhFtkRX
# 6MgEgrMXqL3fU9dGjeQmN9aSDAytOPQ7nQOO6W36nW8JvwdU+2SNZ8Pq3H1cUqO2
# vc7K5QA6ik01CfKtEU570WzF+uS+mg5A2CD4TNyGYzjjhoCds6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCD7Secg2r7JGLVvXmBR1sRUx2rv+YQo0afS
# KS3evXST0gIGZBMgedH5GBMyMDIzMDQxMjIxMTAxOS44ODNaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIKzXu/4R/c48I62cx7U4ZgeqCIqoKx7aNbZx
# 6q+4u1QpMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgYgCYz80/baMvxw6j
...
# ERyUYtpU53A3R8M4gztHWYDGFzANBgkqhkiG9w0BAQsFAASCAgBwlt/I42XoYjf5
# fm86N5/1JhuTwa15G+mqmr2SpeZn3Mq6Ba4aqjritGgK9zCUDICV2ahFcirYHQd9
# RIG9+LtdEDwxz42pkxvRpo4LXgXTUai4Uu1kbfhMy9GQjdf+W6DeUh95d8Qf7cYt
# bmzYmZkPiLaacslC1iAwlGI6thPVENbWR3u4S89DVDR2j9guPSrXJnO/e7OX1EJU
# /Im1C1YkFhZpFhU+If5DfXHzNPmUEQZcbPOxaARrWTuOU96x8hO3u/4Jc3UhlLJG
# K7HXFG9ME9Ir83yM5GuCyPbNfr5nTITnegFSRpARplWrSvJJXDuMRdYN0K/exiW/
# nzOfNR6ossTnMzP3unopoDg2O7qFO6LZCyBwQ+jafepNxH33dKgeUW2kD+KhlgyM
# gSRRrR9wgracUeQnMqQu1tR2mCrW1z05eVMnxUrwwpxXev5q2e7DaH3NlX7CTncw
# 95Owd0Wq8z5T2YrFrZwoF7CuyZ6so4KXD5NvEaoF2RwYKRe08TF6RFdxOwqIrdmy
# 9Uubt5aQN5xxT6ZddMyDRjN3HYxGtxRP8N+cJzqfzI9TQX4jPx/BaQhff7/Us1Q4
# fcs8zG0/oqH7xtOgKQlkFyA7puuXVlXCoj4AwuOnBwEwS+64Nuyq3ixe50TMbrAS
# YwrWkkZ8FJGHzbT77568gXw4/EZZ9w==
