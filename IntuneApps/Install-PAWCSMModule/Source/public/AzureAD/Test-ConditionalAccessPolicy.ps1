function Test-ConditionalAccessPolicy {
    <#
    .SYNOPSIS
    A simple function that looks for the CA Policy in AAD and returns $true is found
    $false if not found
    .PARAMETER $DisplayName
    The Display Name of the CA Policy to look for.
    .LINK
    ...
    if (Get-ConditionalAccessPolicy -DisplayName $DisplayName) {
        return $true
    }
    return $false
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBHaA9NT0B2DPzH
# 9ees032yom+LMI6rkLPunyHmG87BEKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# kaQ8zjASuBMa6GJbq0mnAbZ4NsXfDhjr0wcgmhysMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAybqoYk2xCIPwqONw8eNI/89QuRVZgbqIFlNr
# 4qdk2eZxyxZQEGGvncU1vUVdNNuVFD7Enhh0jOzgtxawQtrK0BBtWoimVx7ib7Ol
# rYfGExuzf2wBP9RNRFeMSJADfrJcSlS5jqI5RnpAMyXkAjhzGhxpn3LxoAiPWfN+
# tfzH65BtGd66asQ+2K16mmMaO+zl+iIOnmVprHfmL3vEbf3hn2o4npWqiAda+Bry
# phyWkVXdpCm1RuHz1/HhNDq+qut6BFbE9QutYvwOWzEkmBZyU5ENoEHDAB3bcibE
# y4OGYL1/lwGfqdk6OZlbned0mkJbVfzd+7vW3Ng/S81/vStPnaGCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCAHGRbizvNzadJiQJfXKjhHfGxAwLvawbGn
# ECRtra8KUwIGZBNQb4iGGBMyMDIzMDQxMjIxMTAxOC44MzlaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIP8QgfB1+lKSYHuNg6lM/V6zPg4FM9C9n2Yq
# yQ3H52hQMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQg/Q4tRz63EiRj4K+1
...
# cmzprmq4oT5/HJRv+dViI7pOJTANBgkqhkiG9w0BAQsFAASCAgAeLYC9o2CkTxhY
# ShC5PmHjCWspoCGAdO8PcOacQrfJpqQwgwUUQaavcShaNKnPK8vm06SJJr8SrVrd
# iMV4CCe7OsOOoQ47bCHiulj9Eh5y/kefre3/3pYtkxd5l+Eqt317CUAas8BG+s3A
# WqSSu3g3Rez7anB7YpsnL7tCCHhlVOcKMTTPYvv0fnI4w9AbzoHkHbCFAKUYfEvg
# vQIgxsDygdiMY2jvpV8rPUwreBNnE3Yrg4tCWDbvip4ltQN5yMjspXFRX8zcDHPN
# sf+UuwSt1P8poOWWMqIUR6O1sVNNDBiZznIoi7xfrCmY7AgHbtKF6/GK5fud19IA
# kkuKxXyIE84zR1cVBHkmr5YIbZz6sGaGJ6enYLYfwOaeDC/6k2d6dteBw82KRSj+
# /hJkqpfFO2HtoOuWMRs1xF5eU56b43t3c40KMIuWxG6GKjvBntbAmecYl6jqZH8C
# yUp4KOvhtRboneSR4pYHhszUIP4vFuUAgtDjBqk3Sgu2rMhd5wc880At93K0DoQv
# zSTUEbFlgEzYdSvytiUnEfJANZ1Qz/G+TLsmKAXYeN+wCFDd5EpRIPL4OuYJMaOv
# uiP+E1iEvaFoxzx/+xA+idBWRdXsqcnOvv7PTY1g6oyaYsqe+Oy8rHVZA80VExvc
# n/zfWXe0/mJAcccnUcPcrO3hTAA1bA==
