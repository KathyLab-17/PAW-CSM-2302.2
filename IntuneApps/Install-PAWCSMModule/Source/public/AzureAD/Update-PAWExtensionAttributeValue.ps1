function Update-PAWExtensionAttributeValue {
    <#
    .SYNOPSIS
    This function is used to set an AAD device extensionAttribute value
    .DESCRIPTION
    This function is used to set an AAD device extensionAttribute value.
    The extension attribute will be used in Device Filter CA evaluation
    .EXAMPLE
    Update-PAWExtensionAttributeValue -DeviceName PAWCSM083254842 -ExtensionAttribute 1 -Value PAW
    This function is used to set an AAD device extensionAttribute value
    #>
    [CmdletBinding()]
    param(
    ...
    $device = Get-AADDevice -DisplayName $DeviceName

    if ($device."extensionAttribute$ExtensionAttribute" -ne $Value) {
        Set-AzureAdDeviceExtensionAttribute -ObjectId $device.Id -ExtensionAttribute "extensionAttribute$ExtensionAttribute" -Value $Value
    }
}
# SIG # Begin signature block
# MIIn0QYJKoZIhvcNAQcCoIInwjCCJ74CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCASJp6UKA3uH5cr
# npstEsEUr1iy8fdhQrj1yJeA3ZfWCaCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOyq
# T+4nCX5ikIeucLiuXMeq1VqktTNRwSH6ILs34YjxMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA5M+/ISIQDKlWnWc6MYlBol4NlKgFScFaQ87h
# 8PS6epTyBBLjzeNbIR95k9cQcCoaPoPuSeXhz/p+o90COhoCxc9RxV+1fqrvv9sM
# N4Qs0ZCyOFAs1KrUHMIIi6x1CPGwGAObrs8QA0iPkABIEbAmyR9qM2oZqe2sxeF1
# KJR/Qiyck43oMwMdy2ZIEWhqlkXYD/8VJZ5+lmGgPdVuxKWA2pjdJ26TUnYW8ZwZ
# uKNLUxCUkqoer5zfDwQ+avB9T3SQouqtw93DLD2755vpIbf+j2faS1HS6zaVcKet
# 2bl5poEMzewMxIFTwIvUD6n7RtkbgJWKO6ldVgL0YZMGDFfrdKGCFywwghcoBgor
# BgEEAYI3AwMBMYIXGDCCFxQGCSqGSIb3DQEHAqCCFwUwghcBAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCA4TRDp4BAn1CH/+kIZaGrj7p0EANJ3IdT9
# PGvh7/thXgIGZBslkL0nGBMyMDIzMDQxMjIxMTAxOC4xODlaMASAAgH0oIHYpIHV
...
# CRABBDAvBgkqhkiG9w0BCQQxIgQg75NUWODDZcpUIw2oO3bHworZUbxPoTPXGAjP
# jMoVDrkwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCBsJ3jTsh7aL8hNeiYG
...
# VJB+Z+n0fmTzxNUlZPnKggUxMA0GCSqGSIb3DQEBCwUABIICAApi5aNQWdTRYUBt
# kPstzWikYEnBxX+82dFL8gXmgBeqaIGna4Jp1p2TBU7zAc+Lc716yVzVh5A5Ejij
# E1t6jCSxJpIPNn0R7Sl1zuf//S/vHSfXUeye96lEsygg5vwlNYIPk0VQClZiYwWU
# I8kNrrr4UVbMmm7Jn81kGUBpP8ukcaq5SojG33SdSLVAy1SJLPjnaLSDsYLnLOol
# jBt2s/hKcg+7i7U8odV6HOiXuqfpm50t6D7j+sF7w/bm1Pdd9YtmOlUwMDVjBEOh
# 25jSmisuJgV94aSI0MMcGwgMtMiT9oJqFZr1H2Rzelf1c0N1uLYY8rxqU4jooZO6
# jQYqOaNKXrez57epBF+oFE1BhzxX/vXBQeZ5GavgvJa9znjoSRJcfw9Ta/b3Iq4S
# uNg/LCKcHeh90UzkTBTPC6TPXo+wsHscH1qsp/o/2SviVh3MNHa/wTwOtNJLyZtt
# OC+DyLf29LwCQGz6MExd5HT5YKgIOdIW6JL7PzKsBvPLNQb9G8fQIkKVdbvX6UMB
# 1F8pbgZcoIfsbtAwhbUk4v0l8n1DTgyTviuuIHCOY4AfnafdBAjBB06lGI3C8L/h
# +bz2snSCMAw5/689REav+dYjGMF84YEIOt3/4lwDzKxV3O8751rWUMjkIxVQgF+Z
# ZG7ZM7S8MC6HhJoUO0bJ2YUjxV6N
