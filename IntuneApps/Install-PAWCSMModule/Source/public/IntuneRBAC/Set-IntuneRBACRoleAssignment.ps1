function Set-IntuneRBACRoleAssignment
{
    <#
    .SYNOPSIS
    This function is used to set the actual assignment for an RBAC Role using the Graph API REST interface
    .DESCRIPTION
    The function connects to the Graph API Interface and creates an assignment for an RBAC Role
    .EXAMPLE
    Set-IntuneRBACRoleAssignment -Id $IntuneRoleID -DisplayName "Assignment" -MemberGroupId $MemberGroupId -TargetGroupId $TargetGroupId
    ...
    $body = @"
    {
        ...
        "description": "",
        "scopeMembers": ["$ScopeMembersId"],
        "scopeType": "resourceScope",
        "resourceScopes": ["$ScopeMembersId"],
        "members": ["$MembersId"],
        "roleDefinition@odata.bind": "https://graph.microsoft.com/beta/deviceManagement/roleDefinitions('$IntuneRBACRoleId')"
        }
"@
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA+POIt/0J4QsOD
# osSeGMMG7wC8jxoHePXATs0dLGTzzqCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIOBk
# bEpicMhs4523O4BShPAvxDR5AAiI0PJ5aJn7tTXNMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEA2lTD+Vu/Y2fDDEYJgIM/8q/XFmHwEKp+cUNf
# Fy/xcWso0pImreGw5GiqbdQcFFrYdFpnBSQ+43rj1rJRQ/HAAXOlZoJP3BfUIjnA
# 6Y/GHvQ9Tmd3/kBmNNtPUj3xPUl2S7VxJ8ZuiGCUmKebaXIgYIHBKkM+QC3K/Dm7
# +RpZRzQg4WAS9sS0kA1zncaFafTU/zf8DB+F8cdC9mbeQ2xhLZUFnqxmAKOZ/L6Q
# NDX+M1PEqgMtFNlXCfoJNF+tlEsFOIRwQeB/cs/K4fWikoZBLrw99fQOs+UPilT/
# vkSlTM3gjViMvfvjCz7PEZAGK9qUIJkN0oGPDR4iybjoarNmhaGCFykwghclBgor
# BgEEAYI3AwMBMYIXFTCCFxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCjIns7QvIvhNd81XEUqKLBrjPigQqX2vNS
# HEUVw/xVTgIGZBtTgDKXGBMyMDIzMDQxMjIxMTAxNy43ODJaMASAAgH0oIHYpIHV
...
# BDAvBgkqhkiG9w0BCQQxIgQgjx7dOuSsNsc+uAvCcN8hB8obnyXpaBkVMLvs1ncK
# MZIwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCApVb08M25w+tYGWsmlGtp1
...
# 0Qzkh2GYVhhhZB03CESFMA0GCSqGSIb3DQEBCwUABIICAHi8rEE3j8yho08rvhng
# keAVq9EoCNXK3K0gUtuWGylZicUBPMAKvlQOWMKcyzQq1XtzFzCDLLN9wuVA+voq
# ffCPhZKvqQqItg2OHxMQLBcFWoN0cw4u9TY9C/1NAsH7hJxH40Tm81a+xFPN70yb
# 9fLhwGgw20H8aLEfrG5ZIxsdhHrE9G00AVG7TVkGDc3HV3cn50Rrg7pfVsoZtwBM
# +zzvNq0mYK1bXe0Hunaw9blpJ0o/lm17ERiZGH3dqlpegnpA3FDgAOz/PDo4yOCY
# AUl9n4WOWZKsxTMbpsaG3/BPiyGodHlXCFRjxquRZM+tJckRtCry7kwDfDcx6XbG
# aJ5pf0fLHj6hRIYpRXRj3KMnivyLzKYc17QEKshWxqndHv+LGBkGyWvC+jMxnZGw
# XA3mUVKbjYVR7Pl3MTjheJnPRiyhfm3ZC4O9Mj687i48y2sCSODf50XPSIC5ohJL
# wCh3Bq4Ap5ATa5H1GR08G4Jo3/qepra11/cv9EYe7QvoTPcTchiCyGDqCTQHfUkR
# QqnnWgJDGuIbc1iPbhcMVOJh4G/pD8IVibGpNnMQ3Cbky1WQ4UvKy9R0c9Pc/rZS
# 3YvkH7jBHc4N4iveyk8w5IUzoqHbflErQKe0RC3LruGASAbixXOPyW2qaweOTqVp
# Pt5RQM4SetnvF6oy9f6jCQ6G
