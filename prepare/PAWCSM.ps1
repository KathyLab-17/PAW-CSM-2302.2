<#
    .SYNOPSIS
    The is a setup script to prepare the PowerShell environment with all
    of the pre-reqs needed by the PAWCSM module. The required modules are
    located here, because PowerShell will look in the same repo for the
    required modules. Since the module is private and the dependent modules
    are public, we need to manage the dependencies in the setup script.
#>
[CmdletBinding()]
param ()
...
$requiredModules = @(
    @{ModuleName = 'Microsoft.Graph.Authentication'; ModuleVersion = '1.22.0'},
    @{ModuleName = 'Microsoft.Graph.Identity.DirectoryManagement'; ModuleVersion = '1.22.0'},
    @{ModuleName = 'Microsoft.Graph.Users'; ModuleVersion = '1.22.0'},
    @{ModuleName = 'Microsoft.Graph.Groups'; ModuleVersion = '1.22.0'},
    @{ModuleName = 'Microsoft.Graph.Identity.SignIns'; ModuleVersion = '1.22.0'},
    @{ModuleName = 'Microsoft.Graph.Identity.Governance'; ModuleVersion = '1.22.0'}
)

if ( (Get-PSRepository -Name PSGallery).InstallationPolicy -ne 'Trusted' ) {
    Write-Verbose 'Setting PS Gallery to trusted' -Verbose:$VerbosePreference
    Set-PSRepository -Name PSGallery -InstallationPolicy Trusted
}
else {
    Write-Verbose 'PS Gallery is trusted' -Verbose:$VerbosePreference
}

foreach ($requiredModule in $requiredModules) {

    if ( Get-Module -FullyQualifiedName $requiredModule -ListAvailable ) {
        Write-Verbose "Found module $($requiredModule.ModuleName)" -Verbose:$VerbosePreference
    }
    else {
        if ($isAdmin) {
            Write-Verbose "Installing module $($requiredModule.ModuleName)" -Verbose:$VerbosePreference
            # Needs to be installed as an admin so that the module will execte on a PAW (inside System directory)
            Install-Module -Name $requiredModule.ModuleName -RequiredVersion $requiredModule.ModuleVersion -Repository PSGallery
        }
        else {
            Write-Warning "$($requiredModule.ModuleName) is missing from the system and must be installed in 'C:\Program Files\WindowsPowerShell\Modules' directory. Please rerun as admin to install the required module."
            exit
        }
    }
}

Write-Verbose "This device is ready to import the PAWCSM module" -Verbose:$VerbosePreference
# SIG # Begin signature block
# MIInkgYJKoZIhvcNAQcCoIIngzCCJ38CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA/gQdLFXMCXzYE
# 07Aeklz+5X0y4RVacvu0a/iGBMyi/qCCDXYwggX0MIID3KADAgECAhMzAAACy7d1
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIIfzQK1I803Yn3LNO2LRU/Sl
# 5tqYWYVtOLEsFOoMUpCQMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAMPsh8y9gslSVAN/TEutL01uzCayE07nn+CspX5T4W6CZK0w2ceZ/RkMo
# nvygAQupL67UOzhLxGqxxu2utSlOrqyJPPNN5aUbiqdTMOHUeRST2/pPYar5Xzxc
# RrbFELyptTlcT5BSGnlDSRZrxpwk8MNteYcfNzRUGMLqNIzHn1+C/Fv4T38Nazsi
# pgLCx9AO4S5TmyvCubMEYkZLUcvEuJw9yF63yn65NEi69arIqkZqJZ+2B1TLKYhg
# NU/q0CP47BQpIkuNNX1j1YuUZDpLSkoseqMXqhxzX2Kc4/NKvU/bZA4w7KQyIgjJ
# mYdvToN2yMlHnBu/qU9lWGwWh0VP+KGCFvwwghb4BgorBgEEAYI3AwMBMYIW6DCC
...
