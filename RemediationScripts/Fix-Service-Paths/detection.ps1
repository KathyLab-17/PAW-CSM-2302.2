##Unquoted service Path detection script
        ...
        If (($ImagePath -like "* *") -and ($ImagePath -notLike '"*"*') -and ($ImagePath -like '*.exe*')) {
            ...
            If ((($FixParameter.ParamName -eq 'UninstallString') -and ($ImagePath -NotMatch 'MsiExec(\.exe)?') -and ($ImagePath -Match '^((\w\:)|(%[-\w_()]+%))\\')) -or ($FixParameter.ParamName -eq 'ImagePath')) {
                ...
                If (-not ($trigger | Measure-Object).count -ge 1) {
                    ...
                    $detected += $($OriginalPath.$($FixParameter.ParamName))
                    }
                    }
                    }
                    }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD+CdFBajofML71
# PpOwg8uyNHQXoxpYLlW4SQUYwsIOrKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# mUTuTqtA9OShLXxoXSBG22ZY/JMPWvzX7SCtmYi0MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAykYbjbWGeAsAfpQydSy0FB7FbHC+TpJSXCbs
# 7MHvbbeGRJMtL6C27KS/p0GBa5FJp4AmBV1t08+7RmHcilecn8wNRDLNIZ9+WTtY
# tw2X5wXfSdk/3p4Ogt629ARrwYtFiEcOBSLlEQPskxOgBVgRVNrVV7WOv/sDUFHi
# yYzuaTv5fA6h8Md/t8nZzP9b4aKgPb6S83IQPUOYvLVUWr1St7AZSnSgJlunpQhz
# ccLCSJ7WZ228Qpn8f9WHVw8X7urn/8xW/MmI7A8e7JDxt62vr83asmH0sSdc/1Hp
# LM5wpnYFwpa2vSL8eU21fVWg5meoPih3B75+T7CaCwrI8hVEKaGCFykwghclBgor
# BgEEAYI3AwMBMYIXFTCCFxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBVSJ0FhfwAceCMfnJVSd9bEMp9rfN3tcJF
# keVWalOiTwIGZBtTgDR5GBMyMDIzMDQxMjIxMTA1NS41NjFaMASAAgH0oIHYpIHV
...
# BDAvBgkqhkiG9w0BCQQxIgQgBrONtokW2K+0glVqcp/tWjrn/V4VomK2Qvv68d0T
# CowwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCApVb08M25w+tYGWsmlGtp1
...
# 0Qzkh2GYVhhhZB03CESFMA0GCSqGSIb3DQEBCwUABIICADOx3WbvqXwAVDaBT6by
# o7RXnicfcUHlhVKg9QgpUPkKS/uJRI/jneUDCVa29b46e30NqTd1SE9HcyZs3ZHv
# 2B/0yHsI7ga5lRfAH8qEZHjzdtIaoxNQWeMClKc8YfCRex4PYlPhl3z+Znn+Tsw2
# YKTFZW46h5kOWfo7SlDEqUfEQo3a/FRNvdY59DPqhqF4E+C85s+iuVORuuddTkFo
# SOGKXdviy9/zMKWPVSdgaY1zD7rP3Sv8EfDX+QbB8XUu6Oykpzi8dc8/G1Mv4X38
# yz0iSqTiBpWRDNUwOReCbLH2ysUEwj+J+A8HJzSG1fVR8ufxoTU8EaQm8ixrplZ0
# /6b3b08APzgbQ7MFwxVYRbbXh1xTlrcl0drcOSsClZ0NpaE5VaM5FaQvgteiGb+S
# SL4j0o+6wPaIi5eHoeVNs3Q0+w+f3fzRSHgtgu4fEKIjl9kcnNCStDn2EG1qbsFE
# YZKW8f0H4Vx3v0agkj9vDuDoXvWOB5ZIRZGjvZYsmUjuUtxwTc5mNNJnbbHueew2
# ApRSDd2WHIyeQVxiUzsiDkWsbJBWYe45+JjqBZGHUhiUmItIhSagqufaw4eXCYhF
# +9SH7TZMm+DpY4PrMvics/X6EPcxzruNgUJfyjqUJSYoj5ZjeFI7izPiGQeM7zeA
# EXeKayUeWgNrEsNWvLKlFsVb
