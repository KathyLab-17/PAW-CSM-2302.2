...
try {
    ...
    Get-ItemProperty -Path $path | Select-Object -ExpandProperty $regkey -ErrorAction Stop | Out-Null
    }
    Catch {
        exit 1
    }
...
try {
    ...
    if ( (Get-ItemPropertyValue -LiteralPath 'HKCU:\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced' -Name 'TaskbarDa' -ErrorAction Stop ) -eq 0 ) { $RegCompliance = $true }
    else { $RegCompliance = $false } 
    
    # evaluate the compliance
    if ($RegCompliance -eq $true) {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDJZClOHdKQr2nk
# IaGAzEtuUYJc5frBFW8ihhZDkyJ/AKCCDYUwggYDMIID66ADAgECAhMzAAACzfNk
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIGDc
# /UTh7s0jKb8d9jmxMwZvIZEdyKVsNM1fmSE4ffaFMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAjTjh82HXfBDc27DMWVjFTQcFuAg6SohDgbFA
# ipsIcNrOKLriv/4ZUVGC25XrPuDvO6yjZBIoKHY3gziGJ3SGEZgRRj4IZ8fLvn1i
# veU/tfXnyj535CCAbRaCq180s26/B82kcYQJf+adyzCsTDXnDhKl/fCZp1tDx3Zw
# Bo0UL2rBaP3J/0jV/N7lp8kBPmnWiA5p3bE8aVhkNI3Jv3u5JQZgj2sqRHwCNter
# UnZOH9wBg3l299VTalqwr8X4iR0MZ1ix+1RxjKkhmThf30MnAvV6ZK9+/V06cpvs
# iqVjPxJ7O+qDrB4/ARtJVgdJRLXUN9wQ+d9By0Ie7zK1As4Ct6GCFv0wghb5Bgor
# BgEEAYI3AwMBMYIW6TCCFuUGCSqGSIb3DQEHAqCCFtYwghbSAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFRBgsqhkiG9w0BCRABBKCCAUAEggE8MIIBOAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCCOlYpCO7VxbUcaQqbNauAQytQQlPM8Mskd
# Isj7/ssqiwIGZBNduD9aGBMyMDIzMDQxMjIxMTAxOC43MjNaMASAAgH0oIHQpIHN
...
# AQkQAQQwLwYJKoZIhvcNAQkEMSIEIOctyRtEHfNl4yBLWkHhDlXm54yK7xTLnx/B
# bgi1k10bMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgWvFYolIIXME0zK/W
...
# v3XZImgEh7IGrhHes2IAq9B9lTANBgkqhkiG9w0BAQsFAASCAgBumUtD0zsx3aca
# iVl2ynaTyPusP5uVOw72t7oYB7RwJMYC3aiMITvTOJ8/bfei0Z3fc0NOFbSHolXi
# zX0U1ykS8pzktdmssyASPgrKSw2O7T4V88AoC6FSlV3HTWFH0eXxvl8tItF8vkeq
# G83NbpgYshWNdcIbH5eqJvJ4YJHGR8cARNdi31BAHIzpJsRNcu+kZAi3q6xLW5KE
# E/pKvGPmCs73mB3NS7p1mbivY/ZOz/CIZs/wlj1ylEpJUXG/tHc0cqtgTWyzwGTB
# EoDayxB1IX74Cgmk5LB0WAlJfYx2f+E+dZToIdB3ka31JXSsMxZX+5b/G9eXx3L6
# 5cMGD42SOyWmU+mVXieBTG48XKRL0dNoR9g1ZP86UoFMaCSrExrOYw7R9jq+XpuZ
# Tg2KHglWi0nqyzrkWZ8d4VNs0G2zBYGcT9UQBVo2tagVvFeittZii1EGD5C+cXZr
# XlpgW78HKHJ6Rphko4sJenrbYjKqZfDzc2Egpy/wNvKf07+Gv1T6Wtdgdr2urUnL
# GkVG9E9cnYsVgNQLZutzAD3kyDuMZ+CaqIdPoestVytA9/HzSewt/srOoA7E15d3
# WdSp+SuwvS7oVkYTbnucXLTDKYV7VeYea5QQqZfTgtpDXigezxnoCClYcrmwu8u2
# Scgq5YwoeM2hFbcIDHBTYWLoFAduxQ==
